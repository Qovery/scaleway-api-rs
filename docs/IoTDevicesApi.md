...
> crate::models::ScalewayIotV1CreateDeviceResponse create_device(region, inline_object82)
Add a device
...
> crate::models::ScalewayIotV1SetDeviceCertificateResponse set_device_certificate(region, device_id, inline_object84)
...
> crate::models::ScalewayIotV1Device update_device(region, device_id, inline_object83)
Update a device
