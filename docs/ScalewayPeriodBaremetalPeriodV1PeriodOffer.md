...
**bandwidth** | Option<**u64**> | Public bandwidth available (in bits/s) with the offer. | [optional]
**max_bandwidth** | Option<**u64**> | Maximum public bandwidth available (in bits/s) depending on available options. | [optional]
...
**private_bandwidth** | Option<**u64**> | Private bandwidth available in bits/s with the offer. | [optional]
