...
------------ | ------------- | ------------- | -------------
**backup_schedule_frequency** | Option<**u64**> | In hours. | [optional]
**backup_schedule_retention** | Option<**u64**> | In days. | [optional]
...
**backup_schedule_start_hour** | Option<**u64**> | Defines the start time of the autobackup. | [optional]
