...
/// struct for typed errors of method [`add_cluster_acl_rules`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddClusterAclRulesError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`delete_acl_rule`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteAclRuleError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`list_cluster_acl_rules`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListClusterAclRulesError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`set_cluster_acl_rules`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SetClusterAclRulesError {
    UnknownValue(serde_json::Value),
}

/// Add new ACL rules for a specific cluster.
pub async fn add_cluster_acl_rules(
    configuration: &configuration::Configuration,
    region: &str,
    cluster_id: &str,
    add_cluster_acl_rules_request: models::AddClusterAclRulesRequest,
) -> Result<
    models::ScalewayPeriodK8sPeriodV1PeriodAddClusterAclRulesResponse,
    Error<AddClusterAclRulesError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_cluster_id = cluster_id;
    let p_add_cluster_acl_rules_request = add_cluster_acl_rules_request;
    ...
    req_builder = req_builder.json(&p_add_cluster_acl_rules_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodK8sPeriodV1PeriodAddClusterAclRulesResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodK8sPeriodV1PeriodAddClusterAclRulesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<AddClusterAclRulesError> = serde_json::from_str(&content).ok();
...
pub async fn delete_acl_rule(
    ...
    region: &str,
    acl_id: &str,
) -> Result<(), Error<DeleteAclRuleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_acl_id = acl_id;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        region = crate::apis::urlencode(p_region),
        acl_id = crate::apis::urlencode(p_acl_id)
    );
    let mut req_builder = configuration
        .client
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteAclRuleError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_cluster_acl_rules(
    configuration: &configuration::Configuration,
    region: &str,
    cluster_id: &str,
    page: Option<i32>,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodK8sPeriodV1PeriodListClusterAclRulesResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodK8sPeriodV1PeriodListClusterAclRulesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListClusterAclRulesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn set_cluster_acl_rules(
    configuration: &configuration::Configuration,
    region: &str,
    cluster_id: &str,
    set_cluster_acl_rules_request: models::SetClusterAclRulesRequest,
) -> Result<
    models::ScalewayPeriodK8sPeriodV1PeriodSetClusterAclRulesResponse,
    Error<SetClusterAclRulesError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_cluster_id = cluster_id;
    let p_set_cluster_acl_rules_request = set_cluster_acl_rules_request;
    ...
    req_builder = req_builder.json(&p_set_cluster_acl_rules_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodK8sPeriodV1PeriodSetClusterAclRulesResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodK8sPeriodV1PeriodSetClusterAclRulesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SetClusterAclRulesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
