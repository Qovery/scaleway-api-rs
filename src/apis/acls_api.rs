...
/// struct for typed errors of method [`add_instance_acl_rules`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddInstanceAclRulesError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`delete_instance_acl_rules`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteInstanceAclRulesError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`list_instance_acl_rules`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListInstanceAclRulesError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`set_instance_acl_rules`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SetInstanceAclRulesError {
    UnknownValue(serde_json::Value),
}

/// Add an additional ACL rule to a Database Instance.
pub async fn add_instance_acl_rules(
    configuration: &configuration::Configuration,
    region: &str,
    instance_id: &str,
    add_instance_acl_rules_request: models::AddInstanceAclRulesRequest,
) -> Result<
    models::ScalewayPeriodRdbPeriodV1PeriodAddInstanceAclRulesResponse,
    Error<AddInstanceAclRulesError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_instance_id = instance_id;
    let p_add_instance_acl_rules_request = add_instance_acl_rules_request;
    ...
    req_builder = req_builder.json(&p_add_instance_acl_rules_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodAddInstanceAclRulesResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodAddInstanceAclRulesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<AddInstanceAclRulesError> = serde_json::from_str(&content).ok();
...
pub async fn delete_instance_acl_rules(
    configuration: &configuration::Configuration,
    region: &str,
    instance_id: &str,
    delete_instance_acl_rules_request: models::DeleteInstanceAclRulesRequest,
) -> Result<
    models::ScalewayPeriodRdbPeriodV1PeriodDeleteInstanceAclRulesResponse,
    Error<DeleteInstanceAclRulesError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_instance_id = instance_id;
    let p_delete_instance_acl_rules_request = delete_instance_acl_rules_request;
    ...
    req_builder = req_builder.json(&p_delete_instance_acl_rules_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodDeleteInstanceAclRulesResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodDeleteInstanceAclRulesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<DeleteInstanceAclRulesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodListInstanceAclRulesResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodListInstanceAclRulesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListInstanceAclRulesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn set_instance_acl_rules(
    ...
    region: &str,
    instance_id: &str,
    set_instance_acl_rules_request: models::SetInstanceAclRulesRequest,
) -> Result<
    models::ScalewayPeriodRdbPeriodV1PeriodSetInstanceAclRulesResponse,
    Error<SetInstanceAclRulesError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_instance_id = instance_id;
    let p_set_instance_acl_rules_request = set_instance_acl_rules_request;
    ...
    req_builder = req_builder.json(&p_set_instance_acl_rules_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodSetInstanceAclRulesResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodSetInstanceAclRulesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SetInstanceAclRulesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
