...
/// struct for typed errors of method `delete_subscriber`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method `list_subscriber`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListSubscriberError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `subscribe_to_lb`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SubscribeToLbError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `unsubscribe_from_lb`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UnsubscribeFromLbError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `update_subscriber`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn create_subscriber(configuration: &configuration::Configuration, region: &str, inline_object50: crate::models::InlineObject50) -> Result<crate::models::ScalewayLbV1Subscriber, Error<CreateSubscriberError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/subscribers", configuration.base_path, region=crate::apis::urlencode(region));
...
pub async fn delete_subscriber(configuration: &configuration::Configuration, region: &str, subscriber_id: &str) -> Result<(), Error<DeleteSubscriberError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/lb/subscriber/{subscriber_id}", configuration.base_path, region=crate::apis::urlencode(region), subscriber_id=crate::apis::urlencode(subscriber_id));
...
pub async fn get_subscriber(configuration: &configuration::Configuration, region: &str, subscriber_id: &str) -> Result<crate::models::ScalewayLbV1Subscriber, Error<GetSubscriberError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/subscribers/{subscriber_id}", configuration.base_path, region=crate::apis::urlencode(region), subscriber_id=crate::apis::urlencode(subscriber_id));
...
pub async fn list_subscriber(configuration: &configuration::Configuration, region: &str, page: f32, name: Option<&str>, order_by: Option<&str>, page_size: Option<f32>, organization_id: Option<&str>, project_id: Option<&str>) -> Result<crate::models::ScalewayLbV1ListSubscriberResponse, Error<ListSubscriberError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListSubscriberError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn subscribe_to_lb(configuration: &configuration::Configuration, region: &str, lb_id: &str, inline_object40: crate::models::InlineObject40) -> Result<crate::models::ScalewayLbV1Lb, Error<SubscribeToLbError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/lb/{lb_id}/subscribe", configuration.base_path, region=crate::apis::urlencode(region), lb_id=crate::apis::urlencode(lb_id));
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SubscribeToLbError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn unsubscribe_from_lb(configuration: &configuration::Configuration, region: &str, lb_id: &str) -> Result<crate::models::ScalewayLbV1Lb, Error<UnsubscribeFromLbError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/lb/{lb_id}/unsubscribe", configuration.base_path, region=crate::apis::urlencode(region), lb_id=crate::apis::urlencode(lb_id));
    let mut local_var_req_builder = local_var_client.delete(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnsubscribeFromLbError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_subscriber(configuration: &configuration::Configuration, region: &str, subscriber_id: &str, inline_object51: crate::models::InlineObject51) -> Result<crate::models::ScalewayLbV1Subscriber, Error<UpdateSubscriberError>> {
