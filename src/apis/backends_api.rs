...
/// struct for typed errors of method `add_backend_servers`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddBackendServersError {
...
/// struct for typed errors of method `remove_backend_servers`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RemoveBackendServersError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `set_backend_servers`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SetBackendServersError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method `update_health_check`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn add_backend_servers(configuration: &configuration::Configuration, region: &str, backend_id: &str, inline_object33: crate::models::InlineObject33) -> Result<crate::models::ScalewayLbV1Backend, Error<AddBackendServersError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/backends/{backend_id}/servers", configuration.base_path, region=crate::apis::urlencode(region), backend_id=crate::apis::urlencode(backend_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddBackendServersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn create_backend(configuration: &configuration::Configuration, region: &str, lb_id: &str, inline_object43: crate::models::InlineObject43) -> Result<crate::models::ScalewayLbV1Backend, Error<CreateBackendError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/lbs/{lb_id}/backends", configuration.base_path, region=crate::apis::urlencode(region), lb_id=crate::apis::urlencode(lb_id));
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn delete_backend(configuration: &configuration::Configuration, region: &str, backend_id: &str) -> Result<(), Error<DeleteBackendError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/backends/{backend_id}", configuration.base_path, region=crate::apis::urlencode(region), backend_id=crate::apis::urlencode(backend_id));
...
pub async fn get_backend(configuration: &configuration::Configuration, region: &str, backend_id: &str) -> Result<crate::models::ScalewayLbV1Backend, Error<GetBackendError>> {
...
pub async fn list_backends(configuration: &configuration::Configuration, region: &str, lb_id: &str, page: f32, name: Option<&str>, order_by: Option<&str>, page_size: Option<f32>) -> Result<crate::models::ScalewayLbV1ListBackendsResponse, Error<ListBackendsError>> {
...
pub async fn remove_backend_servers(configuration: &configuration::Configuration, region: &str, backend_id: &str, inline_object34: crate::models::InlineObject34) -> Result<crate::models::ScalewayLbV1Backend, Error<RemoveBackendServersError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveBackendServersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn set_backend_servers(configuration: &configuration::Configuration, region: &str, backend_id: &str, inline_object32: crate::models::InlineObject32) -> Result<crate::models::ScalewayLbV1Backend, Error<SetBackendServersError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetBackendServersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_backend(configuration: &configuration::Configuration, region: &str, backend_id: &str, inline_object30: crate::models::InlineObject30) -> Result<crate::models::ScalewayLbV1Backend, Error<UpdateBackendError>> {
...
pub async fn update_health_check(configuration: &configuration::Configuration, region: &str, backend_id: &str, inline_object31: crate::models::InlineObject31) -> Result<crate::models::ScalewayLbV1HealthCheck, Error<UpdateHealthCheckError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/backends/{backend_id}/healthcheck", configuration.base_path, region=crate::apis::urlencode(region), backend_id=crate::apis::urlencode(backend_id));
    let mut local_var_req_builder = local_var_client.put(local_var_uri_str.as_str());
