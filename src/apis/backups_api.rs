...
pub async fn create_database_backup(
    ...
    region: &str,
    create_database_backup_request: models::CreateDatabaseBackupRequest,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodDatabaseBackup, Error<CreateDatabaseBackupError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_create_database_backup_request = create_database_backup_request;
    ...
    req_builder = req_builder.json(&p_create_database_backup_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodDatabaseBackup`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodDatabaseBackup`")))),
        }
    } else {
        let content = resp.text().await?;
...
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodDatabaseBackup, Error<DeleteDatabaseBackupError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_database_backup_id = database_backup_id;

    let uri_str = format!(
        "{}/rdb/v1/regions/{region}/backups/{database_backup_id}",
        configuration.base_path,
        region = crate::apis::urlencode(p_region),
        database_backup_id = crate::apis::urlencode(p_database_backup_id)
    );
    let mut req_builder = configuration
        .client
...
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodDatabaseBackup, Error<ExportDatabaseBackupError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_database_backup_id = database_backup_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ExportDatabaseBackupError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_database_backup(
    ...
    region: &str,
    database_backup_id: &str,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodDatabaseBackup, Error<GetDatabaseBackupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_database_backup_id = database_backup_id;
...
> {
    ...
    if let Some(ref param_value) = p_instance_id {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodListDatabaseBackupsResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodListDatabaseBackupsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn restore_database_backup(
    ...
    region: &str,
    database_backup_id: &str,
    restore_database_backup_request: models::RestoreDatabaseBackupRequest,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodDatabaseBackup, Error<RestoreDatabaseBackupError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_database_backup_id = database_backup_id;
    let p_restore_database_backup_request = restore_database_backup_request;
    ...
    req_builder = req_builder.json(&p_restore_database_backup_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RestoreDatabaseBackupError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn update_database_backup(
    ...
    region: &str,
    database_backup_id: &str,
    update_database_backup_request: models::UpdateDatabaseBackupRequest,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodDatabaseBackup, Error<UpdateDatabaseBackupError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_database_backup_id = database_backup_id;
    let p_update_database_backup_request = update_database_backup_request;
    ...
    req_builder = req_builder.json(&p_update_database_backup_request);
