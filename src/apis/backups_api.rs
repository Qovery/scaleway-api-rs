...
pub async fn create_database_backup(configuration: &configuration::Configuration, region: &str, inline_object55: crate::models::InlineObject55) -> Result<crate::models::ScalewayRdbV1DatabaseBackup, Error<CreateDatabaseBackupError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/rdb/v1/regions/{region}/backups", configuration.base_path, region=crate::apis::urlencode(region));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateDatabaseBackupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn delete_database_backup(configuration: &configuration::Configuration, region: &str, database_backup_id: &str) -> Result<crate::models::ScalewayRdbV1DatabaseBackup, Error<DeleteDatabaseBackupError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/rdb/v1/regions/{region}/backups/{database_backup_id}", configuration.base_path, region=crate::apis::urlencode(region), database_backup_id=crate::apis::urlencode(database_backup_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteDatabaseBackupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn export_database_backup(configuration: &configuration::Configuration, region: &str, database_backup_id: &str, body: serde_json::Value) -> Result<crate::models::ScalewayRdbV1DatabaseBackup, Error<ExportDatabaseBackupError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/rdb/v1/regions/{region}/backups/{database_backup_id}/export", configuration.base_path, region=crate::apis::urlencode(region), database_backup_id=crate::apis::urlencode(database_backup_id));
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExportDatabaseBackupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_database_backup(configuration: &configuration::Configuration, region: &str, database_backup_id: &str) -> Result<crate::models::ScalewayRdbV1DatabaseBackup, Error<GetDatabaseBackupError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDatabaseBackupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_database_backups(configuration: &configuration::Configuration, region: &str, name: Option<&str>, order_by: Option<&str>, instance_id: Option<&str>, organization_id: Option<&str>, project_id: Option<&str>, page: Option<f32>, page_size: Option<f32>) -> Result<crate::models::ScalewayRdbV1ListDatabaseBackupsResponse, Error<ListDatabaseBackupsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListDatabaseBackupsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn restore_database_backup(configuration: &configuration::Configuration, region: &str, database_backup_id: &str, inline_object57: crate::models::InlineObject57) -> Result<crate::models::ScalewayRdbV1DatabaseBackup, Error<RestoreDatabaseBackupError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/rdb/v1/regions/{region}/backups/{database_backup_id}/restore", configuration.base_path, region=crate::apis::urlencode(region), database_backup_id=crate::apis::urlencode(database_backup_id));
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RestoreDatabaseBackupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_database_backup(configuration: &configuration::Configuration, region: &str, database_backup_id: &str, inline_object56: crate::models::InlineObject56) -> Result<crate::models::ScalewayRdbV1DatabaseBackup, Error<UpdateDatabaseBackupError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateDatabaseBackupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
