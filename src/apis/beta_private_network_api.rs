...
/// struct for typed errors of method `attach_private_network`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AttachPrivateNetworkError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `detach_private_network`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DetachPrivateNetworkError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `list_lb_private_networks`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListLbPrivateNetworksError {
    UnknownValue(serde_json::Value),
}


pub async fn attach_private_network(configuration: &configuration::Configuration, region: &str, lb_id: &str, private_network_id: &str, inline_object47: crate::models::InlineObject47) -> Result<crate::models::ScalewayLbV1PrivateNetwork, Error<AttachPrivateNetworkError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/lbs/{lb_id}/private-networks/{private_network_id}/attach", configuration.base_path, region=crate::apis::urlencode(region), lb_id=crate::apis::urlencode(lb_id), private_network_id=crate::apis::urlencode(private_network_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AttachPrivateNetworkError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn detach_private_network(configuration: &configuration::Configuration, region: &str, private_network_id: &str, lb_id: &str, body: serde_json::Value) -> Result<(), Error<DetachPrivateNetworkError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/lbs/{lb_id}/private-networks/{private_network_id}/detach", configuration.base_path, region=crate::apis::urlencode(region), private_network_id=crate::apis::urlencode(private_network_id), lb_id=crate::apis::urlencode(lb_id));
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DetachPrivateNetworkError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_lb_private_networks(configuration: &configuration::Configuration, region: &str, lb_id: &str, order_by: Option<crate::models::ScalewayLbV1ListPrivateNetworksRequestOrderBy>, page_size: Option<f32>, page: Option<f32>) -> Result<crate::models::ScalewayLbV1ListLbPrivateNetworksResponse, Error<ListLbPrivateNetworksError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/lbs/{lb_id}/private-networks", configuration.base_path, region=crate::apis::urlencode(region), lb_id=crate::apis::urlencode(lb_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListLbPrivateNetworksError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
