...
pub async fn get_bmc_access(configuration: &configuration::Configuration, zone: &str, server_id: &str) -> Result<crate::models::ScalewayBaremetalV1BmcAccess, Error<GetBmcAccessError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/baremetal/v1/zones/{zone}/servers/{server_id}/bmc-access", configuration.base_path, zone=crate::apis::urlencode(zone), server_id=crate::apis::urlencode(server_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBmcAccessError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn start_bmc_access(configuration: &configuration::Configuration, zone: &str, server_id: &str, inline_object24: crate::models::InlineObject24) -> Result<crate::models::ScalewayBaremetalV1BmcAccess, Error<StartBmcAccessError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StartBmcAccessError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn stop_bmc_access(configuration: &configuration::Configuration, zone: &str, server_id: &str) -> Result<(), Error<StopBmcAccessError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StopBmcAccessError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
