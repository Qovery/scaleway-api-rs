...
pub async fn get_bootscript(
    ...
    zone: &str,
    bootscript_id: &str,
) -> Result<crate::models::ScalewayInstanceV1GetBootscriptResponse, Error<GetBootscriptError>> {
...
pub async fn list_bootscripts(
    ...
    per_page: Option<f32>,
    page: Option<f32>,
) -> Result<crate::models::ScalewayInstanceV1ListBootscriptsResponse, Error<ListBootscriptsError>> {
    let local_var_client = &configuration.client;
