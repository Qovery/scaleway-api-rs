...
pub async fn get_bootscript(configuration: &configuration::Configuration, zone: &str, bootscript_id: &str) -> Result<crate::models::ScalewayInstanceV1GetBootscriptResponse, Error<GetBootscriptError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/bootscripts/{bootscript_id}", configuration.base_path, zone=crate::apis::urlencode(zone), bootscript_id=crate::apis::urlencode(bootscript_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBootscriptError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_bootscripts(configuration: &configuration::Configuration, zone: &str, arch: Option<&str>, title: Option<&str>, default: Option<bool>, public: Option<bool>, per_page: Option<f32>, page: Option<f32>) -> Result<crate::models::ScalewayInstanceV1ListBootscriptsResponse, Error<ListBootscriptsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/bootscripts", configuration.base_path, zone=crate::apis::urlencode(zone));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListBootscriptsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
