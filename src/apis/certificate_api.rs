...
pub async fn create_certificate(configuration: &configuration::Configuration, region: &str, lb_id: &str, inline_object44: crate::models::InlineObject44) -> Result<crate::models::ScalewayLbV1Certificate, Error<CreateCertificateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/lbs/{lb_id}/certificates", configuration.base_path, region=crate::apis::urlencode(region), lb_id=crate::apis::urlencode(lb_id));
...
pub async fn delete_certificate(configuration: &configuration::Configuration, region: &str, certificate_id: &str) -> Result<(), Error<DeleteCertificateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/certificates/{certificate_id}", configuration.base_path, region=crate::apis::urlencode(region), certificate_id=crate::apis::urlencode(certificate_id));
...
pub async fn get_certificate(configuration: &configuration::Configuration, region: &str, certificate_id: &str) -> Result<crate::models::ScalewayLbV1Certificate, Error<GetCertificateError>> {
...
pub async fn list_certificates(configuration: &configuration::Configuration, region: &str, lb_id: &str, order_by: Option<&str>, page: Option<f32>, page_size: Option<f32>, name: Option<&str>) -> Result<crate::models::ScalewayLbV1ListCertificatesResponse, Error<ListCertificatesError>> {
...
pub async fn update_certificate(configuration: &configuration::Configuration, region: &str, certificate_id: &str, inline_object35: crate::models::InlineObject35) -> Result<crate::models::ScalewayLbV1Certificate, Error<UpdateCertificateError>> {
