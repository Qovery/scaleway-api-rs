...
pub async fn create_database(configuration: &configuration::Configuration, region: &str, instance_id: &str, inline_object64: crate::models::InlineObject64) -> Result<crate::models::ScalewayRdbV1Database, Error<CreateDatabaseError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/rdb/v1/regions/{region}/instances/{instance_id}/databases", configuration.base_path, region=crate::apis::urlencode(region), instance_id=crate::apis::urlencode(instance_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateDatabaseError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn delete_database(configuration: &configuration::Configuration, region: &str, instance_id: &str, name: &str) -> Result<(), Error<DeleteDatabaseError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/rdb/v1/regions/{region}/instances/{instance_id}/databases/{name}", configuration.base_path, region=crate::apis::urlencode(region), instance_id=crate::apis::urlencode(instance_id), name=crate::apis::urlencode(name));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteDatabaseError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_databases(configuration: &configuration::Configuration, region: &str, instance_id: &str, name: Option<&str>, managed: Option<bool>, owner: Option<&str>, order_by: Option<&str>, page: Option<f32>, page_size: Option<f32>) -> Result<crate::models::ScalewayRdbV1ListDatabasesResponse, Error<ListDatabasesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListDatabasesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
