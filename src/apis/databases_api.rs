...
pub async fn create_database(
    ...
    region: &str,
    instance_id: &str,
    create_database_request: crate::models::CreateDatabaseRequest,
) -> Result<crate::models::ScalewayPeriodRdbPeriodV1PeriodDatabase, Error<CreateDatabaseError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&create_database_request);
...
pub async fn list_databases(
    ...
    crate::models::ScalewayPeriodRdbPeriodV1PeriodListDatabasesResponse,
