...
/// struct for typed errors of method `list_frontends`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListFrontendsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `update_frontend`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateFrontendError {
    UnknownValue(serde_json::Value),
}


pub async fn create_frontend(configuration: &configuration::Configuration, region: &str, lb_id: &str, inline_object45: crate::models::InlineObject45) -> Result<crate::models::ScalewayLbV1Frontend, Error<CreateFrontendError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/lbs/{lb_id}/frontends", configuration.base_path, region=crate::apis::urlencode(region), lb_id=crate::apis::urlencode(lb_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateFrontendError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn delete_frontend(configuration: &configuration::Configuration, region: &str, frontend_id: &str) -> Result<(), Error<DeleteFrontendError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/frontends/{frontend_id}", configuration.base_path, region=crate::apis::urlencode(region), frontend_id=crate::apis::urlencode(frontend_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteFrontendError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_frontend(configuration: &configuration::Configuration, region: &str, frontend_id: &str) -> Result<crate::models::ScalewayLbV1Frontend, Error<GetFrontendError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFrontendError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_frontends(configuration: &configuration::Configuration, region: &str, lb_id: &str, page: f32, name: Option<&str>, order_by: Option<&str>, page_size: Option<f32>) -> Result<crate::models::ScalewayLbV1ListFrontendsResponse, Error<ListFrontendsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListFrontendsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_frontend(configuration: &configuration::Configuration, region: &str, frontend_id: &str, inline_object36: crate::models::InlineObject36) -> Result<crate::models::ScalewayLbV1Frontend, Error<UpdateFrontendError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateFrontendError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
