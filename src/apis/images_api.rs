...
pub async fn create_image(configuration: &configuration::Configuration, zone: &str, inline_object: crate::models::InlineObject) -> Result<crate::models::ScalewayInstanceV1CreateImageResponse, Error<CreateImageError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/images", configuration.base_path, zone=crate::apis::urlencode(zone));
...
pub async fn delete_image(configuration: &configuration::Configuration, zone: &str, image_id: &str) -> Result<(), Error<DeleteImageError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/images/{image_id}", configuration.base_path, zone=crate::apis::urlencode(zone), image_id=crate::apis::urlencode(image_id));
...
pub async fn delete_image1(configuration: &configuration::Configuration, region: &str, image_id: &str) -> Result<crate::models::ScalewayRegistryV1Image, Error<DeleteImage1Error>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/registry/v1/regions/{region}/images/{image_id}", configuration.base_path, region=crate::apis::urlencode(region), image_id=crate::apis::urlencode(image_id));
    let mut local_var_req_builder = local_var_client.delete(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteImage1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_image(configuration: &configuration::Configuration, zone: &str, image_id: &str) -> Result<crate::models::ScalewayInstanceV1GetImageResponse, Error<GetImageError>> {
...
pub async fn get_image1(configuration: &configuration::Configuration, region: &str, image_id: &str) -> Result<crate::models::ScalewayRegistryV1Image, Error<GetImage1Error>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetImage1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_images(configuration: &configuration::Configuration, zone: &str, organization: Option<&str>, per_page: Option<f32>, page: Option<f32>, name: Option<&str>, public: Option<bool>, arch: Option<&str>, project: Option<&str>) -> Result<crate::models::ScalewayInstanceV1ListImagesResponse, Error<ListImagesError>> {
    ...
    if let Some(ref local_var_str) = public {
        local_var_req_builder = local_var_req_builder.query(&[("public", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = arch {
        local_var_req_builder = local_var_req_builder.query(&[("arch", &local_var_str.to_string())]);
    }
...
pub async fn list_images1(configuration: &configuration::Configuration, region: &str, page: Option<f32>, page_size: Option<f32>, order_by: Option<&str>, namespace_id: Option<&str>, name: Option<&str>, organization_id: Option<&str>, project_id: Option<&str>) -> Result<crate::models::ScalewayRegistryV1ListImagesResponse, Error<ListImages1Error>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/registry/v1/regions/{region}/images", configuration.base_path, region=crate::apis::urlencode(region));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListImages1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn set_image(configuration: &configuration::Configuration, zone: &str, id: &str, inline_object1: crate::models::InlineObject1) -> Result<crate::models::ScalewayInstanceV1SetImageResponse, Error<SetImageError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/images/{id}", configuration.base_path, zone=crate::apis::urlencode(zone), id=crate::apis::urlencode(id));
...
pub async fn update_image(configuration: &configuration::Configuration, region: &str, image_id: &str, inline_object52: crate::models::InlineObject52) -> Result<crate::models::ScalewayRegistryV1Image, Error<UpdateImageError>> {
