...
pub async fn delete_image(
    ...
    region: &str,
    image_id: &str,
) -> Result<crate::models::ScalewayRegistryV1Image, Error<DeleteImageError>> {
...
pub async fn get_image(
    ...
    region: &str,
    image_id: &str,
) -> Result<crate::models::ScalewayRegistryV1Image, Error<GetImageError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ScalewayRegistryV1ListImagesResponse, Error<ListImagesError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ScalewayRegistryV1Image, Error<UpdateImageError>> {
    let local_var_configuration = configuration;
