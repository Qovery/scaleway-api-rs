...
pub async fn export_raw_dns_zone(
    ...
    dns_zone: &str,
    format: Option<&str>,
) -> Result<models::ScalewayPeriodStdPeriodFile, Error<ExportRawDnsZoneError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ExportRawDnsZoneError> = serde_json::from_str(&content).ok();
...
pub async fn import_provider_dns_zone(
    configuration: &configuration::Configuration,
    dns_zone: &str,
    import_provider_dns_zone_request: models::ImportProviderDnsZoneRequest,
) -> Result<
    models::ScalewayPeriodDomainPeriodV2beta1PeriodImportProviderDnsZoneResponse,
    Error<ImportProviderDnsZoneError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_dns_zone = dns_zone;
    let p_import_provider_dns_zone_request = import_provider_dns_zone_request;
    ...
    req_builder = req_builder.json(&p_import_provider_dns_zone_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodDomainPeriodV2beta1PeriodImportProviderDnsZoneResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodDomainPeriodV2beta1PeriodImportProviderDnsZoneResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ImportProviderDnsZoneError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn import_raw_dns_zone(
    configuration: &configuration::Configuration,
    dns_zone: &str,
    import_raw_dns_zone_request: models::ImportRawDnsZoneRequest,
) -> Result<
    models::ScalewayPeriodDomainPeriodV2beta1PeriodImportRawDnsZoneResponse,
    Error<ImportRawDnsZoneError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_dns_zone = dns_zone;
    let p_import_raw_dns_zone_request = import_raw_dns_zone_request;
    ...
    req_builder = req_builder.json(&p_import_raw_dns_zone_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodDomainPeriodV2beta1PeriodImportRawDnsZoneResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodDomainPeriodV2beta1PeriodImportRawDnsZoneResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ImportRawDnsZoneError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
