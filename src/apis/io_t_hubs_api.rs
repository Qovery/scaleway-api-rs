...
pub async fn create_hub(configuration: &configuration::Configuration, region: &str, inline_object85: crate::models::InlineObject85) -> Result<crate::models::ScalewayIotV1Hub, Error<CreateHubError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/iot/v1/regions/{region}/hubs", configuration.base_path, region=crate::apis::urlencode(region));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateHubError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn delete_hub(configuration: &configuration::Configuration, region: &str, hub_id: &str, delete_devices: Option<bool>) -> Result<(), Error<DeleteHubError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/iot/v1/regions/{region}/hubs/{hub_id}", configuration.base_path, region=crate::apis::urlencode(region), hub_id=crate::apis::urlencode(hub_id));
    let mut local_var_req_builder = local_var_client.delete(local_var_uri_str.as_str());

    if let Some(ref local_var_str) = delete_devices {
        local_var_req_builder = local_var_req_builder.query(&[("delete_devices", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteHubError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn disable_hub(configuration: &configuration::Configuration, region: &str, hub_id: &str, body: serde_json::Value) -> Result<crate::models::ScalewayIotV1Hub, Error<DisableHubError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/iot/v1/regions/{region}/hubs/{hub_id}/disable", configuration.base_path, region=crate::apis::urlencode(region), hub_id=crate::apis::urlencode(hub_id));
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DisableHubError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn enable_hub(configuration: &configuration::Configuration, region: &str, hub_id: &str, body: serde_json::Value) -> Result<crate::models::ScalewayIotV1Hub, Error<EnableHubError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/iot/v1/regions/{region}/hubs/{hub_id}/enable", configuration.base_path, region=crate::apis::urlencode(region), hub_id=crate::apis::urlencode(hub_id));
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EnableHubError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_hub(configuration: &configuration::Configuration, region: &str, hub_id: &str) -> Result<crate::models::ScalewayIotV1Hub, Error<GetHubError>> {
...
pub async fn get_hub_ca(configuration: &configuration::Configuration, region: &str, hub_id: &str) -> Result<crate::models::ScalewayIotV1GetHubCaResponse, Error<GetHubCaError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/iot/v1/regions/{region}/hubs/{hub_id}/ca", configuration.base_path, region=crate::apis::urlencode(region), hub_id=crate::apis::urlencode(hub_id));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn get_hub_metrics(configuration: &configuration::Configuration, region: &str, hub_id: &str, start_date: String) -> Result<crate::models::ScalewayIotV1GetHubMetricsResponse, Error<GetHubMetricsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/iot/v1/regions/{region}/hubs/{hub_id}/metrics", configuration.base_path, region=crate::apis::urlencode(region), hub_id=crate::apis::urlencode(hub_id));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHubMetricsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_hubs(configuration: &configuration::Configuration, region: &str, page: Option<f32>, page_size: Option<f32>, order_by: Option<&str>, project_id: Option<&str>, organization_id: Option<&str>, name: Option<&str>) -> Result<crate::models::ScalewayIotV1ListHubsResponse, Error<ListHubsError>> {
...
pub async fn set_hub_ca(configuration: &configuration::Configuration, region: &str, hub_id: &str, inline_object87: crate::models::InlineObject87) -> Result<crate::models::ScalewayIotV1Hub, Error<SetHubCaError>> {
...
pub async fn update_hub(configuration: &configuration::Configuration, region: &str, hub_id: &str, inline_object86: crate::models::InlineObject86) -> Result<crate::models::ScalewayIotV1Hub, Error<UpdateHubError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateHubError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
