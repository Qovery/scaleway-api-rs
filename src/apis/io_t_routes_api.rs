...
/// struct for typed errors of method `create_route1`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateRoute1Error {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `delete_route1`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteRoute1Error {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `get_route1`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetRoute1Error {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `list_routes1`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListRoutes1Error {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `update_route1`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateRoute1Error {
    UnknownValue(serde_json::Value),
}
...
pub async fn create_route1(configuration: &configuration::Configuration, region: &str, inline_object89: crate::models::InlineObject89) -> Result<crate::models::ScalewayIotV1Route, Error<CreateRoute1Error>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/iot/v1/regions/{region}/routes", configuration.base_path, region=crate::apis::urlencode(region));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateRoute1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn delete_route1(configuration: &configuration::Configuration, region: &str, route_id: &str) -> Result<(), Error<DeleteRoute1Error>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/iot/v1/regions/{region}/routes/{route_id}", configuration.base_path, region=crate::apis::urlencode(region), route_id=crate::apis::urlencode(route_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteRoute1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_route1(configuration: &configuration::Configuration, region: &str, route_id: &str) -> Result<crate::models::ScalewayIotV1Route, Error<GetRoute1Error>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRoute1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_routes1(configuration: &configuration::Configuration, region: &str, page: Option<f32>, page_size: Option<f32>, order_by: Option<&str>, hub_id: Option<&str>, name: Option<&str>) -> Result<crate::models::ScalewayIotV1ListRoutesResponse, Error<ListRoutes1Error>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListRoutes1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_route1(configuration: &configuration::Configuration, region: &str, route_id: &str, inline_object90: crate::models::InlineObject90) -> Result<crate::models::ScalewayIotV1Route, Error<UpdateRoute1Error>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateRoute1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
