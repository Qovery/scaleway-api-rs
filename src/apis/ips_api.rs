...
/// struct for typed errors of method `create_ip1`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateIp1Error {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `get_ip1`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetIp1Error {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method `release_ip`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReleaseIpError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `update_ip1`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateIp1Error {
    UnknownValue(serde_json::Value),
}


pub async fn create_ip1(configuration: &configuration::Configuration, region: &str, inline_object38: crate::models::InlineObject38) -> Result<crate::models::ScalewayLbV1Ip, Error<CreateIp1Error>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/ips", configuration.base_path, region=crate::apis::urlencode(region));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateIp1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_ip1(configuration: &configuration::Configuration, region: &str, ip_id: &str) -> Result<crate::models::ScalewayLbV1Ip, Error<GetIp1Error>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/ips/{ip_id}", configuration.base_path, region=crate::apis::urlencode(region), ip_id=crate::apis::urlencode(ip_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetIp1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_ips(configuration: &configuration::Configuration, region: &str, page: f32, page_size: Option<f32>, ip_address: Option<&str>, organization_id: Option<&str>, project_id: Option<&str>) -> Result<crate::models::ScalewayLbV1ListIpsResponse, Error<ListIpsError>> {
...
pub async fn release_ip(configuration: &configuration::Configuration, region: &str, ip_id: &str) -> Result<(), Error<ReleaseIpError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReleaseIpError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_ip1(configuration: &configuration::Configuration, region: &str, ip_id: &str, inline_object39: crate::models::InlineObject39) -> Result<crate::models::ScalewayLbV1Ip, Error<UpdateIp1Error>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateIp1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
