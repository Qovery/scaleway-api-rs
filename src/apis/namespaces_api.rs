...
pub async fn create_namespace(
...
) -> Result<models::ScalewayPeriodRegistryPeriodV1PeriodNamespace, Error<CreateNamespaceError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRegistryPeriodV1PeriodNamespace`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRegistryPeriodV1PeriodNamespace`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_namespace(
    ...
    region: &str,
    namespace_id: &str,
) -> Result<models::ScalewayPeriodRegistryPeriodV1PeriodNamespace, Error<DeleteNamespaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        region = crate::apis::urlencode(p_region),
        namespace_id = crate::apis::urlencode(p_namespace_id)
    );
    let mut req_builder = configuration
        .client
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteNamespaceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_namespace(
    ...
    region: &str,
    namespace_id: &str,
) -> Result<models::ScalewayPeriodRegistryPeriodV1PeriodNamespace, Error<GetNamespaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_namespace_id = namespace_id;
...
pub async fn list_namespaces(
    ...
    models::ScalewayPeriodRegistryPeriodV1PeriodListNamespacesResponse,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRegistryPeriodV1PeriodListNamespacesResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRegistryPeriodV1PeriodListNamespacesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_namespace(
...
) -> Result<models::ScalewayPeriodRegistryPeriodV1PeriodNamespace, Error<UpdateNamespaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_namespace_id = namespace_id;
    let p_update_namespace_request = update_namespace_request;
    ...
    req_builder = req_builder.json(&p_update_namespace_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateNamespaceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
