...
pub async fn create_namespace(configuration: &configuration::Configuration, region: &str, inline_object53: crate::models::InlineObject53) -> Result<crate::models::ScalewayRegistryV1Namespace, Error<CreateNamespaceError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/registry/v1/regions/{region}/namespaces", configuration.base_path, region=crate::apis::urlencode(region));
...
pub async fn delete_namespace(configuration: &configuration::Configuration, region: &str, namespace_id: &str) -> Result<crate::models::ScalewayRegistryV1Namespace, Error<DeleteNamespaceError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/registry/v1/regions/{region}/namespaces/{namespace_id}", configuration.base_path, region=crate::apis::urlencode(region), namespace_id=crate::apis::urlencode(namespace_id));
...
pub async fn get_namespace(configuration: &configuration::Configuration, region: &str, namespace_id: &str) -> Result<crate::models::ScalewayRegistryV1Namespace, Error<GetNamespaceError>> {
...
pub async fn list_namespaces(configuration: &configuration::Configuration, region: &str, page: Option<f32>, page_size: Option<f32>, order_by: Option<&str>, organization_id: Option<&str>, project_id: Option<&str>, name: Option<&str>) -> Result<crate::models::ScalewayRegistryV1ListNamespacesResponse, Error<ListNamespacesError>> {
...
pub async fn update_namespace(configuration: &configuration::Configuration, region: &str, namespace_id: &str, inline_object54: crate::models::InlineObject54) -> Result<crate::models::ScalewayRegistryV1Namespace, Error<UpdateNamespaceError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateNamespaceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
