...
pub async fn get_os(
    ...
    zone: &str,
    os_id: &str,
) -> Result<crate::models::ScalewayAppleSiliconV1alpha1Os, Error<GetOsError>> {
...
pub async fn list_os(
    ...
    name: Option<&str>,
) -> Result<crate::models::ScalewayAppleSiliconV1alpha1ListOsResponse, Error<ListOsError>> {
    let local_var_client = &configuration.client;
    ...
    if let Some(ref local_var_str) = server_type {
        local_var_req_builder =
            local_var_req_builder.query(&[("server_type", &local_var_str.to_string())]);
    }
