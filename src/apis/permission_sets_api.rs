...
/// struct for typed errors of method [`list_permission_sets`]
...
> {
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("organization_id", &organization_id.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListPermissionSetsError> =
