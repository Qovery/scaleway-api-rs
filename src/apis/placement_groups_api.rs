...
pub async fn create_placement_group(configuration: &configuration::Configuration, zone: &str, inline_object4: crate::models::InlineObject4) -> Result<crate::models::ScalewayInstanceV1CreatePlacementGroupResponse, Error<CreatePlacementGroupError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/placement_groups", configuration.base_path, zone=crate::apis::urlencode(zone));
...
pub async fn delete_placement_group(configuration: &configuration::Configuration, zone: &str, placement_group_id: &str) -> Result<(), Error<DeletePlacementGroupError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/placement_groups/{placement_group_id}", configuration.base_path, zone=crate::apis::urlencode(zone), placement_group_id=crate::apis::urlencode(placement_group_id));
...
pub async fn get_placement_group(configuration: &configuration::Configuration, zone: &str, placement_group_id: &str) -> Result<crate::models::ScalewayInstanceV1GetPlacementGroupResponse, Error<GetPlacementGroupError>> {
...
pub async fn get_placement_group_servers(configuration: &configuration::Configuration, zone: &str, placement_group_id: &str) -> Result<crate::models::ScalewayInstanceV1GetPlacementGroupServersResponse, Error<GetPlacementGroupServersError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/placement_groups/{placement_group_id}/servers", configuration.base_path, zone=crate::apis::urlencode(zone), placement_group_id=crate::apis::urlencode(placement_group_id));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPlacementGroupServersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_placement_groups(configuration: &configuration::Configuration, zone: &str, per_page: Option<f32>, page: Option<f32>, organization: Option<&str>, project: Option<&str>, name: Option<&str>) -> Result<crate::models::ScalewayInstanceV1ListPlacementGroupsResponse, Error<ListPlacementGroupsError>> {
...
pub async fn set_placement_group(configuration: &configuration::Configuration, zone: &str, placement_group_id: &str, inline_object5: crate::models::InlineObject5) -> Result<crate::models::ScalewayInstanceV1SetPlacementGroupResponse, Error<SetPlacementGroupError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetPlacementGroupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn set_placement_group_servers(configuration: &configuration::Configuration, zone: &str, placement_group_id: &str, inline_object7: crate::models::InlineObject7) -> Result<crate::models::ScalewayInstanceV1SetPlacementGroupServersResponse, Error<SetPlacementGroupServersError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetPlacementGroupServersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_placement_group(configuration: &configuration::Configuration, zone: &str, placement_group_id: &str, inline_object6: crate::models::InlineObject6) -> Result<crate::models::ScalewayInstanceV1UpdatePlacementGroupResponse, Error<UpdatePlacementGroupError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePlacementGroupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_placement_group_servers(configuration: &configuration::Configuration, zone: &str, placement_group_id: &str, inline_object8: crate::models::InlineObject8) -> Result<crate::models::ScalewayInstanceV1UpdatePlacementGroupServersResponse, Error<UpdatePlacementGroupServersError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePlacementGroupServersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
