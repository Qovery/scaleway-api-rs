...
pub async fn create_pool(configuration: &configuration::Configuration, region: &str, cluster_id: &str, inline_object78: crate::models::InlineObject78) -> Result<crate::models::ScalewayK8sV1Pool, Error<CreatePoolError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/k8s/v1/regions/{region}/clusters/{cluster_id}/pools", configuration.base_path, region=crate::apis::urlencode(region), cluster_id=crate::apis::urlencode(cluster_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePoolError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_pool(configuration: &configuration::Configuration, region: &str, pool_id: &str) -> Result<crate::models::ScalewayK8sV1Pool, Error<DeletePoolError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/k8s/v1/regions/{region}/pools/{pool_id}", configuration.base_path, region=crate::apis::urlencode(region), pool_id=crate::apis::urlencode(pool_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePoolError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_pool(configuration: &configuration::Configuration, region: &str, pool_id: &str) -> Result<crate::models::ScalewayK8sV1Pool, Error<GetPoolError>> {
...
pub async fn list_pools(configuration: &configuration::Configuration, region: &str, cluster_id: &str, order_by: Option<&str>, page: Option<f32>, page_size: Option<f32>, name: Option<&str>, status: Option<&str>) -> Result<crate::models::ScalewayK8sV1ListPoolsResponse, Error<ListPoolsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListPoolsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_pool(configuration: &configuration::Configuration, region: &str, pool_id: &str, inline_object80: crate::models::InlineObject80) -> Result<crate::models::ScalewayK8sV1Pool, Error<UpdatePoolError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePoolError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn upgrade_pool(configuration: &configuration::Configuration, region: &str, pool_id: &str, inline_object81: crate::models::InlineObject81) -> Result<crate::models::ScalewayK8sV1Pool, Error<UpgradePoolError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/k8s/v1/regions/{region}/pools/{pool_id}/upgrade", configuration.base_path, region=crate::apis::urlencode(region), pool_id=crate::apis::urlencode(pool_id));
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpgradePoolError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
