...
/// struct for typed errors of method [`migrate_pools_to_new_images`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MigratePoolsToNewImagesError {
    UnknownValue(serde_json::Value),
}
...
pub async fn create_pool(
    ...
    region: &str,
    cluster_id: &str,
    create_pool_request: models::CreatePoolRequest,
) -> Result<models::ScalewayPeriodK8sPeriodV1PeriodPool, Error<CreatePoolError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_cluster_id = cluster_id;
    let p_create_pool_request = create_pool_request;
    ...
    req_builder = req_builder.json(&p_create_pool_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodK8sPeriodV1PeriodPool`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodK8sPeriodV1PeriodPool`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreatePoolError> = serde_json::from_str(&content).ok();
...
pub async fn delete_pool(
    ...
    region: &str,
    pool_id: &str,
) -> Result<models::ScalewayPeriodK8sPeriodV1PeriodPool, Error<DeletePoolError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        region = crate::apis::urlencode(p_region),
        pool_id = crate::apis::urlencode(p_pool_id)
    );
    let mut req_builder = configuration
        .client
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeletePoolError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_pool(
    ...
    region: &str,
    pool_id: &str,
) -> Result<models::ScalewayPeriodK8sPeriodV1PeriodPool, Error<GetPoolError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_pool_id = pool_id;
...
pub async fn list_pools(
    ...
    name: Option<&str>,
    status: Option<&str>,
) -> Result<models::ScalewayPeriodK8sPeriodV1PeriodListPoolsResponse, Error<ListPoolsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_cluster_id = cluster_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodK8sPeriodV1PeriodListPoolsResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodK8sPeriodV1PeriodListPoolsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListPoolsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn migrate_pools_to_new_images(
    configuration: &configuration::Configuration,
    region: &str,
    cluster_id: &str,
    migrate_pools_to_new_images_request: models::MigratePoolsToNewImagesRequest,
) -> Result<(), Error<MigratePoolsToNewImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_cluster_id = cluster_id;
    let p_migrate_pools_to_new_images_request = migrate_pools_to_new_images_request;
    ...
    req_builder = req_builder.json(&p_migrate_pools_to_new_images_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MigratePoolsToNewImagesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn update_pool(
    ...
    region: &str,
    pool_id: &str,
    update_pool_request: models::UpdatePoolRequest,
) -> Result<models::ScalewayPeriodK8sPeriodV1PeriodPool, Error<UpdatePoolError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_pool_id = pool_id;
    let p_update_pool_request = update_pool_request;
    ...
    req_builder = req_builder.json(&p_update_pool_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdatePoolError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn upgrade_pool(
    ...
    region: &str,
    pool_id: &str,
    upgrade_pool_request: models::UpgradePoolRequest,
) -> Result<models::ScalewayPeriodK8sPeriodV1PeriodPool, Error<UpgradePoolError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_pool_id = pool_id;
    let p_upgrade_pool_request = upgrade_pool_request;
    ...
    req_builder = req_builder.json(&p_upgrade_pool_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpgradePoolError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
