...
) -> Result<models::ScalewayPeriodVpcPeriodV1PeriodPrivateNetwork, Error<CreatePrivateNetworkError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_zone = zone;
    let p_create_private_network_request = create_private_network_request;
    ...
    req_builder = req_builder.json(&p_create_private_network_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodVpcPeriodV1PeriodPrivateNetwork`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodVpcPeriodV1PeriodPrivateNetwork`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreatePrivateNetworkError> = serde_json::from_str(&content).ok();
...
pub async fn delete_private_network(
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        zone = crate::apis::urlencode(p_zone),
        private_network_id = crate::apis::urlencode(p_private_network_id)
    );
    let mut req_builder = configuration
        .client
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeletePrivateNetworkError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_private_network(
    ...
    zone: &str,
    private_network_id: &str,
) -> Result<models::ScalewayPeriodVpcPeriodV1PeriodPrivateNetwork, Error<GetPrivateNetworkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_zone = zone;
    let p_private_network_id = private_network_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetPrivateNetworkError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_private_networks(
    ...
    include_regional: Option<bool>,
) -> Result<
    models::ScalewayPeriodVpcPeriodV1PeriodListPrivateNetworksResponse,
...
> {
    ...
    let p_private_network_ids = private_network_ids;
    let p_include_regional = include_regional;
    ...
    if let Some(ref param_value) = p_private_network_ids {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .iter()
    ...
    if let Some(ref param_value) = p_include_regional {
        req_builder = req_builder.query(&[("include_regional", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodVpcPeriodV1PeriodListPrivateNetworksResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodVpcPeriodV1PeriodListPrivateNetworksResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListPrivateNetworksError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
) -> Result<models::ScalewayPeriodVpcPeriodV1PeriodPrivateNetwork, Error<UpdatePrivateNetworkError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_zone = zone;
    let p_private_network_id = private_network_id;
    let p_update_private_network_request = update_private_network_request;
    ...
    req_builder = req_builder.json(&p_update_private_network_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdatePrivateNetworkError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
