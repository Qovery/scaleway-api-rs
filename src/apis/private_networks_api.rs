...
pub async fn create_private_network(configuration: &configuration::Configuration, zone: &str, inline_object91: crate::models::InlineObject91) -> Result<crate::models::ScalewayVpcV1PrivateNetwork, Error<CreatePrivateNetworkError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/vpc/v1/zones/{zone}/private-networks", configuration.base_path, zone=crate::apis::urlencode(zone));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePrivateNetworkError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn delete_private_network(configuration: &configuration::Configuration, zone: &str, private_network_id: &str) -> Result<(), Error<DeletePrivateNetworkError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/vpc/v1/zones/{zone}/private-networks/{private_network_id}", configuration.base_path, zone=crate::apis::urlencode(zone), private_network_id=crate::apis::urlencode(private_network_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePrivateNetworkError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_private_network(configuration: &configuration::Configuration, zone: &str, private_network_id: &str) -> Result<crate::models::ScalewayVpcV1PrivateNetwork, Error<GetPrivateNetworkError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPrivateNetworkError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_private_networks(configuration: &configuration::Configuration, zone: &str, order_by: Option<&str>, page: Option<f32>, page_size: Option<f32>, name: Option<&str>, tags: Option<Vec<String>>, organization_id: Option<&str>, project_id: Option<&str>) -> Result<crate::models::ScalewayVpcV1ListPrivateNetworksResponse, Error<ListPrivateNetworksError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListPrivateNetworksError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_private_network(configuration: &configuration::Configuration, zone: &str, private_network_id: &str, inline_object92: crate::models::InlineObject92) -> Result<crate::models::ScalewayVpcV1PrivateNetwork, Error<UpdatePrivateNetworkError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePrivateNetworkError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
