...
pub async fn create_private_nic(configuration: &configuration::Configuration, zone: &str, server_id: &str, inline_object16: crate::models::InlineObject16) -> Result<crate::models::ScalewayInstanceV1CreatePrivateNicResponse, Error<CreatePrivateNicError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/servers/{server_id}/private_nics", configuration.base_path, zone=crate::apis::urlencode(zone), server_id=crate::apis::urlencode(server_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePrivateNicError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_private_nic(configuration: &configuration::Configuration, zone: &str, server_id: &str, private_nic_id: &str) -> Result<(), Error<DeletePrivateNicError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/servers/{server_id}/private_nics/{private_nic_id}", configuration.base_path, zone=crate::apis::urlencode(zone), server_id=crate::apis::urlencode(server_id), private_nic_id=crate::apis::urlencode(private_nic_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePrivateNicError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_private_nic(configuration: &configuration::Configuration, zone: &str, server_id: &str, private_nic_id: &str) -> Result<crate::models::ScalewayInstanceV1GetPrivateNicResponse, Error<GetPrivateNicError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPrivateNicError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_private_nics(configuration: &configuration::Configuration, zone: &str, server_id: &str) -> Result<crate::models::ScalewayInstanceV1ListPrivateNicsResponse, Error<ListPrivateNicsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListPrivateNicsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
