...
) -> Result<crate::models::ScalewayInstanceV1CreatePrivateNicResponse, Error<CreatePrivateNicError>>
{
...
pub async fn get_private_nic(
    ...
    server_id: &str,
    private_nic_id: &str,
) -> Result<crate::models::ScalewayInstanceV1GetPrivateNicResponse, Error<GetPrivateNicError>> {
    let local_var_client = &configuration.client;
...
pub async fn list_private_nics(
    ...
    zone: &str,
    server_id: &str,
) -> Result<crate::models::ScalewayInstanceV1ListPrivateNicsResponse, Error<ListPrivateNicsError>> {
    let local_var_client = &configuration.client;
