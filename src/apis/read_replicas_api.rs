...
/// struct for typed errors of method [`promote_read_replica`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn create_read_replica(
    ...
    region: &str,
    create_read_replica_request: models::CreateReadReplicaRequest,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodReadReplica, Error<CreateReadReplicaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_create_read_replica_request = create_read_replica_request;
    ...
    req_builder = req_builder.json(&p_create_read_replica_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodReadReplica`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodReadReplica`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateReadReplicaError> = serde_json::from_str(&content).ok();
...
pub async fn create_read_replica_endpoint(
    ...
    region: &str,
    read_replica_id: &str,
    create_read_replica_endpoint_request: models::CreateReadReplicaEndpointRequest,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodReadReplica, Error<CreateReadReplicaEndpointError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_read_replica_id = read_replica_id;
    let p_create_read_replica_endpoint_request = create_read_replica_endpoint_request;

    let uri_str = format!(
        "{}/rdb/v1/regions/{region}/read-replicas/{read_replica_id}/endpoints",
        configuration.base_path,
        region = crate::apis::urlencode(p_region),
        read_replica_id = crate::apis::urlencode(p_read_replica_id)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_create_read_replica_endpoint_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateReadReplicaEndpointError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn delete_read_replica(
    ...
    region: &str,
    read_replica_id: &str,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodReadReplica, Error<DeleteReadReplicaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_read_replica_id = read_replica_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteReadReplicaError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_read_replica(
    ...
    region: &str,
    read_replica_id: &str,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodReadReplica, Error<GetReadReplicaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_read_replica_id = read_replica_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetReadReplicaError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn promote_read_replica(
    configuration: &configuration::Configuration,
    region: &str,
    read_replica_id: &str,
    body: serde_json::Value,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodInstance, Error<PromoteReadReplicaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_read_replica_id = read_replica_id;
    let p_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PromoteReadReplicaError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn reset_read_replica(
    ...
    read_replica_id: &str,
    body: serde_json::Value,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodReadReplica, Error<ResetReadReplicaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_read_replica_id = read_replica_id;
    let p_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ResetReadReplicaError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
