...
pub async fn create_route(configuration: &configuration::Configuration, region: &str, inline_object48: crate::models::InlineObject48) -> Result<crate::models::ScalewayLbV1Route, Error<CreateRouteError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/routes", configuration.base_path, region=crate::apis::urlencode(region));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateRouteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn delete_route(configuration: &configuration::Configuration, region: &str, route_id: &str) -> Result<(), Error<DeleteRouteError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/routes/{route_id}", configuration.base_path, region=crate::apis::urlencode(region), route_id=crate::apis::urlencode(route_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteRouteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_route(configuration: &configuration::Configuration, region: &str, route_id: &str) -> Result<crate::models::ScalewayLbV1Route, Error<GetRouteError>> {
...
pub async fn list_routes(configuration: &configuration::Configuration, region: &str, order_by: Option<crate::models::ScalewayLbV1ListRoutesRequestOrderBy>, page_size: Option<f32>, page: Option<f32>, frontend_id: Option<&str>) -> Result<crate::models::ScalewayLbV1ListRoutesResponse, Error<ListRoutesError>> {
    ...
    if let Some(ref local_var_str) = frontend_id {
        local_var_req_builder = local_var_req_builder.query(&[("frontend_id", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListRoutesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_route(configuration: &configuration::Configuration, region: &str, route_id: &str, inline_object49: crate::models::InlineObject49) -> Result<crate::models::ScalewayLbV1Route, Error<UpdateRouteError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateRouteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
