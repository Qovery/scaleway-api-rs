...
pub async fn list_rules(
    ...
    crate::models::ScalewayPeriodIamPeriodV1alpha1PeriodListRulesResponse,
...
> {
    ...
    let local_var_uri_str = format!("{}/iam/v1alpha1/rules", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListRulesError> =
...
pub async fn set_rules(
    configuration: &configuration::Configuration,
    set_rules_request: crate::models::SetRulesRequest,
) -> Result<
    crate::models::ScalewayPeriodIamPeriodV1alpha1PeriodSetRulesResponse,
    Error<SetRulesError>,
> {
    let local_var_configuration = configuration;
