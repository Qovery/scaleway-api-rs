...
pub async fn reboot_server(
    ...
    zone: &str,
    server_id: &str,
    reboot_server_request: models::RebootServerRequest,
) -> Result<models::ScalewayPeriodBaremetalPeriodV1PeriodServer, Error<RebootServerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_zone = zone;
    let p_server_id = server_id;
    let p_reboot_server_request = reboot_server_request;
    ...
    req_builder = req_builder.json(&p_reboot_server_request);
...
pub async fn start_server(
    ...
    server_id: &str,
    reboot_server_request: models::RebootServerRequest,
) -> Result<models::ScalewayPeriodBaremetalPeriodV1PeriodServer, Error<StartServerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_zone = zone;
    let p_server_id = server_id;
    let p_reboot_server_request = reboot_server_request;
...
) -> Result<models::ScalewayPeriodBaremetalPeriodV1PeriodServer, Error<StopServerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_zone = zone;
    let p_server_id = server_id;
    let p_body = body;
