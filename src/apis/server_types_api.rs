...
/// struct for typed errors of method `get_server_types_availability`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetServerTypesAvailabilityError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method `list_servers_types`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListServersTypesError {
    UnknownValue(serde_json::Value),
}


/// Get a server technical details.
pub async fn get_server_type(configuration: &configuration::Configuration, zone: &str, server_type: &str) -> Result<crate::models::ScalewayAppleSiliconV1alpha1ServerType, Error<GetServerTypeError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apple-silicon/v1alpha1/zones/{zone}/server-type/{server_type}", configuration.base_path, zone=crate::apis::urlencode(zone), server_type=crate::apis::urlencode(server_type));
...
pub async fn get_server_types_availability(configuration: &configuration::Configuration, zone: &str, per_page: Option<f32>, page: Option<f32>) -> Result<crate::models::ScalewayInstanceV1GetServerTypesAvailabilityResponse, Error<GetServerTypesAvailabilityError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/products/servers/availability", configuration.base_path, zone=crate::apis::urlencode(zone));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetServerTypesAvailabilityError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_server_types(configuration: &configuration::Configuration, zone: &str) -> Result<crate::models::ScalewayAppleSiliconV1alpha1ListServerTypesResponse, Error<ListServerTypesError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apple-silicon/v1alpha1/zones/{zone}/server-types", configuration.base_path, zone=crate::apis::urlencode(zone));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn list_servers_types(configuration: &configuration::Configuration, zone: &str, per_page: Option<f32>, page: Option<f32>) -> Result<crate::models::ScalewayInstanceV1ListServersTypesResponse, Error<ListServersTypesError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/products/servers", configuration.base_path, zone=crate::apis::urlencode(zone));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListServersTypesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
