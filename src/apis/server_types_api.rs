...
pub async fn get_server_type(
    ...
    zone: &str,
    server_type: &str,
) -> Result<crate::models::ScalewayAppleSiliconV1alpha1ServerType, Error<GetServerTypeError>> {
    ...
    let local_var_uri_str = format!(
        ...
        server_type = crate::apis::urlencode(server_type)
    );
...
pub async fn get_server_types_availability(
    ...
    crate::models::ScalewayInstanceV1GetServerTypesAvailabilityResponse,
    Error<GetServerTypesAvailabilityError>,
> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetServerTypesAvailabilityError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_server_types(
    ...
    crate::models::ScalewayAppleSiliconV1alpha1ListServerTypesResponse,
...
pub async fn list_servers_types(
    ...
    per_page: Option<f32>,
    page: Option<f32>,
) -> Result<crate::models::ScalewayInstanceV1ListServersTypesResponse, Error<ListServersTypesError>>
{
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListServersTypesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
