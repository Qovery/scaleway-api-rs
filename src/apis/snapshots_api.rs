...
) -> Result<crate::models::ScalewayRdbV1Instance, Error<CreateInstanceFromSnapshotError>> {
...
) -> Result<crate::models::ScalewayRdbV1Snapshot, Error<CreateSnapshotError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_snapshot(
    ...
    region: &str,
    snapshot_id: &str,
) -> Result<crate::models::ScalewayRdbV1Snapshot, Error<DeleteSnapshotError>> {
    let local_var_configuration = configuration;
...
pub async fn get_snapshot(
    ...
    region: &str,
    snapshot_id: &str,
) -> Result<crate::models::ScalewayRdbV1Snapshot, Error<GetSnapshotError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ScalewayRdbV1ListSnapshotsResponse, Error<ListSnapshotsError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ScalewayRdbV1Snapshot, Error<UpdateSnapshotError>> {
    let local_var_configuration = configuration;
