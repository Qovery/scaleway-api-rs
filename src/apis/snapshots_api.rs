...
pub async fn create_instance_from_snapshot(
    ...
    region: &str,
    snapshot_id: &str,
    create_instance_from_snapshot_request: models::CreateInstanceFromSnapshotRequest,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodInstance, Error<CreateInstanceFromSnapshotError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_snapshot_id = snapshot_id;
    let p_create_instance_from_snapshot_request = create_instance_from_snapshot_request;

    let uri_str = format!(
        "{}/rdb/v1/regions/{region}/snapshots/{snapshot_id}/create-instance",
        configuration.base_path,
        region = crate::apis::urlencode(p_region),
        snapshot_id = crate::apis::urlencode(p_snapshot_id)
    );
    ...
    req_builder = req_builder.json(&p_create_instance_from_snapshot_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateInstanceFromSnapshotError> = serde_json::from_str(&content).ok();
...
pub async fn create_snapshot(
    ...
    region: &str,
    instance_id: &str,
    create_snapshot_request: models::CreateSnapshotRequest,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodSnapshot, Error<CreateSnapshotError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodSnapshot`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodSnapshot`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_snapshot(
    ...
    region: &str,
    snapshot_id: &str,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodSnapshot, Error<DeleteSnapshotError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_snapshot_id = snapshot_id;
...
pub async fn get_snapshot(
    ...
    region: &str,
    snapshot_id: &str,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodSnapshot, Error<GetSnapshotError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_snapshot_id = snapshot_id;
...
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodListSnapshotsResponse, Error<ListSnapshotsError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_name = name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodListSnapshotsResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScalewayPeriodRdbPeriodV1PeriodListSnapshotsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_snapshot(
    ...
    region: &str,
    snapshot_id: &str,
    update_snapshot_request: models::UpdateSnapshotRequest,
) -> Result<models::ScalewayPeriodRdbPeriodV1PeriodSnapshot, Error<UpdateSnapshotError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
    let p_snapshot_id = snapshot_id;
    let p_update_snapshot_request = update_snapshot_request;
    ...
    req_builder = req_builder.json(&p_update_snapshot_request);
