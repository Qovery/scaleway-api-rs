...
/// struct for typed errors of method `get_lb_stats`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetLbStatsError {
    UnknownValue(serde_json::Value),
}


pub async fn get_lb_stats(configuration: &configuration::Configuration, region: &str, lb_id: &str) -> Result<crate::models::ScalewayLbV1LbStats, Error<GetLbStatsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/lb/v1/regions/{region}/lbs/{lb_id}/stats", configuration.base_path, region=crate::apis::urlencode(region), lb_id=crate::apis::urlencode(lb_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLbStatsError> = serde_json::from_str(&local_var_content).ok();
