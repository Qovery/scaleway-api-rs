...
pub async fn delete_tag(
    ...
    tag_id: &str,
    force: Option<bool>,
) -> Result<crate::models::ScalewayRegistryV1Tag, Error<DeleteTagError>> {
...
pub async fn get_tag(
    ...
    region: &str,
    tag_id: &str,
) -> Result<crate::models::ScalewayRegistryV1Tag, Error<GetTagError>> {
    let local_var_client = &configuration.client;
...
pub async fn list_tags(
    ...
    order_by: Option<&str>,
    name: Option<&str>,
) -> Result<crate::models::ScalewayRegistryV1ListTagsResponse, Error<ListTagsError>> {
    let local_var_client = &configuration.client;
