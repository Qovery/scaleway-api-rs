...
pub async fn delete_tag(
    ...
    tag_id: &str,
    force: Option<bool>,
) -> Result<crate::models::ScalewayPeriodRegistryPeriodV1PeriodTag, Error<DeleteTagError>> {
    ...
    let local_var_uri_str = format!(
        ...
        tag_id = crate::apis::urlencode(tag_id)
    );
...
pub async fn get_tag(
    ...
    region: &str,
    tag_id: &str,
) -> Result<crate::models::ScalewayPeriodRegistryPeriodV1PeriodTag, Error<GetTagError>> {
    let local_var_configuration = configuration;
...
pub async fn list_tags(
    ...
    order_by: Option<&str>,
    name: Option<&str>,
) -> Result<crate::models::ScalewayPeriodRegistryPeriodV1PeriodListTagsResponse, Error<ListTagsError>>
{
    let local_var_configuration = configuration;
