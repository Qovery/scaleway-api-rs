...
pub async fn delete_tag(configuration: &configuration::Configuration, region: &str, tag_id: &str, force: Option<bool>) -> Result<crate::models::ScalewayRegistryV1Tag, Error<DeleteTagError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/registry/v1/regions/{region}/tags/{tag_id}", configuration.base_path, region=crate::apis::urlencode(region), tag_id=crate::apis::urlencode(tag_id));
...
pub async fn get_tag(configuration: &configuration::Configuration, region: &str, tag_id: &str) -> Result<crate::models::ScalewayRegistryV1Tag, Error<GetTagError>> {
...
pub async fn list_tags(configuration: &configuration::Configuration, region: &str, image_id: &str, page: Option<f32>, page_size: Option<f32>, order_by: Option<&str>, name: Option<&str>) -> Result<crate::models::ScalewayRegistryV1ListTagsResponse, Error<ListTagsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/registry/v1/regions/{region}/images/{image_id}/tags", configuration.base_path, region=crate::apis::urlencode(region), image_id=crate::apis::urlencode(image_id));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
