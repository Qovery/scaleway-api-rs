...
pub async fn delete_server_user_data(configuration: &configuration::Configuration, zone: &str, server_id: &str, key: &str) -> Result<(), Error<DeleteServerUserDataError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/servers/{server_id}/user_data/{key}", configuration.base_path, zone=crate::apis::urlencode(zone), server_id=crate::apis::urlencode(server_id), key=crate::apis::urlencode(key));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteServerUserDataError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_server_user_data(configuration: &configuration::Configuration, zone: &str, server_id: &str, key: &str) -> Result<crate::models::ScalewayStdFile, Error<GetServerUserDataError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetServerUserDataError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_server_user_data(configuration: &configuration::Configuration, zone: &str, server_id: &str) -> Result<crate::models::ScalewayInstanceV1ListServerUserDataResponse, Error<ListServerUserDataError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/servers/{server_id}/user_data", configuration.base_path, zone=crate::apis::urlencode(zone), server_id=crate::apis::urlencode(server_id));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListServerUserDataError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn set_server_user_data(configuration: &configuration::Configuration, zone: &str, server_id: &str, key: &str, body: std::path::PathBuf) -> Result<(), Error<SetServerUserDataError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetServerUserDataError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
