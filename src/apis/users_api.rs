...
pub async fn create_user(configuration: &configuration::Configuration, region: &str, instance_id: &str, inline_object72: crate::models::InlineObject72) -> Result<crate::models::ScalewayRdbV1User, Error<CreateUserError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/rdb/v1/regions/{region}/instances/{instance_id}/users", configuration.base_path, region=crate::apis::urlencode(region), instance_id=crate::apis::urlencode(instance_id));
...
pub async fn delete_user(configuration: &configuration::Configuration, region: &str, instance_id: &str, name: &str) -> Result<(), Error<DeleteUserError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/rdb/v1/regions/{region}/instances/{instance_id}/users/{name}", configuration.base_path, region=crate::apis::urlencode(region), instance_id=crate::apis::urlencode(instance_id), name=crate::apis::urlencode(name));
...
pub async fn list_users(configuration: &configuration::Configuration, region: &str, instance_id: &str, name: Option<&str>, order_by: Option<&str>, page: Option<f32>, page_size: Option<f32>) -> Result<crate::models::ScalewayRdbV1ListUsersResponse, Error<ListUsersError>> {
...
pub async fn update_user(configuration: &configuration::Configuration, region: &str, instance_id: &str, name: &str, inline_object73: crate::models::InlineObject73) -> Result<crate::models::ScalewayRdbV1User, Error<UpdateUserError>> {
