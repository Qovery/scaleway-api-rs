...
pub async fn get_dns_zone_version_diff(configuration: &configuration::Configuration, dns_zone_version_id: &str) -> Result<crate::models::ScalewayDomainV2beta1GetDnsZoneVersionDiffResponse, Error<GetDnsZoneVersionDiffError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/domain/v2beta1/dns-zones/version/{dns_zone_version_id}/diff", configuration.base_path, dns_zone_version_id=crate::apis::urlencode(dns_zone_version_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDnsZoneVersionDiffError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_version(configuration: &configuration::Configuration, region: &str, version_name: &str) -> Result<crate::models::ScalewayK8sV1Version, Error<GetVersionError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/k8s/v1/regions/{region}/versions/{version_name}", configuration.base_path, region=crate::apis::urlencode(region), version_name=crate::apis::urlencode(version_name));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn list_dns_zone_version_records(configuration: &configuration::Configuration, dns_zone_version_id: &str) -> Result<crate::models::ScalewayDomainV2beta1ListDnsZoneVersionRecordsResponse, Error<ListDnsZoneVersionRecordsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/domain/v2beta1/dns-zones/version/{dns_zone_version_id}", configuration.base_path, dns_zone_version_id=crate::apis::urlencode(dns_zone_version_id));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListDnsZoneVersionRecordsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_dns_zone_versions(configuration: &configuration::Configuration, dns_zone: &str) -> Result<crate::models::ScalewayDomainV2beta1ListDnsZoneVersionsResponse, Error<ListDnsZoneVersionsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/domain/v2beta1/dns-zones/{dns_zone}/versions", configuration.base_path, dns_zone=crate::apis::urlencode(dns_zone));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListDnsZoneVersionsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_versions(configuration: &configuration::Configuration, region: &str) -> Result<crate::models::ScalewayK8sV1ListVersionsResponse, Error<ListVersionsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/k8s/v1/regions/{region}/versions", configuration.base_path, region=crate::apis::urlencode(region));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn restore_dns_zone_version(configuration: &configuration::Configuration, dns_zone_version_id: &str, body: serde_json::Value) -> Result<serde_json::Value, Error<RestoreDnsZoneVersionError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/domain/v2beta1/dns-zones/version/{dns_zone_version_id}/restore", configuration.base_path, dns_zone_version_id=crate::apis::urlencode(dns_zone_version_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RestoreDnsZoneVersionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
