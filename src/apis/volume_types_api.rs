...
/// struct for typed errors of method `list_volumes_types`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListVolumesTypesError {
    UnknownValue(serde_json::Value),
}


/// Get volumes technical details.
pub async fn list_volumes_types(configuration: &configuration::Configuration, zone: &str, per_page: Option<f32>, page: Option<f32>) -> Result<crate::models::ScalewayInstanceV1ListVolumesTypesResponse, Error<ListVolumesTypesError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/instance/v1/zones/{zone}/products/volumes", configuration.base_path, zone=crate::apis::urlencode(zone));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListVolumesTypesError> = serde_json::from_str(&local_var_content).ok();
