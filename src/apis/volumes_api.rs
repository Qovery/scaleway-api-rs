...
) -> Result<crate::models::ScalewayInstanceV1CreateVolumeResponse, Error<CreateVolumeError>> {
...
pub async fn get_volume(
    ...
    zone: &str,
    volume_id: &str,
) -> Result<crate::models::ScalewayInstanceV1GetVolumeResponse, Error<GetVolumeError>> {
    let local_var_client = &configuration.client;
...
pub async fn list_volumes(
    ...
    project: Option<&str>,
    name: Option<&str>,
) -> Result<crate::models::ScalewayInstanceV1ListVolumesResponse, Error<ListVolumesError>> {
    let local_var_client = &configuration.client;
...
) -> Result<crate::models::ScalewayInstanceV1SetVolumeResponse, Error<SetVolumeError>> {
    let local_var_client = &configuration.client;
...
) -> Result<crate::models::ScalewayInstanceV1UpdateVolumeResponse, Error<UpdateVolumeError>> {
    let local_var_client = &configuration.client;
