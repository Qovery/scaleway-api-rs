...
pub struct DomainV2beta1DnsZonesDnsZoneImportProviderOnlineV1 {
    #[serde(rename = "token", skip_serializing_if = "Option::is_none")]
    pub token: Option<String>,
}

impl DomainV2beta1DnsZonesDnsZoneImportProviderOnlineV1 {
    pub fn new() -> DomainV2beta1DnsZonesDnsZoneImportProviderOnlineV1 {
        DomainV2beta1DnsZonesDnsZoneImportProviderOnlineV1 { token: None }
    }
}
