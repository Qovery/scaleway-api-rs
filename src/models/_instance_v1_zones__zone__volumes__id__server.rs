...
/// InstanceV1ZonesZoneVolumesIdServer : The server attached to the volume



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct InstanceV1ZonesZoneVolumesIdServer {
...
impl InstanceV1ZonesZoneVolumesIdServer {
    /// The server attached to the volume
    pub fn new() -> InstanceV1ZonesZoneVolumesIdServer {
