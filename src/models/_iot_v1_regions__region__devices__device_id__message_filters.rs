...
/// IotV1RegionsRegionDevicesDeviceIdMessageFilters : Filter-sets to restrict the topics the device can publish/subscribe to

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionDevicesDeviceIdMessageFilters {
    #[serde(rename = "publish", skip_serializing_if = "Option::is_none")]
    pub publish: Option<Box<crate::models::IotV1RegionsRegionDevicesMessageFiltersPublish>>,
    #[serde(rename = "subscribe", skip_serializing_if = "Option::is_none")]
    pub subscribe: Option<Box<crate::models::IotV1RegionsRegionDevicesMessageFiltersSubscribe>>,
}

impl IotV1RegionsRegionDevicesDeviceIdMessageFilters {
    /// Filter-sets to restrict the topics the device can publish/subscribe to
    pub fn new() -> IotV1RegionsRegionDevicesDeviceIdMessageFilters {
