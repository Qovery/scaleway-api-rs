...
/// IotV1RegionsRegionDevicesMessageFilters : Filter-sets to authorize or deny the device to publish/subscribe to specific topics

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionDevicesMessageFilters {
...
impl IotV1RegionsRegionDevicesMessageFilters {
    /// Filter-sets to authorize or deny the device to publish/subscribe to specific topics
    pub fn new() -> IotV1RegionsRegionDevicesMessageFilters {
        IotV1RegionsRegionDevicesMessageFilters {
            publish: None,
            subscribe: None,
        }
    }
