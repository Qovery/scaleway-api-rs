...
/// IotV1RegionsRegionDevicesMessageFiltersPublish : Filtering rule to restrict topics the device can publish to



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionDevicesMessageFiltersPublish {
...
impl IotV1RegionsRegionDevicesMessageFiltersPublish {
    /// Filtering rule to restrict topics the device can publish to
    pub fn new() -> IotV1RegionsRegionDevicesMessageFiltersPublish {
