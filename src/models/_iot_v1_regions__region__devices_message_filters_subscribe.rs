...
/// IotV1RegionsRegionDevicesMessageFiltersSubscribe : Filtering rule to restrict topics the device can subscribe to

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionDevicesMessageFiltersSubscribe {
...
impl IotV1RegionsRegionDevicesMessageFiltersSubscribe {
    /// Filtering rule to restrict topics the device can subscribe to
    pub fn new() -> IotV1RegionsRegionDevicesMessageFiltersSubscribe {
