...
/// IotV1RegionsRegionHubsTwinsGraphiteConfig : BETA - not implemented yet

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionHubsTwinsGraphiteConfig {
    #[serde(rename = "push_uri", skip_serializing_if = "Option::is_none")]
    pub push_uri: Option<String>,
}

impl IotV1RegionsRegionHubsTwinsGraphiteConfig {
    /// BETA - not implemented yet
    pub fn new() -> IotV1RegionsRegionHubsTwinsGraphiteConfig {
        IotV1RegionsRegionHubsTwinsGraphiteConfig { push_uri: None }
    }
}
