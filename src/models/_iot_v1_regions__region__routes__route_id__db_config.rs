...
/// IotV1RegionsRegionRoutesRouteIdDbConfig : When updating Database Route, DB-specific configuration fields



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionRoutesRouteIdDbConfig {
    ...
    pub engine: Option<crate::models::ScalewayIotV1RouteDatabaseConfigEngine>,
}

impl IotV1RegionsRegionRoutesRouteIdDbConfig {
    /// When updating Database Route, DB-specific configuration fields
    pub fn new() -> IotV1RegionsRegionRoutesRouteIdDbConfig {
