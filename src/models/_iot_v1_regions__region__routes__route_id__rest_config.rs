...
/// IotV1RegionsRegionRoutesRouteIdRestConfig : When updating Rest Route, Rest-specific configuration fields



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionRoutesRouteIdRestConfig {
    ...
    pub headers: Option<Box<crate::models::ScalewayStdMapStringStringValue>>,
}

impl IotV1RegionsRegionRoutesRouteIdRestConfig {
    /// When updating Rest Route, Rest-specific configuration fields
    pub fn new() -> IotV1RegionsRegionRoutesRouteIdRestConfig {
        IotV1RegionsRegionRoutesRouteIdRestConfig {
            verb: None,
            uri: None,
            headers: None,
        }
