...
/// IotV1RegionsRegionRoutesRouteIdS3Config : When updating S3 Route, S3-specific configuration fields



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionRoutesRouteIdS3Config {
...
impl IotV1RegionsRegionRoutesRouteIdS3Config {
    /// When updating S3 Route, S3-specific configuration fields
    pub fn new() -> IotV1RegionsRegionRoutesRouteIdS3Config {
