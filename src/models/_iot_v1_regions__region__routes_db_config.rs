...
/// IotV1RegionsRegionRoutesDbConfig : If creating Database Route, DB-specific configuration fields

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionRoutesDbConfig {
...
impl IotV1RegionsRegionRoutesDbConfig {
    /// If creating Database Route, DB-specific configuration fields
    pub fn new() -> IotV1RegionsRegionRoutesDbConfig {
        IotV1RegionsRegionRoutesDbConfig {
            host: None,
            port: None,
            dbname: None,
            username: None,
