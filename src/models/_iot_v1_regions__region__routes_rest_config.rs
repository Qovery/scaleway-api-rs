...
/// IotV1RegionsRegionRoutesRestConfig : If creating Rest Route, Rest-specific configuration fields



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionRoutesRestConfig {
...
impl IotV1RegionsRegionRoutesRestConfig {
    /// If creating Rest Route, Rest-specific configuration fields
    pub fn new() -> IotV1RegionsRegionRoutesRestConfig {
        IotV1RegionsRegionRoutesRestConfig {
            verb: None,
            uri: None,
            headers: None,
        }
