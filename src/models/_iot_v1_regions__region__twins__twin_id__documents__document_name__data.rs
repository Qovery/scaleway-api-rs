...
/// IotV1RegionsRegionTwinsTwinIdDocumentsDocumentNameData : The new data that will replace the contents of the document.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IotV1RegionsRegionTwinsTwinIdDocumentsDocumentNameData {
    #[serde(rename = "fields", skip_serializing_if = "Option::is_none")]
    pub fields: Option<::std::collections::HashMap<String, serde_json::Value>>,
}

impl IotV1RegionsRegionTwinsTwinIdDocumentsDocumentNameData {
    /// The new data that will replace the contents of the document.
    pub fn new() -> IotV1RegionsRegionTwinsTwinIdDocumentsDocumentNameData {
        IotV1RegionsRegionTwinsTwinIdDocumentsDocumentNameData { fields: None }
    }
}
