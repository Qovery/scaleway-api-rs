...
/// K8sV1RegionsRegionClustersClusterIdAutoUpgrade : The new auo upgrade configuration of the cluster. Note that all the fields needs to be set.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct K8sV1RegionsRegionClustersClusterIdAutoUpgrade {
...
impl K8sV1RegionsRegionClustersClusterIdAutoUpgrade {
    /// The new auo upgrade configuration of the cluster. Note that all the fields needs to be set.
    pub fn new() -> K8sV1RegionsRegionClustersClusterIdAutoUpgrade {
        K8sV1RegionsRegionClustersClusterIdAutoUpgrade {
            enable: None,
