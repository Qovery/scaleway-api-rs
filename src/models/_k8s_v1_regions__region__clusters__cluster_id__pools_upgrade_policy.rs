...
/// K8sV1RegionsRegionClustersClusterIdPoolsUpgradePolicy : The Pool upgrade policy

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct K8sV1RegionsRegionClustersClusterIdPoolsUpgradePolicy {
    #[serde(rename = "max_unavailable", skip_serializing_if = "Option::is_none")]
    pub max_unavailable: Option<f32>,
    #[serde(rename = "max_surge", skip_serializing_if = "Option::is_none")]
    pub max_surge: Option<f32>,
}

impl K8sV1RegionsRegionClustersClusterIdPoolsUpgradePolicy {
    /// The Pool upgrade policy
    pub fn new() -> K8sV1RegionsRegionClustersClusterIdPoolsUpgradePolicy {
