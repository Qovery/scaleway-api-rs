...
/// K8sV1RegionsRegionClustersAutoUpgrade : This configuratiom enables to set a speicific 2-hour time window in which the cluster can be automatically updated to the latest patch version in the current minor one.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct K8sV1RegionsRegionClustersAutoUpgrade {
    ...
    pub maintenance_window: Option<Box<crate::models::K8sV1RegionsRegionClustersAutoUpgradeMaintenanceWindow>>,
}

impl K8sV1RegionsRegionClustersAutoUpgrade {
    ...
    pub fn new() -> K8sV1RegionsRegionClustersAutoUpgrade {
