...
/// K8sV1RegionsRegionClustersAutoUpgradeMaintenanceWindow : The maintenance window of the cluster auto upgrades

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct K8sV1RegionsRegionClustersAutoUpgradeMaintenanceWindow {
...
impl K8sV1RegionsRegionClustersAutoUpgradeMaintenanceWindow {
    /// The maintenance window of the cluster auto upgrades
    pub fn new() -> K8sV1RegionsRegionClustersAutoUpgradeMaintenanceWindow {
        K8sV1RegionsRegionClustersAutoUpgradeMaintenanceWindow {
            start_hour: None,
            day: None,
        }
    }
