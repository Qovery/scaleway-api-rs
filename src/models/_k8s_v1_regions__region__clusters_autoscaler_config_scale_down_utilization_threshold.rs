...
/// K8sV1RegionsRegionClustersAutoscalerConfigScaleDownUtilizationThreshold : Node utilization level, defined as sum of requested resources divided by capacity, below which a node can be considered for scale down

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct K8sV1RegionsRegionClustersAutoscalerConfigScaleDownUtilizationThreshold {
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<f32>,
}

impl K8sV1RegionsRegionClustersAutoscalerConfigScaleDownUtilizationThreshold {
    /// Node utilization level, defined as sum of requested resources divided by capacity, below which a node can be considered for scale down
    pub fn new() -> K8sV1RegionsRegionClustersAutoscalerConfigScaleDownUtilizationThreshold {
        K8sV1RegionsRegionClustersAutoscalerConfigScaleDownUtilizationThreshold { value: None }
    }
}
