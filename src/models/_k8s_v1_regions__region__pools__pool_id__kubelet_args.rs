...
/// K8sV1RegionsRegionPoolsPoolIdKubeletArgs : The new Kubelet arguments to be used by this pool. Note that this feature is to be considered as experimental

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct K8sV1RegionsRegionPoolsPoolIdKubeletArgs {
    #[serde(rename = "<key>", skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
}

impl K8sV1RegionsRegionPoolsPoolIdKubeletArgs {
    /// The new Kubelet arguments to be used by this pool. Note that this feature is to be considered as experimental
    pub fn new() -> K8sV1RegionsRegionPoolsPoolIdKubeletArgs {
        K8sV1RegionsRegionPoolsPoolIdKubeletArgs { key: None }
    }
}
