...
/// LbV1RegionsRegionAclsAclIdAction : Action to undertake when an ACL filter matches



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LbV1RegionsRegionAclsAclIdAction {
    /// The action type
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub _type: Option<Type>,
}

impl LbV1RegionsRegionAclsAclIdAction {
    /// Action to undertake when an ACL filter matches
    pub fn new() -> LbV1RegionsRegionAclsAclIdAction {
        LbV1RegionsRegionAclsAclIdAction {
            _type: None,
        }
    }
}
