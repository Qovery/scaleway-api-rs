...
/// LbV1RegionsRegionAclsAclIdMatch : The ACL match rule. At least `ip_subnet` or `http_filter` and `http_filter_value` are required



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LbV1RegionsRegionAclsAclIdMatch {
...
impl LbV1RegionsRegionAclsAclIdMatch {
    /// The ACL match rule. At least `ip_subnet` or `http_filter` and `http_filter_value` are required
    pub fn new() -> LbV1RegionsRegionAclsAclIdMatch {
