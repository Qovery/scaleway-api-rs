...
/// LbV1RegionsRegionBackendsBackendIdHealthcheckMysqlConfig : The check requires MySQL >=3.22, for older version, please use TCP check



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LbV1RegionsRegionBackendsBackendIdHealthcheckMysqlConfig {
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<String>,
}

impl LbV1RegionsRegionBackendsBackendIdHealthcheckMysqlConfig {
    /// The check requires MySQL >=3.22, for older version, please use TCP check
    pub fn new() -> LbV1RegionsRegionBackendsBackendIdHealthcheckMysqlConfig {
        LbV1RegionsRegionBackendsBackendIdHealthcheckMysqlConfig {
            user: None,
        }
    }
}
