...
pub struct LbV1RegionsRegionBackendsBackendIdHealthcheckPgsqlConfig {
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<String>,
}

impl LbV1RegionsRegionBackendsBackendIdHealthcheckPgsqlConfig {
    pub fn new() -> LbV1RegionsRegionBackendsBackendIdHealthcheckPgsqlConfig {
