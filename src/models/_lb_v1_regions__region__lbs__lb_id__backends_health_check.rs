...
/// LbV1RegionsRegionLbsLbIdBackendsHealthCheck : See the Healthcheck object description



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LbV1RegionsRegionLbsLbIdBackendsHealthCheck {
    #[serde(rename = "mysql_config", skip_serializing_if = "Option::is_none")]
    pub mysql_config: Option<Box<crate::models::LbV1RegionsRegionLbsLbIdBackendsHealthCheckMysqlConfig>>,
    ...
    #[serde(rename = "check_max_retries", skip_serializing_if = "Option::is_none")]
    pub check_max_retries: Option<f32>,
    ...
    pub pgsql_config: Option<Box<crate::models::LbV1RegionsRegionLbsLbIdBackendsHealthCheckPgsqlConfig>>,
    #[serde(rename = "http_config", skip_serializing_if = "Option::is_none")]
    pub http_config: Option<Box<crate::models::LbV1RegionsRegionLbsLbIdBackendsHealthCheckHttpConfig>>,
    #[serde(rename = "https_config", skip_serializing_if = "Option::is_none")]
    pub https_config: Option<Box<crate::models::LbV1RegionsRegionLbsLbIdBackendsHealthCheckHttpConfig>>,
    #[serde(rename = "port", skip_serializing_if = "Option::is_none")]
    pub port: Option<f32>,
    /// (in milliseconds)
    #[serde(rename = "check_timeout", skip_serializing_if = "Option::is_none")]
    pub check_timeout: Option<f32>,
    /// (in milliseconds)
    #[serde(rename = "check_delay", skip_serializing_if = "Option::is_none")]
    pub check_delay: Option<f32>,
...
impl LbV1RegionsRegionLbsLbIdBackendsHealthCheck {
    /// See the Healthcheck object description
    pub fn new() -> LbV1RegionsRegionLbsLbIdBackendsHealthCheck {
        LbV1RegionsRegionLbsLbIdBackendsHealthCheck {
            mysql_config: None,
            ldap_config: None,
            redis_config: None,
            check_max_retries: None,
            tcp_config: None,
            pgsql_config: None,
            http_config: None,
            https_config: None,
