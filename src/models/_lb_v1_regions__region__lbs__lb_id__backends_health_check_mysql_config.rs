...
/// LbV1RegionsRegionLbsLbIdBackendsHealthCheckMysqlConfig : The check requires MySQL >=3.22, for older versions, use TCP check



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LbV1RegionsRegionLbsLbIdBackendsHealthCheckMysqlConfig {
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<String>,
}

impl LbV1RegionsRegionLbsLbIdBackendsHealthCheckMysqlConfig {
    /// The check requires MySQL >=3.22, for older versions, use TCP check
    pub fn new() -> LbV1RegionsRegionLbsLbIdBackendsHealthCheckMysqlConfig {
