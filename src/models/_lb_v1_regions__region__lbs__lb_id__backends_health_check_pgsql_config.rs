...
pub struct LbV1RegionsRegionLbsLbIdBackendsHealthCheckPgsqlConfig {
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<String>,
}

impl LbV1RegionsRegionLbsLbIdBackendsHealthCheckPgsqlConfig {
    pub fn new() -> LbV1RegionsRegionLbsLbIdBackendsHealthCheckPgsqlConfig {
