...
/// LbV1RegionsRegionLbsLbIdPrivateNetworksPrivateNetworkIdAttachStaticConfig : Define two local ip address of your choice for each load balancer instance



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LbV1RegionsRegionLbsLbIdPrivateNetworksPrivateNetworkIdAttachStaticConfig {
    #[serde(rename = "ip_address", skip_serializing_if = "Option::is_none")]
    pub ip_address: Option<Vec<String>>,
}

impl LbV1RegionsRegionLbsLbIdPrivateNetworksPrivateNetworkIdAttachStaticConfig {
    /// Define two local ip address of your choice for each load balancer instance
    pub fn new() -> LbV1RegionsRegionLbsLbIdPrivateNetworksPrivateNetworkIdAttachStaticConfig {
