...
/// LbV1RegionsRegionRoutesMatch : Value to match a redirection



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LbV1RegionsRegionRoutesMatch {
...
impl LbV1RegionsRegionRoutesMatch {
    /// Value to match a redirection
    pub fn new() -> LbV1RegionsRegionRoutesMatch {
        LbV1RegionsRegionRoutesMatch {
            sni: None,
        }
    }
}
