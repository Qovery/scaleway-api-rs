...
/// LbV1RegionsRegionSubscribersEmailConfig : Email address configuration



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LbV1RegionsRegionSubscribersEmailConfig {
    /// Email who receive alert
    #[serde(rename = "email")]
    pub email: String,
}

impl LbV1RegionsRegionSubscribersEmailConfig {
    /// Email address configuration
    pub fn new(email: String) -> LbV1RegionsRegionSubscribersEmailConfig {
