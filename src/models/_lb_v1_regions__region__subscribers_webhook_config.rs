...
/// LbV1RegionsRegionSubscribersWebhookConfig : WebHook URI configuration



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LbV1RegionsRegionSubscribersWebhookConfig {
    /// URI who receive POST request
    #[serde(rename = "uri")]
    pub uri: String,
}

impl LbV1RegionsRegionSubscribersWebhookConfig {
    /// WebHook URI configuration
    pub fn new(uri: String) -> LbV1RegionsRegionSubscribersWebhookConfig {
