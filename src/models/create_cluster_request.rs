...
pub struct CreateClusterRequest {
    ...
    pub pools:
        Option<Vec<models::ScalewayPeriodK8sPeriodV1PeriodCreateClusterRequestPeriodPoolConfig>>,
    #[serde(rename = "autoscaler_config", skip_serializing_if = "Option::is_none")]
    pub autoscaler_config: Option<Box<models::CreateClusterRequestAutoscalerConfig>>,
    #[serde(rename = "auto_upgrade", skip_serializing_if = "Option::is_none")]
    pub auto_upgrade: Option<Box<models::CreateClusterRequestAutoUpgrade>>,
    ...
    pub open_id_connect_config: Option<Box<models::CreateClusterRequestOpenIdConnectConfig>>,
...
impl CreateClusterRequest {
    pub fn new(name: String, version: String, cni: Cni) -> CreateClusterRequest {
