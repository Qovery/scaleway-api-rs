...
/// CreateClusterRequestAutoUpgrade : This configuratiom enables to set a speicific 2-hour time window in which the cluster can be automatically updated to the latest patch version in the current minor one.
