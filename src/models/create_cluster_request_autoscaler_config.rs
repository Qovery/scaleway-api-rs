...
/// CreateClusterRequestAutoscalerConfig : Autoscaler configuration for the cluster. It allows you to set (to an extent) your preferred autoscaler configuration, which is an implementation of the cluster-autoscaler (https://github.com/kubernetes/autoscaler/tree/master/cluster-autoscaler/).
...
pub struct CreateClusterRequestAutoscalerConfig {
    ...
    pub scale_down_utilization_threshold:
        Option<Box<models::CreateClusterRequestAutoscalerConfigScaleDownUtilizationThreshold>>,
