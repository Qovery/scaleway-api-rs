...
/// CreateDeviceRequestMessageFilters : Filter-sets to authorize or deny the device to publish/subscribe to specific topics

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CreateDeviceRequestMessageFilters {
    #[serde(rename = "publish", skip_serializing_if = "Option::is_none")]
    pub publish: Option<Box<crate::models::CreateDeviceRequestMessageFiltersPublish>>,
    #[serde(rename = "subscribe", skip_serializing_if = "Option::is_none")]
    pub subscribe: Option<Box<crate::models::CreateDeviceRequestMessageFiltersSubscribe>>,
}

impl CreateDeviceRequestMessageFilters {
    /// Filter-sets to authorize or deny the device to publish/subscribe to specific topics
    pub fn new() -> CreateDeviceRequestMessageFilters {
        CreateDeviceRequestMessageFilters {
            publish: None,
            subscribe: None,
        }
    }
