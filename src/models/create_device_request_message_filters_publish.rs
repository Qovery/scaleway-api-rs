...
/// CreateDeviceRequestMessageFiltersPublish : Filtering rule to restrict topics the device can publish to

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct CreateDeviceRequestMessageFiltersPublish {
...
impl CreateDeviceRequestMessageFiltersPublish {
    /// Filtering rule to restrict topics the device can publish to
    pub fn new() -> CreateDeviceRequestMessageFiltersPublish {
