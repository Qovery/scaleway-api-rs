...
/// CreateHubRequestTwinsGraphiteConfig : BETA - not implemented yet

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct CreateHubRequestTwinsGraphiteConfig {
    #[serde(rename = "push_uri", skip_serializing_if = "Option::is_none")]
    pub push_uri: Option<String>,
}

impl CreateHubRequestTwinsGraphiteConfig {
    /// BETA - not implemented yet
    pub fn new() -> CreateHubRequestTwinsGraphiteConfig {
        CreateHubRequestTwinsGraphiteConfig { push_uri: None }
    }
}
