...
pub struct CreateRouteRequest {
    ...
    pub s3_config: Option<Box<crate::models::CreateRouteRequestS3Config>>,
    #[serde(rename = "db_config", skip_serializing_if = "Option::is_none")]
    pub db_config: Option<Box<crate::models::CreateRouteRequestDbConfig>>,
    #[serde(rename = "rest_config", skip_serializing_if = "Option::is_none")]
    pub rest_config: Option<Box<crate::models::CreateRouteRequestRestConfig>>,
}

impl CreateRouteRequest {
    pub fn new() -> CreateRouteRequest {
        CreateRouteRequest {
            name: None,
            hub_id: None,
            topic: None,
