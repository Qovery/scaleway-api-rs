...
/// CreateRouteRequestDbConfig : If creating Database Route, DB-specific configuration fields

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct CreateRouteRequestDbConfig {
...
impl CreateRouteRequestDbConfig {
    /// If creating Database Route, DB-specific configuration fields
    pub fn new() -> CreateRouteRequestDbConfig {
