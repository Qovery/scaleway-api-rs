...
/// CreateRouteRequestS3Config : If creating S3 Route, S3-specific configuration fields

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct CreateRouteRequestS3Config {
...
impl CreateRouteRequestS3Config {
    /// If creating S3 Route, S3-specific configuration fields
    pub fn new() -> CreateRouteRequestS3Config {
