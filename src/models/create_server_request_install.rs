...
/// CreateServerRequestInstall : Object describing the configuration details of the OS installation on the server.
...
pub struct CreateServerRequestInstall {
    ...
    #[serde(
        rename = "partitioning_schema",
        skip_serializing_if = "Option::is_none"
    )]
    pub partitioning_schema:
        Option<Box<models::ValidatePartitioningSchemaRequestPartitioningSchema>>,
}
