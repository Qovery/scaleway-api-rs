...
pub struct DeleteInstanceAclRulesRequest {
    /// ACL rules IP present on the instance
    #[serde(rename = "acl_rule_ips", skip_serializing_if = "Option::is_none")]
    pub acl_rule_ips: Option<Vec<String>>,
}

impl DeleteInstanceAclRulesRequest {
    pub fn new() -> DeleteInstanceAclRulesRequest {
        DeleteInstanceAclRulesRequest { acl_rule_ips: None }
    }
}
