...
pub struct GoogleProtobufValueListValue {
    #[serde(rename = "values", skip_serializing_if = "Option::is_none")]
    pub values: Option<Vec<crate::models::GoogleProtobufValue>>,
}

impl GoogleProtobufValueListValue {
    pub fn new() -> GoogleProtobufValueListValue {
        GoogleProtobufValueListValue { values: None }
    }
}
