...
pub struct GoogleProtobufValueStructValue {
    #[serde(rename = "fields", skip_serializing_if = "Option::is_none")]
    pub fields: Option<crate::models::PutTwinDocumentRequestDataFields>,
}

impl GoogleProtobufValueStructValue {
    pub fn new() -> GoogleProtobufValueStructValue {
        GoogleProtobufValueStructValue { fields: None }
    }
}
