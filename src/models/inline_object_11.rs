...
pub struct InlineObject11 {
    ...
    pub protocol: crate::models::ScalewayInstanceV1SecurityGroupRuleProtocol,
    #[serde(rename = "direction")]
    pub direction: crate::models::ScalewayInstanceV1SecurityGroupRuleDirection,
    #[serde(rename = "action")]
    pub action: crate::models::ScalewayInstanceV1SecurityGroupRuleAction,
    /// (IP network)
    #[serde(rename = "ip_range")]
    pub ip_range: String,
    #[serde(rename = "dest_port_from", skip_serializing_if = "Option::is_none")]
    pub dest_port_from: Option<f32>,
    #[serde(rename = "dest_port_to", skip_serializing_if = "Option::is_none")]
    pub dest_port_to: Option<f32>,
...
impl InlineObject11 {
    pub fn new(protocol: crate::models::ScalewayInstanceV1SecurityGroupRuleProtocol, direction: crate::models::ScalewayInstanceV1SecurityGroupRuleDirection, action: crate::models::ScalewayInstanceV1SecurityGroupRuleAction, ip_range: String) -> InlineObject11 {
        InlineObject11 {
            protocol,
            direction,
            action,
