...
impl InlineObject11 {
    pub fn new(
        protocol: crate::models::ScalewayInstanceV1SecurityGroupRuleProtocol,
        direction: crate::models::ScalewayInstanceV1SecurityGroupRuleDirection,
        action: crate::models::ScalewayInstanceV1SecurityGroupRuleAction,
        ip_range: String,
    ) -> InlineObject11 {
        InlineObject11 {
            protocol,
