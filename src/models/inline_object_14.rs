...
pub struct InlineObject14 {
    ...
    pub boot_type: Option<crate::models::ScalewayInstanceV1BootType>,
    /// Tags of the server
    ...
    pub security_group: Option<Box<crate::models::ScalewayInstanceV1SecurityGroupTemplate>>,
