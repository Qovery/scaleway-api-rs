...
pub struct InlineObject29 {
    ...
    #[serde(rename = "match")]
    pub _match: Box<crate::models::LbV1RegionsRegionAclsAclIdMatch>,
...
impl InlineObject29 {
    pub fn new(name: String, action: crate::models::LbV1RegionsRegionAclsAclIdAction, _match: crate::models::LbV1RegionsRegionAclsAclIdMatch, index: f32) -> InlineObject29 {
        InlineObject29 {
            name,
