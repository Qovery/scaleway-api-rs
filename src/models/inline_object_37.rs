...
pub struct InlineObject37 {
    ...
    pub name: String,
    #[serde(rename = "action")]
    pub action: Box<crate::models::LbV1RegionsRegionAclsAclIdAction>,
    #[serde(rename = "match")]
    pub _match: Box<crate::models::LbV1RegionsRegionFrontendsFrontendIdAclsMatch>,
...
impl InlineObject37 {
    pub fn new(name: String, action: crate::models::LbV1RegionsRegionAclsAclIdAction, _match: crate::models::LbV1RegionsRegionFrontendsFrontendIdAclsMatch, index: f32) -> InlineObject37 {
        InlineObject37 {
            name,
            action: Box::new(action),
            _match: Box::new(_match),
            index,
        }
    }
}
