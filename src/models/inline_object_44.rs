...
pub struct InlineObject44 {
    ...
    pub letsencrypt: Box<crate::models::LbV1RegionsRegionLbsLbIdCertificatesLetsencrypt>,
    #[serde(rename = "custom_certificate")]
    pub custom_certificate: Box<crate::models::LbV1RegionsRegionLbsLbIdCertificatesCustomCertificate>,
}

impl InlineObject44 {
    pub fn new(name: String, letsencrypt: crate::models::LbV1RegionsRegionLbsLbIdCertificatesLetsencrypt, custom_certificate: crate::models::LbV1RegionsRegionLbsLbIdCertificatesCustomCertificate) -> InlineObject44 {
        InlineObject44 {
            name,
            letsencrypt: Box::new(letsencrypt),
            custom_certificate: Box::new(custom_certificate),
        }
    }
}
