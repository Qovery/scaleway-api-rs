...
pub struct InlineObject5 {
    ...
    pub policy_mode: Option<crate::models::ScalewayInstanceV1PlacementGroupPolicyMode>,
    #[serde(rename = "policy_type", skip_serializing_if = "Option::is_none")]
    pub policy_type: Option<crate::models::ScalewayInstanceV1PlacementGroupPolicyType>,
