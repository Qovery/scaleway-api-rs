...
pub struct InlineObject50 {
    ...
    pub email_config: Option<Box<crate::models::LbV1RegionsRegionSubscribersEmailConfig>>,
    #[serde(rename = "webhook_config", skip_serializing_if = "Option::is_none")]
    pub webhook_config: Option<Box<crate::models::LbV1RegionsRegionSubscribersWebhookConfig>>,
    /// Owner of resources
...
impl InlineObject50 {
    pub fn new(name: String, project_id: String) -> InlineObject50 {
        InlineObject50 {
            name,
            email_config: None,
            webhook_config: None,
