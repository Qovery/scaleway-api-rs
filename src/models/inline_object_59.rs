...
pub struct InlineObject59 {
    /// In hours
    #[serde(rename = "backup_schedule_frequency", skip_serializing_if = "Option::is_none")]
    pub backup_schedule_frequency: Option<f32>,
    /// In days
    #[serde(rename = "backup_schedule_retention", skip_serializing_if = "Option::is_none")]
    pub backup_schedule_retention: Option<f32>,
    /// Whether or not the backup schedule is disabled
    #[serde(rename = "is_backup_schedule_disabled", skip_serializing_if = "Option::is_none")]
