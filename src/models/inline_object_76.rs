...
pub struct InlineObject76 {
    ...
    pub open_id_connect_config: Option<Box<crate::models::K8sV1RegionsRegionClustersOpenIdConnectConfig>>,
...
impl InlineObject76 {
    pub fn new(name: String, version: String, cni: Cni) -> InlineObject76 {
        InlineObject76 {
