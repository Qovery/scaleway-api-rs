...
pub struct InlineObject80 {
    ...
    pub kubelet_args: Option<Box<crate::models::K8sV1RegionsRegionPoolsPoolIdKubeletArgs>>,
    #[serde(rename = "upgrade_policy", skip_serializing_if = "Option::is_none")]
    pub upgrade_policy: Option<Box<crate::models::K8sV1RegionsRegionClustersClusterIdPoolsUpgradePolicy>>,
}
