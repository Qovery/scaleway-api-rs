...
pub struct PatchTwinDocumentRequest {
    /// If set, ensures that the document's current version matches before persisting the update.
    #[serde(rename = "version", skip_serializing_if = "Option::is_none")]
    pub version: Option<i64>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::PatchTwinDocumentRequestData>>,
}

impl PatchTwinDocumentRequest {
    pub fn new() -> PatchTwinDocumentRequest {
