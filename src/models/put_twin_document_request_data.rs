...
/// PutTwinDocumentRequestData : The new data that will replace the contents of the document.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct PutTwinDocumentRequestData {
    #[serde(rename = "fields", skip_serializing_if = "Option::is_none")]
    pub fields: Option<crate::models::PutTwinDocumentRequestDataFields>,
}

impl PutTwinDocumentRequestData {
    /// The new data that will replace the contents of the document.
    pub fn new() -> PutTwinDocumentRequestData {
        PutTwinDocumentRequestData { fields: None }
    }
}
