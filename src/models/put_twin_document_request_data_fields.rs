...
pub struct PutTwinDocumentRequestDataFields {
    #[serde(rename = "<fieldKey>", skip_serializing_if = "Option::is_none")]
    pub field_key: Option<Box<crate::models::GoogleProtobufValue>>,
}

impl PutTwinDocumentRequestDataFields {
    pub fn new() -> PutTwinDocumentRequestDataFields {
        PutTwinDocumentRequestDataFields { field_key: None }
    }
}
