...
pub struct ScalewayAppleSiliconV1alpha1ListOsResponse {
    /// Total number of os
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
    /// List of OS
    #[serde(rename = "os", skip_serializing_if = "Option::is_none")]
    pub os: Option<Vec<crate::models::ScalewayAppleSiliconV1alpha1Os>>,
}

impl ScalewayAppleSiliconV1alpha1ListOsResponse {
    pub fn new() -> ScalewayAppleSiliconV1alpha1ListOsResponse {
        ScalewayAppleSiliconV1alpha1ListOsResponse {
            total_count: None,
            os: None,
        }
    }
