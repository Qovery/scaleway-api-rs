...
pub struct ScalewayAppleSiliconV1alpha1ListServerTypesResponse {
    /// The available server types
    #[serde(rename = "server_types", skip_serializing_if = "Option::is_none")]
    pub server_types: Option<Vec<crate::models::ScalewayAppleSiliconV1alpha1ServerType>>,
}

impl ScalewayAppleSiliconV1alpha1ListServerTypesResponse {
    pub fn new() -> ScalewayAppleSiliconV1alpha1ListServerTypesResponse {
        ScalewayAppleSiliconV1alpha1ListServerTypesResponse { server_types: None }
    }
}
