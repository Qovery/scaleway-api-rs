...
pub struct ScalewayAppleSiliconV1alpha1ListServersResponse {
    ...
    pub servers: Option<Vec<crate::models::ScalewayAppleSiliconV1alpha1Server>>,
}

impl ScalewayAppleSiliconV1alpha1ListServersResponse {
    pub fn new() -> ScalewayAppleSiliconV1alpha1ListServersResponse {
        ScalewayAppleSiliconV1alpha1ListServersResponse {
            total_count: None,
            servers: None,
        }
    }
