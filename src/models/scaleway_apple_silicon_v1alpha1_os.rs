...
pub struct ScalewayAppleSiliconV1alpha1Os {
    /// The OS unique ID
    ...
    #[serde(rename = "compatible_server_types", skip_serializing_if = "Option::is_none")]
    pub compatible_server_types: Option<Vec<String>>,
}

impl ScalewayAppleSiliconV1alpha1Os {
    pub fn new() -> ScalewayAppleSiliconV1alpha1Os {
        ScalewayAppleSiliconV1alpha1Os {
            id: None,
            name: None,
            label: None,
            image_url: None,
            compatible_server_types: None,
        }
    }
}
