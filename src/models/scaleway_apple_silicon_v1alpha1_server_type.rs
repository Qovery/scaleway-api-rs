...
pub struct ScalewayAppleSiliconV1alpha1ServerType {
    #[serde(rename = "cpu", skip_serializing_if = "Option::is_none")]
    pub cpu: Option<Box<crate::models::ScalewayAppleSiliconV1alpha1ServerTypeCpu>>,
    #[serde(rename = "disk", skip_serializing_if = "Option::is_none")]
    pub disk: Option<Box<crate::models::ScalewayAppleSiliconV1alpha1ServerTypeDisk>>,
    /// Name of the type
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "memory", skip_serializing_if = "Option::is_none")]
    pub memory: Option<Box<crate::models::ScalewayAppleSiliconV1alpha1ServerTypeMemory>>,
    /// Current stock
    ...
    #[serde(rename = "minimum_lease_duration", skip_serializing_if = "Option::is_none")]
    pub minimum_lease_duration: Option<String>,
}

impl ScalewayAppleSiliconV1alpha1ServerType {
    pub fn new() -> ScalewayAppleSiliconV1alpha1ServerType {
        ScalewayAppleSiliconV1alpha1ServerType {
            cpu: None,
            disk: None,
            name: None,
            memory: None,
            stock: None,
            minimum_lease_duration: None,
        }
    }
}
...
pub enum Stock {
    #[serde(rename = "unknown_stock")]
    UnknownStock,
    #[serde(rename = "no_stock")]
    NoStock,
    #[serde(rename = "low_stock")]
    LowStock,
    #[serde(rename = "high_stock")]
    HighStock,
}
