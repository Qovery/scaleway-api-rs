...
/// ScalewayAppleSiliconV1alpha1ServerTypeCpu : CPU description



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayAppleSiliconV1alpha1ServerTypeCpu {
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "core_count", skip_serializing_if = "Option::is_none")]
    pub core_count: Option<f32>,
}

impl ScalewayAppleSiliconV1alpha1ServerTypeCpu {
    /// CPU description
    pub fn new() -> ScalewayAppleSiliconV1alpha1ServerTypeCpu {
