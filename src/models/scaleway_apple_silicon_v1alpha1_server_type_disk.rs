...
/// ScalewayAppleSiliconV1alpha1ServerTypeDisk : Size of the local disk of the server



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayAppleSiliconV1alpha1ServerTypeDisk {
    /// (in bytes)
...
impl ScalewayAppleSiliconV1alpha1ServerTypeDisk {
    /// Size of the local disk of the server
    pub fn new() -> ScalewayAppleSiliconV1alpha1ServerTypeDisk {
