...
/// ScalewayAppleSiliconV1alpha1ServerTypeMemory : Size of memory available



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayAppleSiliconV1alpha1ServerTypeMemory {
    /// (in bytes)
...
impl ScalewayAppleSiliconV1alpha1ServerTypeMemory {
    /// Size of memory available
    pub fn new() -> ScalewayAppleSiliconV1alpha1ServerTypeMemory {
        ScalewayAppleSiliconV1alpha1ServerTypeMemory {
            capacity: None,
            _type: None,
        }
    }
