...
pub struct ScalewayBaremetalV1GetServerMetricsResponse {
...
impl ScalewayBaremetalV1GetServerMetricsResponse {
    pub fn new() -> ScalewayBaremetalV1GetServerMetricsResponse {
        ScalewayBaremetalV1GetServerMetricsResponse { pings: None }
    }
}
