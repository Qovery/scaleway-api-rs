...
pub struct ScalewayBaremetalV1Ip {
    /// ID of the IP
    ...
    #[serde(rename = "reverse_status_message", skip_serializing_if = "Option::is_none")]
    pub reverse_status_message: Option<String>,
}

impl ScalewayBaremetalV1Ip {
    pub fn new() -> ScalewayBaremetalV1Ip {
        ScalewayBaremetalV1Ip {
            id: None,
            address: None,
            reverse: None,
            version: None,
