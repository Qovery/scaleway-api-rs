...
pub struct ScalewayBaremetalV1ListOffersResponse {
    ...
    pub offers: Option<Vec<crate::models::ScalewayBaremetalV1Offer>>,
}

impl ScalewayBaremetalV1ListOffersResponse {
    pub fn new() -> ScalewayBaremetalV1ListOffersResponse {
