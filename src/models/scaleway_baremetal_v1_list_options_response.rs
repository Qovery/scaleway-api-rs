...
pub struct ScalewayBaremetalV1ListOptionsResponse {
    /// Total count of matching options
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i64>,
    /// Options that match filters
    #[serde(rename = "options", skip_serializing_if = "Option::is_none")]
    pub options: Option<Vec<crate::models::ScalewayBaremetalV1Option>>,
}

impl ScalewayBaremetalV1ListOptionsResponse {
    pub fn new() -> ScalewayBaremetalV1ListOptionsResponse {
        ScalewayBaremetalV1ListOptionsResponse {
            total_count: None,
            options: None,
        }
    }
