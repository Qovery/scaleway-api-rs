...
pub struct ScalewayBaremetalV1ListOsResponse {
    /// Total count of matching OS
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
    /// OS that match filters
    #[serde(rename = "os", skip_serializing_if = "Option::is_none")]
    pub os: Option<Vec<crate::models::ScalewayBaremetalV1Os>>,
}

impl ScalewayBaremetalV1ListOsResponse {
    pub fn new() -> ScalewayBaremetalV1ListOsResponse {
