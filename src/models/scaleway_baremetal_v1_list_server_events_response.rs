...
pub struct ScalewayBaremetalV1ListServerEventsResponse {
    /// Total count of matching events
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
    /// Server events that match filters
    #[serde(rename = "events", skip_serializing_if = "Option::is_none")]
    pub events: Option<Vec<crate::models::ScalewayBaremetalV1ServerEvent>>,
}

impl ScalewayBaremetalV1ListServerEventsResponse {
    pub fn new() -> ScalewayBaremetalV1ListServerEventsResponse {
