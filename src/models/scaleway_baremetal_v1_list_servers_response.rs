...
pub struct ScalewayBaremetalV1ListServersResponse {
    ...
    pub servers: Option<Vec<crate::models::ScalewayBaremetalV1Server>>,
}

impl ScalewayBaremetalV1ListServersResponse {
    pub fn new() -> ScalewayBaremetalV1ListServersResponse {
