...
pub struct ScalewayBaremetalV1ListSettingsResponse {
    /// Total count of matching sttings
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i64>,
    /// Settings that match filters
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    pub settings: Option<Vec<crate::models::ScalewayBaremetalV1Setting>>,
}

impl ScalewayBaremetalV1ListSettingsResponse {
    pub fn new() -> ScalewayBaremetalV1ListSettingsResponse {
        ScalewayBaremetalV1ListSettingsResponse {
            total_count: None,
            settings: None,
        }
    }
