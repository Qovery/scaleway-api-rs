...
/// ScalewayBaremetalV1OfferPricePerMonth : Price of the offer per months

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayBaremetalV1OfferPricePerMonth {
    #[serde(rename = "currency_code", skip_serializing_if = "Option::is_none")]
    pub currency_code: Option<String>,
    #[serde(rename = "units", skip_serializing_if = "Option::is_none")]
    pub units: Option<f32>,
    #[serde(rename = "nanos", skip_serializing_if = "Option::is_none")]
    pub nanos: Option<f32>,
}

impl ScalewayBaremetalV1OfferPricePerMonth {
    /// Price of the offer per months
    pub fn new() -> ScalewayBaremetalV1OfferPricePerMonth {
