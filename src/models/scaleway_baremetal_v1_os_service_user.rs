...
/// ScalewayBaremetalV1OsServiceUser : Define the username requirements to install the service

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct ScalewayBaremetalV1OsServiceUser {
...
impl ScalewayBaremetalV1OsServiceUser {
    /// Define the username requirements to install the service
    pub fn new() -> ScalewayBaremetalV1OsServiceUser {
