...
/// ScalewayBaremetalV1OsSsh : Define the SSH requirements to install the OS

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct ScalewayBaremetalV1OsSsh {
...
impl ScalewayBaremetalV1OsSsh {
    /// Define the SSH requirements to install the OS
    pub fn new() -> ScalewayBaremetalV1OsSsh {
        ScalewayBaremetalV1OsSsh {
            editable: None,
            required: None,
            default_value: None,
        }
