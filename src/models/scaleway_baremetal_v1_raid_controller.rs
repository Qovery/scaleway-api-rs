...
pub struct ScalewayBaremetalV1RaidController {
...
impl ScalewayBaremetalV1RaidController {
    pub fn new() -> ScalewayBaremetalV1RaidController {
        ScalewayBaremetalV1RaidController {
            model: None,
            raid_level: None,
        }
    }
