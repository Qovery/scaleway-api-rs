...
pub struct ScalewayBaremetalV1ServerOption {
    /// ID of the option
...
impl ScalewayBaremetalV1ServerOption {
    pub fn new() -> ScalewayBaremetalV1ServerOption {
        ScalewayBaremetalV1ServerOption {
            id: None,
            name: None,
            status: None,
            manageable: None,
