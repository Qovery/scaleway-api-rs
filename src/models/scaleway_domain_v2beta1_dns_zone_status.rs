...
pub enum ScalewayDomainV2beta1DnsZoneStatus {
...
impl ToString for ScalewayDomainV2beta1DnsZoneStatus {
...
impl Default for ScalewayDomainV2beta1DnsZoneStatus {
    fn default() -> ScalewayDomainV2beta1DnsZoneStatus {
        Self::Unknown
    }
}
