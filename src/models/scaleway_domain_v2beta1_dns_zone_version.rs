...
pub struct ScalewayDomainV2beta1DnsZoneVersion {
    /// (UUID format)
...
impl ScalewayDomainV2beta1DnsZoneVersion {
    pub fn new() -> ScalewayDomainV2beta1DnsZoneVersion {
        ScalewayDomainV2beta1DnsZoneVersion {
            id: None,
            created_at: None,
        }
    }
