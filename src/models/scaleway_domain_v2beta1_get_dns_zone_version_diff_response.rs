...
pub struct ScalewayDomainV2beta1GetDnsZoneVersionDiffResponse {
...
impl ScalewayDomainV2beta1GetDnsZoneVersionDiffResponse {
    pub fn new() -> ScalewayDomainV2beta1GetDnsZoneVersionDiffResponse {
        ScalewayDomainV2beta1GetDnsZoneVersionDiffResponse { changes: None }
    }
}
