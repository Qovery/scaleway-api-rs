...
pub struct ScalewayDomainV2beta1ImportProviderDnsZoneResponse {
    #[serde(rename = "records", skip_serializing_if = "Option::is_none")]
    pub records: Option<Vec<crate::models::ScalewayDomainV2beta1Record>>,
}

impl ScalewayDomainV2beta1ImportProviderDnsZoneResponse {
    pub fn new() -> ScalewayDomainV2beta1ImportProviderDnsZoneResponse {
        ScalewayDomainV2beta1ImportProviderDnsZoneResponse { records: None }
    }
}
