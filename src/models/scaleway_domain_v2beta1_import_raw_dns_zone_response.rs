...
pub struct ScalewayDomainV2beta1ImportRawDnsZoneResponse {
    #[serde(rename = "records", skip_serializing_if = "Option::is_none")]
    pub records: Option<Vec<crate::models::ScalewayDomainV2beta1Record>>,
}

impl ScalewayDomainV2beta1ImportRawDnsZoneResponse {
    pub fn new() -> ScalewayDomainV2beta1ImportRawDnsZoneResponse {
        ScalewayDomainV2beta1ImportRawDnsZoneResponse { records: None }
    }
}
