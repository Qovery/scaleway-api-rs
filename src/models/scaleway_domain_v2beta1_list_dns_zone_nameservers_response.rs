...
pub struct ScalewayDomainV2beta1ListDnsZoneNameserversResponse {
...
impl ScalewayDomainV2beta1ListDnsZoneNameserversResponse {
    pub fn new() -> ScalewayDomainV2beta1ListDnsZoneNameserversResponse {
        ScalewayDomainV2beta1ListDnsZoneNameserversResponse { ns: None }
    }
}
