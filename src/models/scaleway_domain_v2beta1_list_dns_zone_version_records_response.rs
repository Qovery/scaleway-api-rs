...
pub struct ScalewayDomainV2beta1ListDnsZoneVersionRecordsResponse {
    #[serde(rename = "records", skip_serializing_if = "Option::is_none")]
    pub records: Option<Vec<crate::models::ScalewayDomainV2beta1Record>>,
}

impl ScalewayDomainV2beta1ListDnsZoneVersionRecordsResponse {
    pub fn new() -> ScalewayDomainV2beta1ListDnsZoneVersionRecordsResponse {
        ScalewayDomainV2beta1ListDnsZoneVersionRecordsResponse { records: None }
    }
}
