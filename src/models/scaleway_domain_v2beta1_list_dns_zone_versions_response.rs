...
pub struct ScalewayDomainV2beta1ListDnsZoneVersionsResponse {
    #[serde(rename = "versions", skip_serializing_if = "Option::is_none")]
    pub versions: Option<Vec<crate::models::ScalewayDomainV2beta1DnsZoneVersion>>,
}

impl ScalewayDomainV2beta1ListDnsZoneVersionsResponse {
    pub fn new() -> ScalewayDomainV2beta1ListDnsZoneVersionsResponse {
        ScalewayDomainV2beta1ListDnsZoneVersionsResponse { versions: None }
    }
}
