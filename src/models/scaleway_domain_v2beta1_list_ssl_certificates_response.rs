...
pub struct ScalewayDomainV2beta1ListSslCertificatesResponse {
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
    #[serde(rename = "certificates", skip_serializing_if = "Option::is_none")]
    pub certificates: Option<Vec<crate::models::ScalewayDomainV2beta1SslCertificate>>,
}

impl ScalewayDomainV2beta1ListSslCertificatesResponse {
    pub fn new() -> ScalewayDomainV2beta1ListSslCertificatesResponse {
