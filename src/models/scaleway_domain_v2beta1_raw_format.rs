...
pub enum ScalewayDomainV2beta1RawFormat {
...
impl ToString for ScalewayDomainV2beta1RawFormat {
...
impl Default for ScalewayDomainV2beta1RawFormat {
    fn default() -> ScalewayDomainV2beta1RawFormat {
