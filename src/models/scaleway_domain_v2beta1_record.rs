...
pub struct ScalewayDomainV2beta1Record {
    ...
    #[serde(rename = "http_service_config", skip_serializing_if = "Option::is_none")]
    pub http_service_config: Option<Box<crate::models::ScalewayDomainV2beta1RecordHttpServiceConfig>>,
