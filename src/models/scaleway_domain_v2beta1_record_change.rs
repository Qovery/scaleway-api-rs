...
pub struct ScalewayDomainV2beta1RecordChange {
...
impl ScalewayDomainV2beta1RecordChange {
    pub fn new() -> ScalewayDomainV2beta1RecordChange {
        ScalewayDomainV2beta1RecordChange {
            add: None,
            set: None,
            delete: None,
            clear: None,
