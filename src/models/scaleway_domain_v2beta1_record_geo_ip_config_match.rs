...
pub struct ScalewayDomainV2beta1RecordGeoIpConfigMatch {
...
impl ScalewayDomainV2beta1RecordGeoIpConfigMatch {
    pub fn new() -> ScalewayDomainV2beta1RecordGeoIpConfigMatch {
