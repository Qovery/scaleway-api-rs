...
pub enum ScalewayDomainV2beta1RecordHttpServiceConfigStrategy {
    #[serde(rename = "random")]
    Random,
    #[serde(rename = "hashed")]
    Hashed,
...
impl ToString for ScalewayDomainV2beta1RecordHttpServiceConfigStrategy {
...
impl Default for ScalewayDomainV2beta1RecordHttpServiceConfigStrategy {
    fn default() -> ScalewayDomainV2beta1RecordHttpServiceConfigStrategy {
        Self::Random
    }
}
