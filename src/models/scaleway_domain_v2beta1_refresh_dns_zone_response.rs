...
pub struct ScalewayDomainV2beta1RefreshDnsZoneResponse {
    /// The returned DNS zones
    #[serde(rename = "dns_zones", skip_serializing_if = "Option::is_none")]
    pub dns_zones: Option<Vec<crate::models::ScalewayDomainV2beta1DnsZone>>,
}

impl ScalewayDomainV2beta1RefreshDnsZoneResponse {
    pub fn new() -> ScalewayDomainV2beta1RefreshDnsZoneResponse {
        ScalewayDomainV2beta1RefreshDnsZoneResponse { dns_zones: None }
    }
}
