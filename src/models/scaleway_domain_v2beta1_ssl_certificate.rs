...
pub struct ScalewayDomainV2beta1SslCertificate {
    #[serde(rename = "dns_zone", skip_serializing_if = "Option::is_none")]
    pub dns_zone: Option<String>,
    #[serde(rename = "alternative_dns_zones", skip_serializing_if = "Option::is_none")]
    pub alternative_dns_zones: Option<Vec<String>>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::ScalewayDomainV2beta1SslCertificateStatus>,
...
impl ScalewayDomainV2beta1SslCertificate {
    pub fn new() -> ScalewayDomainV2beta1SslCertificate {
        ScalewayDomainV2beta1SslCertificate {
            dns_zone: None,
