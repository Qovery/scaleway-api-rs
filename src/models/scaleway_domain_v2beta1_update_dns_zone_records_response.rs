...
pub struct ScalewayDomainV2beta1UpdateDnsZoneRecordsResponse {
...
impl ScalewayDomainV2beta1UpdateDnsZoneRecordsResponse {
    pub fn new() -> ScalewayDomainV2beta1UpdateDnsZoneRecordsResponse {
        ScalewayDomainV2beta1UpdateDnsZoneRecordsResponse { records: None }
    }
}
