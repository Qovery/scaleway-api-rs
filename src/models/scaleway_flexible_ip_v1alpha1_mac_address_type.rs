...
pub enum ScalewayFlexibleIpV1alpha1MacAddressType {
...
impl ToString for ScalewayFlexibleIpV1alpha1MacAddressType {
    fn to_string(&self) -> String {
        match self {
            Self::UnknownType => String::from("unknown_type"),
            Self::Vmware => String::from("vmware"),
            Self::Xen => String::from("xen"),
            Self::Kvm => String::from("kvm"),
        }
    }
}
