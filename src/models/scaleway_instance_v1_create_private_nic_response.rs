...
pub struct ScalewayInstanceV1CreatePrivateNicResponse {
    #[serde(rename = "private_nic", skip_serializing_if = "Option::is_none")]
    pub private_nic: Option<Box<crate::models::ScalewayInstanceV1PrivateNic>>,
}

impl ScalewayInstanceV1CreatePrivateNicResponse {
    pub fn new() -> ScalewayInstanceV1CreatePrivateNicResponse {
        ScalewayInstanceV1CreatePrivateNicResponse { private_nic: None }
    }
}
