...
pub struct ScalewayInstanceV1CreateSecurityGroupResponse {
    #[serde(rename = "security_group", skip_serializing_if = "Option::is_none")]
    pub security_group: Option<Box<crate::models::ScalewayInstanceV1SecurityGroup>>,
}

impl ScalewayInstanceV1CreateSecurityGroupResponse {
    pub fn new() -> ScalewayInstanceV1CreateSecurityGroupResponse {
