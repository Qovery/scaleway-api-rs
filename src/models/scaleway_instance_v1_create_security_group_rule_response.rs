...
pub struct ScalewayInstanceV1CreateSecurityGroupRuleResponse {
    #[serde(rename = "rule", skip_serializing_if = "Option::is_none")]
    pub rule: Option<Box<crate::models::ScalewayInstanceV1SecurityGroupRule>>,
}

impl ScalewayInstanceV1CreateSecurityGroupRuleResponse {
    pub fn new() -> ScalewayInstanceV1CreateSecurityGroupRuleResponse {
        ScalewayInstanceV1CreateSecurityGroupRuleResponse { rule: None }
    }
}
