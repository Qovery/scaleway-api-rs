...
pub struct ScalewayInstanceV1CreateServerResponse {
    #[serde(rename = "server", skip_serializing_if = "Option::is_none")]
    pub server: Option<Box<crate::models::ScalewayInstanceV1Server>>,
}

impl ScalewayInstanceV1CreateServerResponse {
    pub fn new() -> ScalewayInstanceV1CreateServerResponse {
        ScalewayInstanceV1CreateServerResponse { server: None }
    }
}
