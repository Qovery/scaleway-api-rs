...
pub struct ScalewayInstanceV1CreateSnapshotResponse {
    #[serde(rename = "snapshot", skip_serializing_if = "Option::is_none")]
    pub snapshot: Option<Box<crate::models::ScalewayInstanceV1Snapshot>>,
}

impl ScalewayInstanceV1CreateSnapshotResponse {
    pub fn new() -> ScalewayInstanceV1CreateSnapshotResponse {
        ScalewayInstanceV1CreateSnapshotResponse { snapshot: None }
    }
}
