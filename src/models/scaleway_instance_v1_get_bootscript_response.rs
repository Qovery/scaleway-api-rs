...
pub struct ScalewayInstanceV1GetBootscriptResponse {
    #[serde(rename = "bootscript", skip_serializing_if = "Option::is_none")]
    pub bootscript: Option<Box<crate::models::ScalewayInstanceV1Bootscript>>,
}

impl ScalewayInstanceV1GetBootscriptResponse {
    pub fn new() -> ScalewayInstanceV1GetBootscriptResponse {
        ScalewayInstanceV1GetBootscriptResponse { bootscript: None }
    }
}
