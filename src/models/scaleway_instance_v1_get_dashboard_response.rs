...
pub struct ScalewayInstanceV1GetDashboardResponse {
    #[serde(rename = "dashboard", skip_serializing_if = "Option::is_none")]
    pub dashboard: Option<Box<crate::models::ScalewayInstanceV1Dashboard>>,
}

impl ScalewayInstanceV1GetDashboardResponse {
    pub fn new() -> ScalewayInstanceV1GetDashboardResponse {
        ScalewayInstanceV1GetDashboardResponse { dashboard: None }
    }
}
