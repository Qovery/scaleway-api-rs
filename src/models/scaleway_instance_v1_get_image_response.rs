...
pub struct ScalewayInstanceV1GetImageResponse {
    #[serde(rename = "image", skip_serializing_if = "Option::is_none")]
    pub image: Option<Box<crate::models::ScalewayInstanceV1Image>>,
}

impl ScalewayInstanceV1GetImageResponse {
    pub fn new() -> ScalewayInstanceV1GetImageResponse {
        ScalewayInstanceV1GetImageResponse { image: None }
    }
}
