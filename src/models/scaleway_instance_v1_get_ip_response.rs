...
pub struct ScalewayInstanceV1GetIpResponse {
    #[serde(rename = "ip", skip_serializing_if = "Option::is_none")]
    pub ip: Option<Box<crate::models::ScalewayInstanceV1Ip>>,
}

impl ScalewayInstanceV1GetIpResponse {
    pub fn new() -> ScalewayInstanceV1GetIpResponse {
        ScalewayInstanceV1GetIpResponse { ip: None }
    }
}
