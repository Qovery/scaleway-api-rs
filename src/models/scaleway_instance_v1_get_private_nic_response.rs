...
pub struct ScalewayInstanceV1GetPrivateNicResponse {
...
impl ScalewayInstanceV1GetPrivateNicResponse {
    pub fn new() -> ScalewayInstanceV1GetPrivateNicResponse {
        ScalewayInstanceV1GetPrivateNicResponse { private_nic: None }
    }
}
