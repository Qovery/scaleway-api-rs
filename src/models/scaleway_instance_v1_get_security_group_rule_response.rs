...
pub struct ScalewayInstanceV1GetSecurityGroupRuleResponse {
    #[serde(rename = "rule", skip_serializing_if = "Option::is_none")]
    pub rule: Option<Box<crate::models::ScalewayInstanceV1SecurityGroupRule>>,
}

impl ScalewayInstanceV1GetSecurityGroupRuleResponse {
    pub fn new() -> ScalewayInstanceV1GetSecurityGroupRuleResponse {
        ScalewayInstanceV1GetSecurityGroupRuleResponse { rule: None }
    }
}
