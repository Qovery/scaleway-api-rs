...
pub struct ScalewayInstanceV1GetServerResponse {
    #[serde(rename = "server", skip_serializing_if = "Option::is_none")]
    pub server: Option<Box<crate::models::ScalewayInstanceV1Server>>,
}

impl ScalewayInstanceV1GetServerResponse {
    pub fn new() -> ScalewayInstanceV1GetServerResponse {
        ScalewayInstanceV1GetServerResponse { server: None }
    }
}
