...
pub struct ScalewayInstanceV1GetServerTypesAvailabilityResponse {
    #[serde(rename = "servers", skip_serializing_if = "Option::is_none")]
    pub servers: Option<::std::collections::HashMap<String, serde_json::Value>>,
}

impl ScalewayInstanceV1GetServerTypesAvailabilityResponse {
    pub fn new() -> ScalewayInstanceV1GetServerTypesAvailabilityResponse {
        ScalewayInstanceV1GetServerTypesAvailabilityResponse { servers: None }
    }
}
