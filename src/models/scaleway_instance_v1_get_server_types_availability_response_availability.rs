...
pub struct ScalewayInstanceV1GetServerTypesAvailabilityResponseAvailability {
    #[serde(rename = "availability", skip_serializing_if = "Option::is_none")]
    pub availability: Option<crate::models::ScalewayInstanceV1ServerTypesAvailability>,
}

impl ScalewayInstanceV1GetServerTypesAvailabilityResponseAvailability {
    pub fn new() -> ScalewayInstanceV1GetServerTypesAvailabilityResponseAvailability {
        ScalewayInstanceV1GetServerTypesAvailabilityResponseAvailability { availability: None }
    }
}
