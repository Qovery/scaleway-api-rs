...
pub struct ScalewayInstanceV1GetSnapshotResponse {
    #[serde(rename = "snapshot", skip_serializing_if = "Option::is_none")]
    pub snapshot: Option<Box<crate::models::ScalewayInstanceV1Snapshot>>,
}

impl ScalewayInstanceV1GetSnapshotResponse {
    pub fn new() -> ScalewayInstanceV1GetSnapshotResponse {
        ScalewayInstanceV1GetSnapshotResponse { snapshot: None }
    }
}
