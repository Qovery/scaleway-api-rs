...
pub struct ScalewayInstanceV1GetVolumeResponse {
    #[serde(rename = "volume", skip_serializing_if = "Option::is_none")]
    pub volume: Option<Box<crate::models::ScalewayInstanceV1Volume>>,
}

impl ScalewayInstanceV1GetVolumeResponse {
    pub fn new() -> ScalewayInstanceV1GetVolumeResponse {
        ScalewayInstanceV1GetVolumeResponse { volume: None }
    }
}
