...
pub struct ScalewayInstanceV1Ip {
    ...
    pub server: Option<Box<crate::models::ScalewayInstanceV1ServerSummary>>,
...
impl ScalewayInstanceV1Ip {
    pub fn new() -> ScalewayInstanceV1Ip {
