...
pub struct ScalewayInstanceV1ListBootscriptsResponse {
    #[serde(rename = "bootscripts", skip_serializing_if = "Option::is_none")]
    pub bootscripts: Option<Vec<crate::models::ScalewayInstanceV1Bootscript>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayInstanceV1ListBootscriptsResponse {
    pub fn new() -> ScalewayInstanceV1ListBootscriptsResponse {
