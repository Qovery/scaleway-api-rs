...
pub struct ScalewayInstanceV1ListImagesResponse {
    #[serde(rename = "images", skip_serializing_if = "Option::is_none")]
    pub images: Option<Vec<crate::models::ScalewayInstanceV1Image>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayInstanceV1ListImagesResponse {
    pub fn new() -> ScalewayInstanceV1ListImagesResponse {
