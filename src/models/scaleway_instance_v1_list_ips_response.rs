...
pub struct ScalewayInstanceV1ListIpsResponse {
    #[serde(rename = "ips", skip_serializing_if = "Option::is_none")]
    pub ips: Option<Vec<crate::models::ScalewayInstanceV1Ip>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayInstanceV1ListIpsResponse {
    pub fn new() -> ScalewayInstanceV1ListIpsResponse {
