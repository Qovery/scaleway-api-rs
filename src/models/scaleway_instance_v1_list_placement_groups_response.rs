...
pub struct ScalewayInstanceV1ListPlacementGroupsResponse {
    #[serde(rename = "placement_groups", skip_serializing_if = "Option::is_none")]
    pub placement_groups: Option<Vec<crate::models::ScalewayInstanceV1PlacementGroup>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayInstanceV1ListPlacementGroupsResponse {
    pub fn new() -> ScalewayInstanceV1ListPlacementGroupsResponse {
