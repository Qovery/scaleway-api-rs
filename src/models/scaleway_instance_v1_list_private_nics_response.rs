...
pub struct ScalewayInstanceV1ListPrivateNicsResponse {
...
impl ScalewayInstanceV1ListPrivateNicsResponse {
    pub fn new() -> ScalewayInstanceV1ListPrivateNicsResponse {
        ScalewayInstanceV1ListPrivateNicsResponse { private_nics: None }
    }
}
