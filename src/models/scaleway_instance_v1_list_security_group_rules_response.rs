...
pub struct ScalewayInstanceV1ListSecurityGroupRulesResponse {
    #[serde(rename = "rules", skip_serializing_if = "Option::is_none")]
    pub rules: Option<Vec<crate::models::ScalewayInstanceV1SecurityGroupRule>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayInstanceV1ListSecurityGroupRulesResponse {
    pub fn new() -> ScalewayInstanceV1ListSecurityGroupRulesResponse {
