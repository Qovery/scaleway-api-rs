...
pub struct ScalewayInstanceV1ListSecurityGroupsResponse {
    #[serde(rename = "security_groups", skip_serializing_if = "Option::is_none")]
    pub security_groups: Option<Vec<crate::models::ScalewayInstanceV1SecurityGroup>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayInstanceV1ListSecurityGroupsResponse {
    pub fn new() -> ScalewayInstanceV1ListSecurityGroupsResponse {
