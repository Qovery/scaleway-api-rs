...
pub struct ScalewayInstanceV1ListServerActionsResponse {
    #[serde(rename = "actions", skip_serializing_if = "Option::is_none")]
    pub actions: Option<Vec<crate::models::ScalewayInstanceV1ServerAction>>,
}

impl ScalewayInstanceV1ListServerActionsResponse {
    pub fn new() -> ScalewayInstanceV1ListServerActionsResponse {
        ScalewayInstanceV1ListServerActionsResponse { actions: None }
    }
}
