...
pub struct ScalewayInstanceV1ListServerUserDataResponse {
    #[serde(rename = "user_data", skip_serializing_if = "Option::is_none")]
    pub user_data: Option<Vec<String>>,
}

impl ScalewayInstanceV1ListServerUserDataResponse {
    pub fn new() -> ScalewayInstanceV1ListServerUserDataResponse {
        ScalewayInstanceV1ListServerUserDataResponse { user_data: None }
    }
}
