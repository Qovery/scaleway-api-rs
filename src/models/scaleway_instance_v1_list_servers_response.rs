...
pub struct ScalewayInstanceV1ListServersResponse {
    #[serde(rename = "servers", skip_serializing_if = "Option::is_none")]
    pub servers: Option<Vec<crate::models::ScalewayInstanceV1Server>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayInstanceV1ListServersResponse {
    pub fn new() -> ScalewayInstanceV1ListServersResponse {
