...
pub struct ScalewayInstanceV1ListSnapshotsResponse {
    #[serde(rename = "snapshots", skip_serializing_if = "Option::is_none")]
    pub snapshots: Option<Vec<crate::models::ScalewayInstanceV1Snapshot>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayInstanceV1ListSnapshotsResponse {
    pub fn new() -> ScalewayInstanceV1ListSnapshotsResponse {
