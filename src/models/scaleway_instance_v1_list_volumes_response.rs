...
pub struct ScalewayInstanceV1ListVolumesResponse {
    #[serde(rename = "volumes", skip_serializing_if = "Option::is_none")]
    pub volumes: Option<Vec<crate::models::ScalewayInstanceV1Volume>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayInstanceV1ListVolumesResponse {
    pub fn new() -> ScalewayInstanceV1ListVolumesResponse {
