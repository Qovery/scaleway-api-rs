...
pub struct ScalewayInstanceV1SecurityGroupRule {
    ...
    pub protocol: Option<crate::models::ScalewayInstanceV1SecurityGroupRuleProtocol>,
    #[serde(rename = "direction", skip_serializing_if = "Option::is_none")]
    pub direction: Option<crate::models::ScalewayInstanceV1SecurityGroupRuleDirection>,
    #[serde(rename = "action", skip_serializing_if = "Option::is_none")]
    pub action: Option<crate::models::ScalewayInstanceV1SecurityGroupRuleAction>,
    /// (IP network)
...
impl ScalewayInstanceV1SecurityGroupRule {
    pub fn new() -> ScalewayInstanceV1SecurityGroupRule {
