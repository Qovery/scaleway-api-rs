...
pub struct ScalewayInstanceV1ServerActionResponse {
    #[serde(rename = "task", skip_serializing_if = "Option::is_none")]
    pub task: Option<Box<crate::models::ScalewayInstanceV1Task>>,
}

impl ScalewayInstanceV1ServerActionResponse {
    pub fn new() -> ScalewayInstanceV1ServerActionResponse {
        ScalewayInstanceV1ServerActionResponse { task: None }
    }
}
