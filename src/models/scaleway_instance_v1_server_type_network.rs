...
pub struct ScalewayInstanceV1ServerTypeNetwork {
    ...
    pub interfaces: Option<Vec<crate::models::ScalewayInstanceV1ServerTypeNetworkInterface>>,
    /// Total maximum internal bandwidth in bits per seconds
    #[serde(rename = "sum_internal_bandwidth", skip_serializing_if = "Option::is_none")]
    pub sum_internal_bandwidth: Option<f32>,
    /// Total maximum internet bandwidth in bits per seconds
    #[serde(rename = "sum_internet_bandwidth", skip_serializing_if = "Option::is_none")]
    pub sum_internet_bandwidth: Option<f32>,
