...
pub struct ScalewayInstanceV1ServerTypeNetworkInterface {
    /// Maximum internal bandwidth in bits per seconds
    #[serde(rename = "internal_bandwidth", skip_serializing_if = "Option::is_none")]
    pub internal_bandwidth: Option<f32>,
    /// Maximum internet bandwidth in bits per seconds
    #[serde(rename = "internet_bandwidth", skip_serializing_if = "Option::is_none")]
    pub internet_bandwidth: Option<f32>,
}

impl ScalewayInstanceV1ServerTypeNetworkInterface {
    pub fn new() -> ScalewayInstanceV1ServerTypeNetworkInterface {
