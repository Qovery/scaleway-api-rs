...
pub struct ScalewayInstanceV1SetImageResponse {
    #[serde(rename = "image", skip_serializing_if = "Option::is_none")]
    pub image: Option<Box<crate::models::ScalewayInstanceV1Image>>,
}

impl ScalewayInstanceV1SetImageResponse {
    pub fn new() -> ScalewayInstanceV1SetImageResponse {
        ScalewayInstanceV1SetImageResponse { image: None }
    }
}
