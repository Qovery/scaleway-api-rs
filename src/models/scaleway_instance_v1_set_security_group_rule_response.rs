...
pub struct ScalewayInstanceV1SetSecurityGroupRuleResponse {
    #[serde(rename = "rule", skip_serializing_if = "Option::is_none")]
    pub rule: Option<Box<crate::models::ScalewayInstanceV1SecurityGroupRule>>,
}

impl ScalewayInstanceV1SetSecurityGroupRuleResponse {
    pub fn new() -> ScalewayInstanceV1SetSecurityGroupRuleResponse {
        ScalewayInstanceV1SetSecurityGroupRuleResponse { rule: None }
    }
}
