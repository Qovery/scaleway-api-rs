...
pub struct ScalewayInstanceV1SetSnapshotResponse {
    #[serde(rename = "snapshot", skip_serializing_if = "Option::is_none")]
    pub snapshot: Option<Box<crate::models::ScalewayInstanceV1Snapshot>>,
}

impl ScalewayInstanceV1SetSnapshotResponse {
    pub fn new() -> ScalewayInstanceV1SetSnapshotResponse {
        ScalewayInstanceV1SetSnapshotResponse { snapshot: None }
    }
}
