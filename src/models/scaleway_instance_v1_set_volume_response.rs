...
pub struct ScalewayInstanceV1SetVolumeResponse {
    #[serde(rename = "volume", skip_serializing_if = "Option::is_none")]
    pub volume: Option<Box<crate::models::ScalewayInstanceV1Volume>>,
}

impl ScalewayInstanceV1SetVolumeResponse {
    pub fn new() -> ScalewayInstanceV1SetVolumeResponse {
        ScalewayInstanceV1SetVolumeResponse { volume: None }
    }
}
