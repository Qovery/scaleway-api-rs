...
pub struct ScalewayInstanceV1UpdateIpResponse {
    #[serde(rename = "ip", skip_serializing_if = "Option::is_none")]
    pub ip: Option<Box<crate::models::ScalewayInstanceV1Ip>>,
}

impl ScalewayInstanceV1UpdateIpResponse {
    pub fn new() -> ScalewayInstanceV1UpdateIpResponse {
        ScalewayInstanceV1UpdateIpResponse { ip: None }
    }
}
