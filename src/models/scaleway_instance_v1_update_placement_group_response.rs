...
pub struct ScalewayInstanceV1UpdatePlacementGroupResponse {
    #[serde(rename = "placement_group", skip_serializing_if = "Option::is_none")]
    pub placement_group: Option<Box<crate::models::ScalewayInstanceV1PlacementGroup>>,
}

impl ScalewayInstanceV1UpdatePlacementGroupResponse {
    pub fn new() -> ScalewayInstanceV1UpdatePlacementGroupResponse {
