...
pub struct ScalewayInstanceV1UpdatePlacementGroupServersResponse {
    #[serde(rename = "servers", skip_serializing_if = "Option::is_none")]
    pub servers: Option<Vec<crate::models::ScalewayInstanceV1PlacementGroupServer>>,
}

impl ScalewayInstanceV1UpdatePlacementGroupServersResponse {
    pub fn new() -> ScalewayInstanceV1UpdatePlacementGroupServersResponse {
        ScalewayInstanceV1UpdatePlacementGroupServersResponse { servers: None }
    }
}
