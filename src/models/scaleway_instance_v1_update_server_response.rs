...
pub struct ScalewayInstanceV1UpdateServerResponse {
    #[serde(rename = "server", skip_serializing_if = "Option::is_none")]
    pub server: Option<Box<crate::models::ScalewayInstanceV1Server>>,
}

impl ScalewayInstanceV1UpdateServerResponse {
    pub fn new() -> ScalewayInstanceV1UpdateServerResponse {
        ScalewayInstanceV1UpdateServerResponse { server: None }
    }
}
