...
pub struct ScalewayInstanceV1UpdateVolumeResponse {
    #[serde(rename = "volume", skip_serializing_if = "Option::is_none")]
    pub volume: Option<Box<crate::models::ScalewayInstanceV1Volume>>,
}

impl ScalewayInstanceV1UpdateVolumeResponse {
    pub fn new() -> ScalewayInstanceV1UpdateVolumeResponse {
        ScalewayInstanceV1UpdateVolumeResponse { volume: None }
    }
}
