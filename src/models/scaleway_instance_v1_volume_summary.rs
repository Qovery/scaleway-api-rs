...
pub struct ScalewayInstanceV1VolumeSummary {
    ...
    pub volume_type: Option<crate::models::ScalewayInstanceV1VolumeVolumeType>,
}

impl ScalewayInstanceV1VolumeSummary {
    pub fn new() -> ScalewayInstanceV1VolumeSummary {
