...
pub struct ScalewayInstanceV1VolumeType {
    #[serde(rename = "display_name", skip_serializing_if = "Option::is_none")]
    pub display_name: Option<String>,
    #[serde(rename = "capabilities", skip_serializing_if = "Option::is_none")]
    pub capabilities: Option<Box<crate::models::ScalewayInstanceV1VolumeTypeCapabilities>>,
    #[serde(rename = "constraints", skip_serializing_if = "Option::is_none")]
    pub constraints: Option<Box<crate::models::ScalewayInstanceV1VolumeTypeConstraints>>,
}

impl ScalewayInstanceV1VolumeType {
    pub fn new() -> ScalewayInstanceV1VolumeType {
