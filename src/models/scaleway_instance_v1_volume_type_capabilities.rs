...
pub struct ScalewayInstanceV1VolumeTypeCapabilities {
    #[serde(rename = "snapshot", skip_serializing_if = "Option::is_none")]
    pub snapshot: Option<bool>,
}

impl ScalewayInstanceV1VolumeTypeCapabilities {
    pub fn new() -> ScalewayInstanceV1VolumeTypeCapabilities {
        ScalewayInstanceV1VolumeTypeCapabilities { snapshot: None }
    }
}
