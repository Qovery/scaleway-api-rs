...
pub struct ScalewayIotV1CreateDeviceResponse {
...
impl ScalewayIotV1CreateDeviceResponse {
    pub fn new() -> ScalewayIotV1CreateDeviceResponse {
        ScalewayIotV1CreateDeviceResponse {
            device: None,
            certificate: None,
        }
    }
