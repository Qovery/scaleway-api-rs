...
/// ScalewayIotV1CreateDeviceResponseCertificate : Device certificate



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayIotV1CreateDeviceResponseCertificate {
    #[serde(rename = "crt", skip_serializing_if = "Option::is_none")]
    pub crt: Option<String>,
    #[serde(rename = "key", skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
}

impl ScalewayIotV1CreateDeviceResponseCertificate {
    /// Device certificate
    pub fn new() -> ScalewayIotV1CreateDeviceResponseCertificate {
