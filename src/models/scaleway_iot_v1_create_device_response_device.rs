...
/// ScalewayIotV1CreateDeviceResponseDevice : Created device information



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayIotV1CreateDeviceResponseDevice {
    ...
    #[serde(rename = "allow_multiple_connections", skip_serializing_if = "Option::is_none")]
    pub allow_multiple_connections: Option<bool>,
    #[serde(rename = "message_filters", skip_serializing_if = "Option::is_none")]
    pub message_filters: Option<Box<crate::models::IotV1RegionsRegionDevicesDeviceIdMessageFilters>>,
    ...
    #[serde(rename = "has_custom_certificate", skip_serializing_if = "Option::is_none")]
...
impl ScalewayIotV1CreateDeviceResponseDevice {
    /// Created device information
    pub fn new() -> ScalewayIotV1CreateDeviceResponseDevice {
