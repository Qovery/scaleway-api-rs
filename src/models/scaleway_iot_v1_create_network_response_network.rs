...
/// ScalewayIotV1CreateNetworkResponseNetwork : Created network



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayIotV1CreateNetworkResponseNetwork {
    /// Network ID
...
impl ScalewayIotV1CreateNetworkResponseNetwork {
    /// Created network
    pub fn new() -> ScalewayIotV1CreateNetworkResponseNetwork {
