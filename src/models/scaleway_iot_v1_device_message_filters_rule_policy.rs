...
pub enum ScalewayIotV1DeviceMessageFiltersRulePolicy {
...
impl ToString for ScalewayIotV1DeviceMessageFiltersRulePolicy {
...
impl Default for ScalewayIotV1DeviceMessageFiltersRulePolicy {
    fn default() -> ScalewayIotV1DeviceMessageFiltersRulePolicy {
        Self::Unknown
    }
}
