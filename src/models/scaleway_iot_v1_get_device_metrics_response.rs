...
pub struct ScalewayIotV1GetDeviceMetricsResponse {
    /// Metrics for a device over the requested period
    #[serde(rename = "metrics", skip_serializing_if = "Option::is_none")]
    pub metrics: Option<Vec<crate::models::ScalewayStdTimeSeries>>,
}

impl ScalewayIotV1GetDeviceMetricsResponse {
    pub fn new() -> ScalewayIotV1GetDeviceMetricsResponse {
        ScalewayIotV1GetDeviceMetricsResponse { metrics: None }
    }
}
