...
pub struct ScalewayIotV1GetHubCaResponse {
    #[serde(rename = "ca_cert_pem", skip_serializing_if = "Option::is_none")]
    pub ca_cert_pem: Option<String>,
}

impl ScalewayIotV1GetHubCaResponse {
    pub fn new() -> ScalewayIotV1GetHubCaResponse {
        ScalewayIotV1GetHubCaResponse { ca_cert_pem: None }
    }
}
