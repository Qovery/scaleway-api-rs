...
pub struct ScalewayIotV1GetHubMetricsResponse {
    /// Metrics for a hub over the requested period
    #[serde(rename = "metrics", skip_serializing_if = "Option::is_none")]
    pub metrics: Option<Vec<crate::models::ScalewayStdTimeSeries>>,
}

impl ScalewayIotV1GetHubMetricsResponse {
    pub fn new() -> ScalewayIotV1GetHubMetricsResponse {
        ScalewayIotV1GetHubMetricsResponse { metrics: None }
    }
}
