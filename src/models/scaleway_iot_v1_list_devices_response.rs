...
pub struct ScalewayIotV1ListDevicesResponse {
    /// Total number of devices
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
    /// A page of devices
    #[serde(rename = "devices", skip_serializing_if = "Option::is_none")]
    pub devices: Option<Vec<crate::models::ScalewayIotV1Device>>,
}

impl ScalewayIotV1ListDevicesResponse {
    pub fn new() -> ScalewayIotV1ListDevicesResponse {
