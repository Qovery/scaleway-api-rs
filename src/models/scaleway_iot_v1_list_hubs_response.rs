...
pub struct ScalewayIotV1ListHubsResponse {
    /// Total number of hubs
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
    /// A page of hubs
    #[serde(rename = "hubs", skip_serializing_if = "Option::is_none")]
    pub hubs: Option<Vec<crate::models::ScalewayIotV1Hub>>,
}

impl ScalewayIotV1ListHubsResponse {
    pub fn new() -> ScalewayIotV1ListHubsResponse {
