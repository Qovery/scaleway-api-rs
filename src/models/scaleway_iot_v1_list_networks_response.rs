...
pub struct ScalewayIotV1ListNetworksResponse {
    /// Total number of Networks
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
    /// A page of networks
    #[serde(rename = "networks", skip_serializing_if = "Option::is_none")]
    pub networks: Option<Vec<crate::models::ScalewayIotV1Network>>,
}

impl ScalewayIotV1ListNetworksResponse {
    pub fn new() -> ScalewayIotV1ListNetworksResponse {
