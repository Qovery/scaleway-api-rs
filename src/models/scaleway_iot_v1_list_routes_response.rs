...
pub struct ScalewayIotV1ListRoutesResponse {
    /// Total number of routes
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
    /// A page of routes
    #[serde(rename = "routes", skip_serializing_if = "Option::is_none")]
    pub routes: Option<Vec<crate::models::ScalewayIotV1RouteSummary>>,
}

impl ScalewayIotV1ListRoutesResponse {
    pub fn new() -> ScalewayIotV1ListRoutesResponse {
