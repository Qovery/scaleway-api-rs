...
pub struct ScalewayIotV1ListTwinDocumentsResponse {
    /// Twin's document list
    #[serde(rename = "documents", skip_serializing_if = "Option::is_none")]
    pub documents:
        Option<Vec<crate::models::ScalewayIotV1ListTwinDocumentsResponseDocumentSummary>>,
}

impl ScalewayIotV1ListTwinDocumentsResponse {
    pub fn new() -> ScalewayIotV1ListTwinDocumentsResponse {
        ScalewayIotV1ListTwinDocumentsResponse { documents: None }
    }
}
