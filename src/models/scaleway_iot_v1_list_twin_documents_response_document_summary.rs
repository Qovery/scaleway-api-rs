...
pub struct ScalewayIotV1ListTwinDocumentsResponseDocumentSummary {
    /// Document's name
    #[serde(rename = "document_name", skip_serializing_if = "Option::is_none")]
    pub document_name: Option<String>,
}

impl ScalewayIotV1ListTwinDocumentsResponseDocumentSummary {
    pub fn new() -> ScalewayIotV1ListTwinDocumentsResponseDocumentSummary {
        ScalewayIotV1ListTwinDocumentsResponseDocumentSummary {
            document_name: None,
        }
    }
}
