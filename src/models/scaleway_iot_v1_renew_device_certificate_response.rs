...
pub struct ScalewayIotV1RenewDeviceCertificateResponse {
    #[serde(rename = "device", skip_serializing_if = "Option::is_none")]
    pub device: Option<Box<crate::models::ScalewayIotV1CreateDeviceResponseDevice>>,
    #[serde(rename = "certificate", skip_serializing_if = "Option::is_none")]
    pub certificate: Option<Box<crate::models::ScalewayIotV1CreateDeviceResponseCertificate>>,
}

impl ScalewayIotV1RenewDeviceCertificateResponse {
    pub fn new() -> ScalewayIotV1RenewDeviceCertificateResponse {
