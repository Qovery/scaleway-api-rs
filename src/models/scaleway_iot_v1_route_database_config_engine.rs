...
pub enum ScalewayIotV1RouteDatabaseConfigEngine {
...
impl ToString for ScalewayIotV1RouteDatabaseConfigEngine {
...
impl Default for ScalewayIotV1RouteDatabaseConfigEngine {
    fn default() -> ScalewayIotV1RouteDatabaseConfigEngine {
        Self::Unknown
    }
}
