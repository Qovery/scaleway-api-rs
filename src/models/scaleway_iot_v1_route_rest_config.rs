...
/// ScalewayIotV1RouteRestConfig : When using Rest Route, Rest-specific configuration fields

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct ScalewayIotV1RouteRestConfig {
    ...
    pub headers: Option<crate::models::ScalewayIotV1RouteRestConfigHeaders>,
}

impl ScalewayIotV1RouteRestConfig {
    /// When using Rest Route, Rest-specific configuration fields
    pub fn new() -> ScalewayIotV1RouteRestConfig {
