...
/// ScalewayIotV1RouteRestConfigHeaders : HTTP call extra headers

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct ScalewayIotV1RouteRestConfigHeaders {
    #[serde(rename = "<headerKey>", skip_serializing_if = "Option::is_none")]
    pub header_key: Option<String>,
}

impl ScalewayIotV1RouteRestConfigHeaders {
    /// HTTP call extra headers
    pub fn new() -> ScalewayIotV1RouteRestConfigHeaders {
        ScalewayIotV1RouteRestConfigHeaders { header_key: None }
    }
}
