...
pub enum ScalewayIotV1RouteS3ConfigS3Strategy {
...
impl ToString for ScalewayIotV1RouteS3ConfigS3Strategy {
    fn to_string(&self) -> String {
        match self {
            Self::Unknown => String::from("unknown"),
            Self::PerTopic => String::from("per_topic"),
            Self::PerMessage => String::from("per_message"),
        }
    }
}

impl Default for ScalewayIotV1RouteS3ConfigS3Strategy {
    fn default() -> ScalewayIotV1RouteS3ConfigS3Strategy {
        Self::Unknown
    }
}
