...
pub struct ScalewayIotV1SetDeviceCertificateResponse {
    #[serde(rename = "device", skip_serializing_if = "Option::is_none")]
    pub device: Option<Box<crate::models::ScalewayIotV1Device>>,
    #[serde(rename = "certificate_pem", skip_serializing_if = "Option::is_none")]
    pub certificate_pem: Option<String>,
}

impl ScalewayIotV1SetDeviceCertificateResponse {
    pub fn new() -> ScalewayIotV1SetDeviceCertificateResponse {
        ScalewayIotV1SetDeviceCertificateResponse {
            device: None,
