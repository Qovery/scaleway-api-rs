...
pub struct ScalewayIotV1TwinDocument {
    ...
    pub data: Option<Box<crate::models::ScalewayIotV1TwinDocumentData>>,
}

impl ScalewayIotV1TwinDocument {
    pub fn new() -> ScalewayIotV1TwinDocument {
