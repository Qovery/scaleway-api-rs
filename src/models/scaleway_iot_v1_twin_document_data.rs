...
/// ScalewayIotV1TwinDocumentData : Document's new data

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ScalewayIotV1TwinDocumentData {
    #[serde(rename = "fields", skip_serializing_if = "Option::is_none")]
    pub fields: Option<crate::models::PutTwinDocumentRequestDataFields>,
}

impl ScalewayIotV1TwinDocumentData {
    /// Document's new data
    pub fn new() -> ScalewayIotV1TwinDocumentData {
        ScalewayIotV1TwinDocumentData { fields: None }
    }
}
