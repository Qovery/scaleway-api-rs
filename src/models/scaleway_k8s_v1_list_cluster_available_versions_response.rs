...
pub struct ScalewayK8sV1ListClusterAvailableVersionsResponse {
    /// The available Kubernetes version for the cluster
    #[serde(rename = "versions", skip_serializing_if = "Option::is_none")]
    pub versions: Option<Vec<crate::models::ScalewayK8sV1Version>>,
}

impl ScalewayK8sV1ListClusterAvailableVersionsResponse {
    pub fn new() -> ScalewayK8sV1ListClusterAvailableVersionsResponse {
        ScalewayK8sV1ListClusterAvailableVersionsResponse { versions: None }
    }
}
