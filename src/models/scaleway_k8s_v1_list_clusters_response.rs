...
pub struct ScalewayK8sV1ListClustersResponse {
    ...
    pub clusters: Option<Vec<crate::models::ScalewayK8sV1Cluster>>,
}

impl ScalewayK8sV1ListClustersResponse {
    pub fn new() -> ScalewayK8sV1ListClustersResponse {
