...
pub struct ScalewayK8sV1ListPoolsResponse {
    ...
    pub pools: Option<Vec<crate::models::ScalewayK8sV1Pool>>,
}

impl ScalewayK8sV1ListPoolsResponse {
    pub fn new() -> ScalewayK8sV1ListPoolsResponse {
