...
pub struct ScalewayK8sV1ListVersionsResponse {
...
impl ScalewayK8sV1ListVersionsResponse {
    pub fn new() -> ScalewayK8sV1ListVersionsResponse {
        ScalewayK8sV1ListVersionsResponse { versions: None }
    }
}
