...
pub struct ScalewayK8sV1Version {
    ...
    #[serde(rename = "available_ingresses", skip_serializing_if = "Option::is_none")]
    pub available_ingresses: Option<Vec<crate::models::ScalewayK8sV1Ingress>>,
    /// The supported container runtimes for this version
    #[serde(rename = "available_container_runtimes", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "available_feature_gates", skip_serializing_if = "Option::is_none")]
    pub available_feature_gates: Option<Vec<String>>,
    /// The supported admission plugins for this version
    #[serde(rename = "available_admission_plugins", skip_serializing_if = "Option::is_none")]
    pub available_admission_plugins: Option<Vec<String>>,
    /// The supported kubelet arguments for this version
    #[serde(rename = "available_kubelet_args", skip_serializing_if = "Option::is_none")]
