...
pub struct ScalewayLbV1Acl {
    ...
    pub _match: Option<Box<crate::models::LbV1RegionsRegionAclsAclIdMatch>>,
    #[serde(rename = "action", skip_serializing_if = "Option::is_none")]
    pub action: Option<Box<crate::models::LbV1RegionsRegionAclsAclIdAction>>,
    #[serde(rename = "frontend", skip_serializing_if = "Option::is_none")]
    pub frontend: Option<Box<crate::models::ScalewayLbV1AclFrontend>>,
...
impl ScalewayLbV1Acl {
    pub fn new() -> ScalewayLbV1Acl {
        ScalewayLbV1Acl {
            id: None,
            name: None,
            _match: None,
