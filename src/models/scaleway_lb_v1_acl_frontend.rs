...
/// ScalewayLbV1AclFrontend : See the Frontend object description



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayLbV1AclFrontend {
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "inbound_port", skip_serializing_if = "Option::is_none")]
    pub inbound_port: Option<f32>,
    #[serde(rename = "backend", skip_serializing_if = "Option::is_none")]
    pub backend: Option<Box<crate::models::ScalewayLbV1Backend>>,
    ...
    pub certificate: Option<Box<crate::models::ScalewayLbV1Certificate>>,
...
impl ScalewayLbV1AclFrontend {
    /// See the Frontend object description
    pub fn new() -> ScalewayLbV1AclFrontend {
        ScalewayLbV1AclFrontend {
            id: None,
            name: None,
            inbound_port: None,
            backend: None,
