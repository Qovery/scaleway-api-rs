...
pub struct ScalewayLbV1Certificate {
    ...
    #[serde(rename = "subject_alternative_name", skip_serializing_if = "Option::is_none")]
    pub subject_alternative_name: Option<Vec<String>>,
    /// Identifier (SHA-1) of the certificate
    #[serde(rename = "fingerprint", skip_serializing_if = "Option::is_none")]
    pub fingerprint: Option<String>,
    /// Validity bounds
    #[serde(rename = "not_valid_before", skip_serializing_if = "Option::is_none")]
    pub not_valid_before: Option<String>,
    /// Validity bounds
    #[serde(rename = "not_valid_after", skip_serializing_if = "Option::is_none")]
    pub not_valid_after: Option<String>,
    /// Status of certificate
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Status>,
    #[serde(rename = "lb", skip_serializing_if = "Option::is_none")]
    pub lb: Option<Box<crate::models::ScalewayLbV1CertificateLb>>,
    /// Certificate name
...
impl ScalewayLbV1Certificate {
    pub fn new() -> ScalewayLbV1Certificate {
