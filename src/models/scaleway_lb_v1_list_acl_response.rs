...
pub struct ScalewayLbV1ListAclResponse {
    /// List of Acl object (see Acl object description)
    #[serde(rename = "acls", skip_serializing_if = "Option::is_none")]
    pub acls: Option<Vec<crate::models::ScalewayLbV1Acl>>,
    /// The total number of items
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListAclResponse {
    pub fn new() -> ScalewayLbV1ListAclResponse {
        ScalewayLbV1ListAclResponse {
            acls: None,
            total_count: None,
        }
    }
