...
pub struct ScalewayLbV1ListBackendStatsResponse {
    /// List backend stats object of your loadbalancer
    #[serde(rename = "backend_servers_stats", skip_serializing_if = "Option::is_none")]
    pub backend_servers_stats: Option<Vec<crate::models::ScalewayLbV1BackendServerStats>>,
    /// The total number of items
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListBackendStatsResponse {
    pub fn new() -> ScalewayLbV1ListBackendStatsResponse {
        ScalewayLbV1ListBackendStatsResponse {
            backend_servers_stats: None,
            total_count: None,
        }
    }
}
