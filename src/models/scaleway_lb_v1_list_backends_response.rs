...
pub struct ScalewayLbV1ListBackendsResponse {
    /// List Backend objects of a load balancer
    #[serde(rename = "backends", skip_serializing_if = "Option::is_none")]
    pub backends: Option<Vec<crate::models::ScalewayLbV1Backend>>,
    /// Total count, wihtout pagination
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListBackendsResponse {
    pub fn new() -> ScalewayLbV1ListBackendsResponse {
        ScalewayLbV1ListBackendsResponse {
            backends: None,
            total_count: None,
        }
    }
