...
pub struct ScalewayLbV1ListCertificatesResponse {
    #[serde(rename = "certificates", skip_serializing_if = "Option::is_none")]
    pub certificates: Option<Vec<crate::models::ScalewayLbV1Certificate>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListCertificatesResponse {
    pub fn new() -> ScalewayLbV1ListCertificatesResponse {
        ScalewayLbV1ListCertificatesResponse {
            certificates: None,
            total_count: None,
        }
    }
