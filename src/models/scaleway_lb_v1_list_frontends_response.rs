...
pub struct ScalewayLbV1ListFrontendsResponse {
    /// List frontends object of your loadbalancer
    #[serde(rename = "frontends", skip_serializing_if = "Option::is_none")]
    pub frontends: Option<Vec<crate::models::ScalewayLbV1Frontend>>,
    /// Total count, wihtout pagination
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListFrontendsResponse {
    pub fn new() -> ScalewayLbV1ListFrontendsResponse {
        ScalewayLbV1ListFrontendsResponse {
            frontends: None,
            total_count: None,
        }
    }
