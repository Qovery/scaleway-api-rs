...
pub struct ScalewayLbV1ListIpsResponse {
    /// List IP address object
    #[serde(rename = "ips", skip_serializing_if = "Option::is_none")]
    pub ips: Option<Vec<crate::models::ScalewayLbV1Ip>>,
    /// Total count, wihtout pagination
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListIpsResponse {
    pub fn new() -> ScalewayLbV1ListIpsResponse {
        ScalewayLbV1ListIpsResponse {
            ips: None,
            total_count: None,
        }
    }
