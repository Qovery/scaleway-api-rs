...
pub struct ScalewayLbV1ListLbPrivateNetworksResponse {
    #[serde(rename = "private_network", skip_serializing_if = "Option::is_none")]
    pub private_network: Option<Vec<crate::models::ScalewayLbV1PrivateNetwork>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListLbPrivateNetworksResponse {
    pub fn new() -> ScalewayLbV1ListLbPrivateNetworksResponse {
        ScalewayLbV1ListLbPrivateNetworksResponse {
