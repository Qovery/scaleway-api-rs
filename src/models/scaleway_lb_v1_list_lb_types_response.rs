...
pub struct ScalewayLbV1ListLbTypesResponse {
    #[serde(rename = "lb_types", skip_serializing_if = "Option::is_none")]
    pub lb_types: Option<Vec<crate::models::ScalewayLbV1LbType>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListLbTypesResponse {
    pub fn new() -> ScalewayLbV1ListLbTypesResponse {
        ScalewayLbV1ListLbTypesResponse {
            lb_types: None,
            total_count: None,
        }
    }
