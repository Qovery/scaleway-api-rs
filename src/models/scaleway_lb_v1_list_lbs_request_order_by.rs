...
pub enum ScalewayLbV1ListLbsRequestOrderBy {
...
impl ToString for ScalewayLbV1ListLbsRequestOrderBy {
    fn to_string(&self) -> String {
        match self {
            Self::CreatedAtAsc => String::from("created_at_asc"),
            Self::CreatedAtDesc => String::from("created_at_desc"),
            Self::NameAsc => String::from("name_asc"),
            Self::NameDesc => String::from("name_desc"),
        }
    }
}
