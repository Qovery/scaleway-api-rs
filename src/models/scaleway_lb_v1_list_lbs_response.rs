...
pub struct ScalewayLbV1ListLbsResponse {
    #[serde(rename = "lbs", skip_serializing_if = "Option::is_none")]
    pub lbs: Option<Vec<crate::models::ScalewayLbV1Lb>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListLbsResponse {
    pub fn new() -> ScalewayLbV1ListLbsResponse {
        ScalewayLbV1ListLbsResponse {
            lbs: None,
            total_count: None,
        }
    }
