...
pub enum ScalewayLbV1ListPrivateNetworksRequestOrderBy {
...
impl ToString for ScalewayLbV1ListPrivateNetworksRequestOrderBy {
    fn to_string(&self) -> String {
        match self {
            Self::Asc => String::from("created_at_asc"),
            Self::Desc => String::from("created_at_desc"),
        }
    }
}
