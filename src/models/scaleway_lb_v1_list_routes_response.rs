...
pub struct ScalewayLbV1ListRoutesResponse {
    /// List of Routes object
    #[serde(rename = "routes", skip_serializing_if = "Option::is_none")]
    pub routes: Option<Vec<crate::models::ScalewayLbV1Route>>,
    /// The total number of items
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListRoutesResponse {
    pub fn new() -> ScalewayLbV1ListRoutesResponse {
        ScalewayLbV1ListRoutesResponse {
            routes: None,
            total_count: None,
        }
    }
