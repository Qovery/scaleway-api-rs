...
pub struct ScalewayLbV1ListSubscriberResponse {
    /// List of Subscribers object
    #[serde(rename = "subscribers", skip_serializing_if = "Option::is_none")]
    pub subscribers: Option<Vec<crate::models::ScalewayLbV1Subscriber>>,
    /// The total number of items
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayLbV1ListSubscriberResponse {
    pub fn new() -> ScalewayLbV1ListSubscriberResponse {
        ScalewayLbV1ListSubscriberResponse {
            subscribers: None,
            total_count: None,
        }
    }
