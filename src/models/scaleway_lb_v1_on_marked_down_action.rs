...
pub enum ScalewayLbV1OnMarkedDownAction {
...
impl ToString for ScalewayLbV1OnMarkedDownAction {
    fn to_string(&self) -> String {
        match self {
            Self::OnMarkedDownActionNone => String::from("on_marked_down_action_none"),
            Self::ShutdownSessions => String::from("shutdown_sessions"),
        }
    }
}
