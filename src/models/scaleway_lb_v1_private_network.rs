...
pub struct ScalewayLbV1PrivateNetwork {
    #[serde(rename = "lb", skip_serializing_if = "Option::is_none")]
    pub lb: Option<Box<crate::models::ScalewayLbV1PrivateNetworkLb>>,
    #[serde(rename = "static_config", skip_serializing_if = "Option::is_none")]
    pub static_config: Option<Box<crate::models::ScalewayLbV1PrivateNetworkStaticConfig>>,
    /// Value set to true if load balancer instance use a DHCP
    #[serde(rename = "dhcp_config", skip_serializing_if = "Option::is_none")]
    pub dhcp_config: Option<serde_json::Value>,
...
impl ScalewayLbV1PrivateNetwork {
    pub fn new() -> ScalewayLbV1PrivateNetwork {
