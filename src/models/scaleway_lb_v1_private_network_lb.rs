...
/// ScalewayLbV1PrivateNetworkLb : LoadBalancer object



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayLbV1PrivateNetworkLb {
    ...
    pub status: Option<crate::models::ScalewayLbV1LbStatus>,
    #[serde(rename = "instances", skip_serializing_if = "Option::is_none")]
    pub instances: Option<Vec<crate::models::ScalewayLbV1Instance>>,
    #[serde(rename = "organization_id", skip_serializing_if = "Option::is_none")]
    pub organization_id: Option<String>,
    #[serde(rename = "ip", skip_serializing_if = "Option::is_none")]
    pub ip: Option<Vec<crate::models::ScalewayLbV1Ip>>,
    #[serde(rename = "tags", skip_serializing_if = "Option::is_none")]
    pub tags: Option<Vec<String>>,
    #[serde(rename = "frontend_count", skip_serializing_if = "Option::is_none")]
    pub frontend_count: Option<f32>,
    #[serde(rename = "backend_count", skip_serializing_if = "Option::is_none")]
    pub backend_count: Option<f32>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub _type: Option<String>,
    #[serde(rename = "subscriber", skip_serializing_if = "Option::is_none")]
    pub subscriber: Option<Box<crate::models::ScalewayLbV1Subscriber>>,
    #[serde(rename = "ssl_compatibility_level", skip_serializing_if = "Option::is_none")]
    pub ssl_compatibility_level: Option<crate::models::ScalewayLbV1SslCompatibilityLevel>,
    ...
    #[serde(rename = "private_network_count", skip_serializing_if = "Option::is_none")]
    pub private_network_count: Option<f32>,
    #[serde(rename = "route_count", skip_serializing_if = "Option::is_none")]
    pub route_count: Option<f32>,
...
impl ScalewayLbV1PrivateNetworkLb {
    /// LoadBalancer object
    pub fn new() -> ScalewayLbV1PrivateNetworkLb {
        ScalewayLbV1PrivateNetworkLb {
            id: None,
            name: None,
            description: None,
            status: None,
