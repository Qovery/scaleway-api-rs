...
/// ScalewayLbV1PrivateNetworkStaticConfig : Local ip address of load balancer instance



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayLbV1PrivateNetworkStaticConfig {
    #[serde(rename = "ip_address", skip_serializing_if = "Option::is_none")]
    pub ip_address: Option<Vec<String>>,
}

impl ScalewayLbV1PrivateNetworkStaticConfig {
    /// Local ip address of load balancer instance
    pub fn new() -> ScalewayLbV1PrivateNetworkStaticConfig {
        ScalewayLbV1PrivateNetworkStaticConfig {
            ip_address: None,
        }
    }
}
