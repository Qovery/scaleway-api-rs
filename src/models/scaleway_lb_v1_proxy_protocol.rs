...
pub enum ScalewayLbV1ProxyProtocol {
...
impl ToString for ScalewayLbV1ProxyProtocol {
    fn to_string(&self) -> String {
        match self {
            Self::Unknown => String::from("proxy_protocol_unknown"),
            Self::None => String::from("proxy_protocol_none"),
            Self::V1 => String::from("proxy_protocol_v1"),
            Self::V2 => String::from("proxy_protocol_v2"),
            Self::V2Ssl => String::from("proxy_protocol_v2_ssl"),
            Self::V2SslCn => String::from("proxy_protocol_v2_ssl_cn"),
        }
    }
}
