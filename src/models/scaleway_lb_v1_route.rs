...
pub struct ScalewayLbV1Route {
    /// Id of match ressource
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    /// Id of frontend
    #[serde(rename = "frontend_id", skip_serializing_if = "Option::is_none")]
    pub frontend_id: Option<String>,
    /// Id of backend
    #[serde(rename = "backend_id", skip_serializing_if = "Option::is_none")]
    pub backend_id: Option<String>,
    #[serde(rename = "match", skip_serializing_if = "Option::is_none")]
    pub _match: Option<Box<crate::models::LbV1RegionsRegionRoutesMatch>>,
...
impl ScalewayLbV1Route {
    pub fn new() -> ScalewayLbV1Route {
        ScalewayLbV1Route {
            id: None,
            frontend_id: None,
            backend_id: None,
