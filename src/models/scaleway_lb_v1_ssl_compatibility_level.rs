...
pub enum ScalewayLbV1SslCompatibilityLevel {
...
impl ToString for ScalewayLbV1SslCompatibilityLevel {
    fn to_string(&self) -> String {
        match self {
            Self::Unknown => String::from("ssl_compatibility_level_unknown"),
            Self::Intermediate => String::from("ssl_compatibility_level_intermediate"),
            Self::Modern => String::from("ssl_compatibility_level_modern"),
            Self::Old => String::from("ssl_compatibility_level_old"),
        }
    }
}
