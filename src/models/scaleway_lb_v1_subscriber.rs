...
pub struct ScalewayLbV1Subscriber {
    /// Subscriber ID
    ...
    pub email_config: Option<Box<crate::models::ScalewayLbV1SubscriberEmailConfig>>,
    #[serde(rename = "webhook_config", skip_serializing_if = "Option::is_none")]
    pub webhook_config: Option<Box<crate::models::ScalewayLbV1SubscriberWebhookConfig>>,
}

impl ScalewayLbV1Subscriber {
    pub fn new() -> ScalewayLbV1Subscriber {
        ScalewayLbV1Subscriber {
            id: None,
            name: None,
            email_config: None,
            webhook_config: None,
