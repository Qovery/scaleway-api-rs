...
/// ScalewayLbV1SubscriberEmailConfig : Email address of subscriber



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayLbV1SubscriberEmailConfig {
    /// Email who receive alert
    #[serde(rename = "email")]
    pub email: String,
}

impl ScalewayLbV1SubscriberEmailConfig {
    /// Email address of subscriber
    pub fn new(email: String) -> ScalewayLbV1SubscriberEmailConfig {
