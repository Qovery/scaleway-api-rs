...
/// ScalewayLbV1SubscriberWebhookConfig : WebHook URI of subscriber



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScalewayLbV1SubscriberWebhookConfig {
    /// URI who receive POST request
    #[serde(rename = "uri")]
    pub uri: String,
}

impl ScalewayLbV1SubscriberWebhookConfig {
    /// WebHook URI of subscriber
    pub fn new(uri: String) -> ScalewayLbV1SubscriberWebhookConfig {
        ScalewayLbV1SubscriberWebhookConfig {
            uri,
        }
    }
}
