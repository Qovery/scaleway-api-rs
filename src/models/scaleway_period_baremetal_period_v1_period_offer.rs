...
pub struct ScalewayPeriodBaremetalPeriodV1PeriodOffer {
    ...
    pub price_per_hour: Option<Box<models::ScalewayBaremetalV1OfferPricePerHour>>,
    #[serde(rename = "price_per_month", skip_serializing_if = "Option::is_none")]
    pub price_per_month: Option<Box<models::ScalewayBaremetalV1OfferPricePerMonth>>,
    /// Disks specifications of the offer.
    #[serde(rename = "disks", skip_serializing_if = "Option::is_none")]
    pub disks: Option<Vec<models::ScalewayPeriodBaremetalPeriodV1PeriodDisk>>,
    ...
    pub cpus: Option<Vec<models::ScalewayPeriodBaremetalPeriodV1PeriodCpu>>,
    /// Memory specifications of the offer.
    #[serde(rename = "memories", skip_serializing_if = "Option::is_none")]
    pub memories: Option<Vec<models::ScalewayPeriodBaremetalPeriodV1PeriodMemory>>,
    ...
    pub persistent_memories:
        Option<Vec<models::ScalewayPeriodBaremetalPeriodV1PeriodPersistentMemory>>,
    /// Raid controller specifications of the offer.
    #[serde(rename = "raid_controllers", skip_serializing_if = "Option::is_none")]
    pub raid_controllers: Option<Vec<models::ScalewayPeriodBaremetalPeriodV1PeriodRaidController>>,
    ...
    pub fee: Option<Box<models::ScalewayBaremetalV1OfferFee>>,
    ...
    pub gpus: Option<Vec<models::ScalewayPeriodBaremetalPeriodV1PeriodGpu>>,
    /// Exist only for hourly offers, to migrate to the monthly offer.
    #[serde(
        rename = "monthly_offer_id",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub monthly_offer_id: Option<Option<String>>,
}
...
impl ScalewayPeriodBaremetalPeriodV1PeriodOffer {
    pub fn new() -> ScalewayPeriodBaremetalPeriodV1PeriodOffer {
        ScalewayPeriodBaremetalPeriodV1PeriodOffer {
            ...
            fee: None,
            options: None,
            private_bandwidth: None,
            shared_bandwidth: None,
            tags: None,
            gpus: None,
            monthly_offer_id: None,
        }
    }
}
/// Stock level.
