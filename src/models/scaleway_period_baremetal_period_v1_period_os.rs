...
pub struct ScalewayPeriodBaremetalPeriodV1PeriodOs {
    ...
    pub ssh: Option<Box<models::ScalewayBaremetalV1OsSsh>>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<Box<models::ScalewayBaremetalV1OsUser>>,
    #[serde(rename = "password", skip_serializing_if = "Option::is_none")]
    pub password: Option<Box<models::ScalewayBaremetalV1OsPassword>>,
    #[serde(rename = "service_user", skip_serializing_if = "Option::is_none")]
    pub service_user: Option<Box<models::ScalewayBaremetalV1OsServiceUser>>,
    #[serde(rename = "service_password", skip_serializing_if = "Option::is_none")]
    pub service_password: Option<Box<models::ScalewayBaremetalV1OsServicePassword>>,
    ...
    #[serde(
        rename = "custom_partitioning_supported",
        skip_serializing_if = "Option::is_none"
    )]
    pub custom_partitioning_supported: Option<bool>,
}
...
impl ScalewayPeriodBaremetalPeriodV1PeriodOs {
    pub fn new() -> ScalewayPeriodBaremetalPeriodV1PeriodOs {
        ScalewayPeriodBaremetalPeriodV1PeriodOs {
            ...
            allowed: None,
            custom_partitioning_supported: None,
        }
    }
}
