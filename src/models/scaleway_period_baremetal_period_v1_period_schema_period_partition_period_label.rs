...
pub enum ScalewayPeriodBaremetalPeriodV1PeriodSchemaPeriodPartitionPeriodLabel {
    #[serde(rename = "unknown_partition_label")]
...
impl std::fmt::Display for ScalewayPeriodBaremetalPeriodV1PeriodSchemaPeriodPartitionPeriodLabel {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::UnknownPartitionLabel => write!(f, "unknown_partition_label"),
...
impl Default for ScalewayPeriodBaremetalPeriodV1PeriodSchemaPeriodPartitionPeriodLabel {
    fn default() -> ScalewayPeriodBaremetalPeriodV1PeriodSchemaPeriodPartitionPeriodLabel {
        Self::UnknownPartitionLabel
    }
}
