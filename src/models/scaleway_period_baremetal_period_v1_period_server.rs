...
pub struct ScalewayPeriodBaremetalPeriodV1PeriodServer {
    ...
    pub ips: Option<Vec<models::ScalewayPeriodBaremetalPeriodV1PeriodIp>>,
    ...
    pub install: Option<Box<models::ScalewayBaremetalV1ServerInstall>>,
    ...
    pub options: Option<Vec<models::ScalewayPeriodBaremetalPeriodV1PeriodServerPeriodOption>>,
    #[serde(rename = "rescue_server", skip_serializing_if = "Option::is_none")]
    pub rescue_server: Option<Box<models::ScalewayBaremetalV1ServerRescueServer>>,
}
