...
pub struct ScalewayPeriodDomainPeriodV2beta1PeriodDnsZone {
    ...
    pub status: Option<models::ScalewayPeriodDomainPeriodV2beta1PeriodDnsZonePeriodStatus>,
    #[serde(
        rename = "message",
        default,
    ...
    #[serde(rename = "linked_products", skip_serializing_if = "Option::is_none")]
    pub linked_products: Option<Vec<models::ScalewayPeriodDomainPeriodV2beta1PeriodLinkedProduct>>,
}
