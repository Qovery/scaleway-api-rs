...
pub struct ScalewayPeriodDomainPeriodV2beta1PeriodRecord {
    ...
    #[serde(
        rename = "geo_ip_config",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub geo_ip_config: Option<Option<Box<models::ScalewayDomainV2beta1RecordGeoIpConfig>>>,
    #[serde(
    ...
    pub http_service_config:
        Option<Option<Box<models::ScalewayDomainV2beta1RecordHttpServiceConfig>>>,
    #[serde(
        rename = "weighted_config",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub weighted_config: Option<Option<Box<models::ScalewayDomainV2beta1RecordWeightedConfig>>>,
    #[serde(
        rename = "view_config",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub view_config: Option<Option<Box<models::ScalewayDomainV2beta1RecordViewConfig>>>,
