...
pub struct ScalewayPeriodDomainPeriodV2beta1PeriodRecordChange {
    ...
    pub add: Option<Option<Box<models::ScalewayDomainV2beta1RecordChangeAdd>>>,
    #[serde(
        rename = "set",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub set: Option<Option<Box<models::ScalewayDomainV2beta1RecordChangeSet>>>,
    #[serde(
        rename = "delete",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub delete: Option<Option<Box<models::ScalewayDomainV2beta1RecordChangeDelete>>>,
    #[serde(
        rename = "clear",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub clear: Option<Option<serde_json::Value>>,
}
