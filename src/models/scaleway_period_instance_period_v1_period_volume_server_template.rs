...
pub struct ScalewayPeriodInstancePeriodV1PeriodVolumeServerTemplate {
    /// UUID of the volume
...
impl ScalewayPeriodInstancePeriodV1PeriodVolumeServerTemplate {
    pub fn new() -> ScalewayPeriodInstancePeriodV1PeriodVolumeServerTemplate {
