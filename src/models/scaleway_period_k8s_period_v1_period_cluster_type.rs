...
pub struct ScalewayPeriodK8sPeriodV1PeriodClusterType {
    /// Cluster type name.
    ...
    pub commitment_delay: Option<Option<String>>,
    ...
    #[serde(rename = "resiliency", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(
        rename = "audit_logs_supported",
        skip_serializing_if = "Option::is_none"
    )]
    pub audit_logs_supported: Option<bool>,
}

impl ScalewayPeriodK8sPeriodV1PeriodClusterType {
    pub fn new() -> ScalewayPeriodK8sPeriodV1PeriodClusterType {
        ScalewayPeriodK8sPeriodV1PeriodClusterType {
            name: None,
            availability: None,
            max_nodes: None,
            commitment_delay: None,
            sla: None,
            resiliency: None,
            memory: None,
            dedicated: None,
            audit_logs_supported: None,
        }
    }
}
/// Cluster type availability.
...
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum Resiliency {
    #[serde(rename = "unknown_resiliency")]
    UnknownResiliency,
...
impl Default for Resiliency {
    fn default() -> Resiliency {
        Self::UnknownResiliency
    }
}
