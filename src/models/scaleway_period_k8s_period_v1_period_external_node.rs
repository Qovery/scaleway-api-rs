...
pub struct ScalewayPeriodK8sPeriodV1PeriodExternalNode {
    ...
    #[serde(rename = "pool_version", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "containerd_version", skip_serializing_if = "Option::is_none")]
    pub containerd_version: Option<String>,
    #[serde(rename = "runc_version", skip_serializing_if = "Option::is_none")]
    pub runc_version: Option<String>,
    #[serde(
        rename = "cni_plugins_version",
        skip_serializing_if = "Option::is_none"
    )]
    pub cni_plugins_version: Option<String>,
    #[serde(rename = "node_labels", skip_serializing_if = "Option::is_none")]
    pub node_labels: Option<models::ScalewayK8sV1ExternalNodeNodeLabels>,
    #[serde(rename = "node_taints", skip_serializing_if = "Option::is_none")]
    pub node_taints:
        Option<Vec<models::ScalewayPeriodK8sPeriodV1PeriodExternalNodePeriodCoreV1Taint>>,
    #[serde(rename = "iam_token", skip_serializing_if = "Option::is_none")]
