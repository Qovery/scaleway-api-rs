...
pub struct ScalewayPeriodK8sPeriodV1PeriodVersion {
    ...
    pub available_cnis: Option<Vec<models::ScalewayPeriodK8sPeriodV1PeriodCni>>,
    /// Supported container runtimes for this version.
    #[serde(
        rename = "available_container_runtimes",
        skip_serializing_if = "Option::is_none"
    )]
    pub available_container_runtimes: Option<Vec<models::ScalewayPeriodK8sPeriodV1PeriodRuntime>>,
    ...
    pub available_kubelet_args: Option<models::ScalewayK8sV1VersionAvailableKubeletArgs>,
}
