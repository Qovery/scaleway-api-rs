...
pub struct ScalewayPeriodRdbPeriodV1PeriodEndpoint {
    ...
    pub private_network: Option<Option<Box<models::ScalewayRdbV1EndpointPrivateNetwork>>>,
    ...
    pub load_balancer: Option<Option<serde_json::Value>>,
    /// Direct access details. Public endpoint reserved for Read Replicas. One per Read Replica.
    #[serde(
        rename = "direct_access",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub direct_access: Option<Option<serde_json::Value>>,
