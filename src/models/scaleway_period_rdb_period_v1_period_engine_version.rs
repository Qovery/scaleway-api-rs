...
pub struct ScalewayPeriodRdbPeriodV1PeriodEngineVersion {
    ...
    pub available_settings: Option<Vec<models::ScalewayPeriodRdbPeriodV1PeriodEngineSetting>>,
    ...
    pub available_init_settings: Option<Vec<models::ScalewayPeriodRdbPeriodV1PeriodEngineSetting>>,
}
