...
pub struct ScalewayPeriodRdbPeriodV1PeriodInstance {
    ...
    pub volume: Option<Box<models::ScalewayRdbV1InstanceVolume>>,
    ...
    pub upgradable_version: Option<Vec<models::ScalewayPeriodRdbPeriodV1PeriodUpgradableVersion>>,
    #[serde(rename = "endpoint", skip_serializing_if = "Option::is_none")]
    pub endpoint: Option<Box<models::ScalewayRdbV1InstanceEndpoint>>,
    /// List of tags applied to the Database Instance.
    #[serde(rename = "tags", skip_serializing_if = "Option::is_none")]
    pub tags: Option<Vec<String>>,
    /// Advanced settings of the Database Instance.
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    pub settings: Option<Vec<models::ScalewayPeriodRdbPeriodV1PeriodInstanceSetting>>,
    #[serde(rename = "backup_schedule", skip_serializing_if = "Option::is_none")]
    pub backup_schedule: Option<Box<models::ScalewayRdbV1InstanceBackupSchedule>>,
    ...
    pub read_replicas: Option<Vec<models::ScalewayPeriodRdbPeriodV1PeriodReadReplica>>,
    ...
    pub init_settings: Option<Vec<models::ScalewayPeriodRdbPeriodV1PeriodInstanceSetting>>,
    /// List of Database Instance endpoints.
    #[serde(rename = "endpoints", skip_serializing_if = "Option::is_none")]
    pub endpoints: Option<Vec<models::ScalewayPeriodRdbPeriodV1PeriodEndpoint>>,
    #[serde(rename = "logs_policy", skip_serializing_if = "Option::is_none")]
    pub logs_policy: Option<Box<models::UpdateInstanceRequestLogsPolicy>>,
    ...
    pub maintenances: Option<Vec<models::ScalewayPeriodRdbPeriodV1PeriodMaintenance>>,
    #[serde(rename = "encryption", skip_serializing_if = "Option::is_none")]
    pub encryption: Option<Box<models::CreateInstanceRequestEncryption>>,
}
