...
pub struct ScalewayPeriodRdbPeriodV1PeriodNodeType {
    ...
    pub available_volume_types:
        Option<Vec<models::ScalewayPeriodRdbPeriodV1PeriodNodeTypePeriodVolumeType>>,
    ...
    #[serde(rename = "instance_range", skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum Generation {
    #[serde(rename = "unknown_generation")]
    UnknownGeneration,
    #[serde(rename = "generation_v1")]
    GenerationV1,
    #[serde(rename = "generation_v2")]
    GenerationV2,
}
