...
pub struct ScalewayPeriodRdbPeriodV1PeriodPrivilege {
...
impl ScalewayPeriodRdbPeriodV1PeriodPrivilege {
    pub fn new() -> ScalewayPeriodRdbPeriodV1PeriodPrivilege {
        ScalewayPeriodRdbPeriodV1PeriodPrivilege {
            permission: None,
            database_name: None,
            user_name: None,
        }
