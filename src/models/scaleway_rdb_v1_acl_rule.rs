...
pub struct ScalewayRdbV1AclRule {
    ...
    pub protocol: Option<crate::models::ScalewayRdbV1AclRuleProtocol>,
    #[serde(rename = "direction", skip_serializing_if = "Option::is_none")]
    pub direction: Option<crate::models::ScalewayRdbV1AclRuleDirection>,
    #[serde(rename = "action", skip_serializing_if = "Option::is_none")]
    pub action: Option<crate::models::ScalewayRdbV1AclRuleAction>,
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}

impl ScalewayRdbV1AclRule {
    pub fn new() -> ScalewayRdbV1AclRule {
