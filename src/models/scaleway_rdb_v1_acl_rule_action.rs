...
pub enum ScalewayRdbV1AclRuleAction {
    #[serde(rename = "allow")]
    Allow,
    #[serde(rename = "deny")]
    Deny,
...
impl ToString for ScalewayRdbV1AclRuleAction {
...
impl Default for ScalewayRdbV1AclRuleAction {
    fn default() -> ScalewayRdbV1AclRuleAction {
        Self::Allow
    }
}
