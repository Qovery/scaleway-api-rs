...
pub enum ScalewayRdbV1AclRuleDirection {
...
impl ToString for ScalewayRdbV1AclRuleDirection {
...
impl Default for ScalewayRdbV1AclRuleDirection {
    fn default() -> ScalewayRdbV1AclRuleDirection {
        Self::Inbound
    }
}
