...
pub struct ScalewayRdbV1AddInstanceAclRulesResponse {
    /// Rules enabled on the instance
    #[serde(rename = "rules", skip_serializing_if = "Option::is_none")]
    pub rules: Option<Vec<crate::models::ScalewayRdbV1AclRule>>,
}

impl ScalewayRdbV1AddInstanceAclRulesResponse {
    pub fn new() -> ScalewayRdbV1AddInstanceAclRulesResponse {
        ScalewayRdbV1AddInstanceAclRulesResponse { rules: None }
    }
}
