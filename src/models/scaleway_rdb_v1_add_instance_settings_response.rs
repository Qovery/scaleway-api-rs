...
pub struct ScalewayRdbV1AddInstanceSettingsResponse {
    /// Settings available on the instance
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    pub settings: Option<Vec<crate::models::ScalewayRdbV1InstanceSetting>>,
}

impl ScalewayRdbV1AddInstanceSettingsResponse {
    pub fn new() -> ScalewayRdbV1AddInstanceSettingsResponse {
        ScalewayRdbV1AddInstanceSettingsResponse { settings: None }
    }
}
