...
pub struct ScalewayRdbV1DatabaseEngine {
    /// Engine name
    ...
    pub versions: Option<Vec<crate::models::ScalewayRdbV1EngineVersion>>,
    /// Region of this database engine
    #[serde(rename = "region", skip_serializing_if = "Option::is_none")]
    pub region: Option<String>,
}

impl ScalewayRdbV1DatabaseEngine {
    pub fn new() -> ScalewayRdbV1DatabaseEngine {
        ScalewayRdbV1DatabaseEngine {
            name: None,
            logo_url: None,
            versions: None,
            region: None,
