...
pub struct ScalewayRdbV1DeleteInstanceAclRulesResponse {
    /// ACL rules present on the instance
    #[serde(rename = "rules", skip_serializing_if = "Option::is_none")]
    pub rules: Option<Vec<crate::models::ScalewayRdbV1AclRule>>,
}

impl ScalewayRdbV1DeleteInstanceAclRulesResponse {
    pub fn new() -> ScalewayRdbV1DeleteInstanceAclRulesResponse {
        ScalewayRdbV1DeleteInstanceAclRulesResponse { rules: None }
    }
}
