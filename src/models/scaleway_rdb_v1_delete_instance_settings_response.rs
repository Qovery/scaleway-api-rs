...
pub struct ScalewayRdbV1DeleteInstanceSettingsResponse {
    /// Settings names to delete from the instance
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    pub settings: Option<Vec<crate::models::ScalewayRdbV1InstanceSetting>>,
}

impl ScalewayRdbV1DeleteInstanceSettingsResponse {
    pub fn new() -> ScalewayRdbV1DeleteInstanceSettingsResponse {
        ScalewayRdbV1DeleteInstanceSettingsResponse { settings: None }
    }
}
