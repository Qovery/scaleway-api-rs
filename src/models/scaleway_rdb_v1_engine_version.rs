...
pub struct ScalewayRdbV1EngineVersion {
    ...
    /// End of life date
    #[serde(rename = "end_of_life", skip_serializing_if = "Option::is_none")]
    ...
    pub available_settings: Option<Vec<crate::models::ScalewayRdbV1EngineSetting>>,
    ...
    #[serde(rename = "available_init_settings", skip_serializing_if = "Option::is_none")]
    pub available_init_settings: Option<Vec<crate::models::ScalewayRdbV1EngineSetting>>,
}

impl ScalewayRdbV1EngineVersion {
    pub fn new() -> ScalewayRdbV1EngineVersion {
        ScalewayRdbV1EngineVersion {
            version: None,
            name: None,
            end_of_life: None,
