...
pub struct ScalewayRdbV1InstanceMetrics {
    /// Time series of metrics of a given instance
    #[serde(rename = "timeseries", skip_serializing_if = "Option::is_none")]
    pub timeseries: Option<Vec<crate::models::ScalewayStdTimeSeries>>,
}

impl ScalewayRdbV1InstanceMetrics {
    pub fn new() -> ScalewayRdbV1InstanceMetrics {
        ScalewayRdbV1InstanceMetrics { timeseries: None }
    }
}
