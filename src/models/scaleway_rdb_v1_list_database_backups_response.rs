...
pub struct ScalewayRdbV1ListDatabaseBackupsResponse {
    /// List of database backups
    #[serde(rename = "database_backups", skip_serializing_if = "Option::is_none")]
    pub database_backups: Option<Vec<crate::models::ScalewayRdbV1DatabaseBackup>>,
    /// Total count of database backups available
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayRdbV1ListDatabaseBackupsResponse {
    pub fn new() -> ScalewayRdbV1ListDatabaseBackupsResponse {
