...
pub struct ScalewayRdbV1ListDatabaseEnginesResponse {
    /// List of the available database engines
    #[serde(rename = "engines", skip_serializing_if = "Option::is_none")]
    pub engines: Option<Vec<crate::models::ScalewayRdbV1DatabaseEngine>>,
    /// Total count of database engines available
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayRdbV1ListDatabaseEnginesResponse {
    pub fn new() -> ScalewayRdbV1ListDatabaseEnginesResponse {
