...
pub struct ScalewayRdbV1ListDatabasesResponse {
    /// List of the databases
    #[serde(rename = "databases", skip_serializing_if = "Option::is_none")]
    pub databases: Option<Vec<crate::models::ScalewayRdbV1Database>>,
    /// Total count of databases present on a given instance
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayRdbV1ListDatabasesResponse {
    pub fn new() -> ScalewayRdbV1ListDatabasesResponse {
