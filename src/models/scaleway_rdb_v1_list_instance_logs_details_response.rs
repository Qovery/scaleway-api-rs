...
pub struct ScalewayRdbV1ListInstanceLogsDetailsResponse {
    /// Remote instance logs details
    #[serde(rename = "details", skip_serializing_if = "Option::is_none")]
    pub details:
        Option<Vec<crate::models::ScalewayRdbV1ListInstanceLogsDetailsResponseInstanceLogDetail>>,
}

impl ScalewayRdbV1ListInstanceLogsDetailsResponse {
    pub fn new() -> ScalewayRdbV1ListInstanceLogsDetailsResponse {
        ScalewayRdbV1ListInstanceLogsDetailsResponse { details: None }
    }
}
