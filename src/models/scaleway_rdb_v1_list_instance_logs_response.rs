...
pub struct ScalewayRdbV1ListInstanceLogsResponse {
...
impl ScalewayRdbV1ListInstanceLogsResponse {
    pub fn new() -> ScalewayRdbV1ListInstanceLogsResponse {
        ScalewayRdbV1ListInstanceLogsResponse {
            instance_logs: None,
        }
    }
}
