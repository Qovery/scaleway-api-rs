...
pub struct ScalewayRdbV1ListNodeTypesResponse {
    /// Types of the node
    #[serde(rename = "node_types", skip_serializing_if = "Option::is_none")]
    pub node_types: Option<Vec<crate::models::ScalewayRdbV1NodeType>>,
    /// Total count of node-types available
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayRdbV1ListNodeTypesResponse {
    pub fn new() -> ScalewayRdbV1ListNodeTypesResponse {
