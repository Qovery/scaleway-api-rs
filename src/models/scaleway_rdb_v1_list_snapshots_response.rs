...
pub struct ScalewayRdbV1ListSnapshotsResponse {
    /// List of snapshots
    #[serde(rename = "snapshots", skip_serializing_if = "Option::is_none")]
    pub snapshots: Option<Vec<crate::models::ScalewayRdbV1Snapshot>>,
    /// Total count of snapshots available
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayRdbV1ListSnapshotsResponse {
    pub fn new() -> ScalewayRdbV1ListSnapshotsResponse {
