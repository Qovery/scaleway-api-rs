...
pub struct ScalewayRdbV1ListUsersResponse {
    /// List of users in a given instance
    #[serde(rename = "users", skip_serializing_if = "Option::is_none")]
    pub users: Option<Vec<crate::models::ScalewayRdbV1User>>,
    /// Total count of users present on a given instance
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayRdbV1ListUsersResponse {
    pub fn new() -> ScalewayRdbV1ListUsersResponse {
