...
pub struct ScalewayRdbV1Maintenance {
    ...
    #[serde(rename = "stops_at", skip_serializing_if = "Option::is_none")]
...
impl ScalewayRdbV1Maintenance {
    pub fn new() -> ScalewayRdbV1Maintenance {
        ScalewayRdbV1Maintenance {
            starts_at: None,
            stops_at: None,
            closed_at: None,
            reason: None,
