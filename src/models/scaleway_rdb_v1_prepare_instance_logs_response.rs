...
pub struct ScalewayRdbV1PrepareInstanceLogsResponse {
    ...
    pub instance_logs: Option<Vec<crate::models::ScalewayRdbV1InstanceLog>>,
}

impl ScalewayRdbV1PrepareInstanceLogsResponse {
    pub fn new() -> ScalewayRdbV1PrepareInstanceLogsResponse {
        ScalewayRdbV1PrepareInstanceLogsResponse {
            instance_logs: None,
        }
    }
}
