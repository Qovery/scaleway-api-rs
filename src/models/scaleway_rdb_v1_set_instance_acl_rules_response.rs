...
pub struct ScalewayRdbV1SetInstanceAclRulesResponse {
    /// ACLs rules configured for an instance
    #[serde(rename = "rules", skip_serializing_if = "Option::is_none")]
    pub rules: Option<Vec<crate::models::ScalewayRdbV1AclRule>>,
}

impl ScalewayRdbV1SetInstanceAclRulesResponse {
    pub fn new() -> ScalewayRdbV1SetInstanceAclRulesResponse {
        ScalewayRdbV1SetInstanceAclRulesResponse { rules: None }
    }
}
