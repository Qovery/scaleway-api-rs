...
pub struct ScalewayRdbV1SetInstanceSettingsResponse {
    /// Settings configured for a given instance
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    pub settings: Option<Vec<crate::models::ScalewayRdbV1InstanceSetting>>,
}

impl ScalewayRdbV1SetInstanceSettingsResponse {
    pub fn new() -> ScalewayRdbV1SetInstanceSettingsResponse {
        ScalewayRdbV1SetInstanceSettingsResponse { settings: None }
    }
}
