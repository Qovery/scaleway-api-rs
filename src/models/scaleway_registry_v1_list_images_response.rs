...
pub struct ScalewayRegistryV1ListImagesResponse {
    /// Paginated list of images matching filters
    #[serde(rename = "images", skip_serializing_if = "Option::is_none")]
    pub images: Option<Vec<crate::models::ScalewayRegistryV1Image>>,
    /// Total number of images matching filters
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayRegistryV1ListImagesResponse {
    pub fn new() -> ScalewayRegistryV1ListImagesResponse {
