...
pub struct ScalewayRegistryV1ListNamespacesResponse {
    /// Paginated list of namespaces matching filters
    #[serde(rename = "namespaces", skip_serializing_if = "Option::is_none")]
    pub namespaces: Option<Vec<crate::models::ScalewayRegistryV1Namespace>>,
    /// Total number of namespaces matching filters
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayRegistryV1ListNamespacesResponse {
    pub fn new() -> ScalewayRegistryV1ListNamespacesResponse {
