...
pub struct ScalewayRegistryV1ListTagsResponse {
    /// Paginated list of tags matching filters
    #[serde(rename = "tags", skip_serializing_if = "Option::is_none")]
    pub tags: Option<Vec<crate::models::ScalewayRegistryV1Tag>>,
    /// Total number of tags matching filters
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayRegistryV1ListTagsResponse {
    pub fn new() -> ScalewayRegistryV1ListTagsResponse {
