...
pub struct ScalewayStdMapStringStringValue {
    #[serde(rename = "<key>", skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
}

impl ScalewayStdMapStringStringValue {
    pub fn new() -> ScalewayStdMapStringStringValue {
        ScalewayStdMapStringStringValue { key: None }
    }
}
