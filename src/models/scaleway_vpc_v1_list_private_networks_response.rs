...
pub struct ScalewayVpcV1ListPrivateNetworksResponse {
    #[serde(rename = "private_networks", skip_serializing_if = "Option::is_none")]
    pub private_networks: Option<Vec<crate::models::ScalewayVpcV1PrivateNetwork>>,
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<f32>,
}

impl ScalewayVpcV1ListPrivateNetworksResponse {
    pub fn new() -> ScalewayVpcV1ListPrivateNetworksResponse {
