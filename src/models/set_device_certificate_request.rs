...
pub struct SetDeviceCertificateRequest {
    /// The PEM-encoded custom certificate
    #[serde(rename = "certificate_pem")]
    pub certificate_pem: String,
}

impl SetDeviceCertificateRequest {
    pub fn new(certificate_pem: String) -> SetDeviceCertificateRequest {
        SetDeviceCertificateRequest { certificate_pem }
    }
}
