...
pub struct UpdateClusterRequest {
    ...
    pub autoscaler_config: Option<Box<models::UpdateClusterRequestAutoscalerConfig>>,
    #[serde(rename = "auto_upgrade", skip_serializing_if = "Option::is_none")]
    pub auto_upgrade: Option<Box<models::UpdateClusterRequestAutoUpgrade>>,
    ...
    pub open_id_connect_config: Option<Box<models::UpdateClusterRequestOpenIdConnectConfig>>,
