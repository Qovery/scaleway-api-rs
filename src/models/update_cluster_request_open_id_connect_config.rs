...
/// UpdateClusterRequestOpenIdConnectConfig : OpenID Connect configuration of the cluster. This configuration enables to update the OpenID Connect configuration of the Kubernetes API server.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateClusterRequestOpenIdConnectConfig {
