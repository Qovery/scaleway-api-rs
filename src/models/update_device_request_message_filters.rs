...
/// UpdateDeviceRequestMessageFilters : Filter-sets to restrict the topics the device can publish/subscribe to

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct UpdateDeviceRequestMessageFilters {
...
impl UpdateDeviceRequestMessageFilters {
    /// Filter-sets to restrict the topics the device can publish/subscribe to
    pub fn new() -> UpdateDeviceRequestMessageFilters {
