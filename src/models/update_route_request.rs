...
pub struct UpdateRouteRequest {
    ...
    pub s3_config: Option<Box<crate::models::UpdateRouteRequestS3Config>>,
    #[serde(rename = "db_config", skip_serializing_if = "Option::is_none")]
    pub db_config: Option<Box<crate::models::UpdateRouteRequestDbConfig>>,
    #[serde(rename = "rest_config", skip_serializing_if = "Option::is_none")]
    pub rest_config: Option<Box<crate::models::UpdateRouteRequestRestConfig>>,
}

impl UpdateRouteRequest {
    pub fn new() -> UpdateRouteRequest {
        UpdateRouteRequest {
            name: None,
            topic: None,
            s3_config: None,
