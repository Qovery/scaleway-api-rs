...
/// UpdateRouteRequestDbConfig : When updating Database Route, DB-specific configuration fields

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct UpdateRouteRequestDbConfig {
...
impl UpdateRouteRequestDbConfig {
    /// When updating Database Route, DB-specific configuration fields
    pub fn new() -> UpdateRouteRequestDbConfig {
