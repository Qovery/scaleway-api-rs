...
/// UpdateRouteRequestRestConfig : When updating Rest Route, Rest-specific configuration fields

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct UpdateRouteRequestRestConfig {
...
impl UpdateRouteRequestRestConfig {
    /// When updating Rest Route, Rest-specific configuration fields
    pub fn new() -> UpdateRouteRequestRestConfig {
