...
/// UpdateRouteRequestS3Config : When updating S3 Route, S3-specific configuration fields

#[derive(Clone, Debug, PartialEq, Eq, Default, Serialize, Deserialize)]
pub struct UpdateRouteRequestS3Config {
...
impl UpdateRouteRequestS3Config {
    /// When updating S3 Route, S3-specific configuration fields
    pub fn new() -> UpdateRouteRequestS3Config {
