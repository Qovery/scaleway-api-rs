...
pub struct UpgradeInstanceRequest {
    ...
    pub enable_ha: Option<Option<bool>>,
    ...
    pub volume_type: Option<Option<VolumeType>>,
    /// Update your database engine to a newer version. This will create a new Database Instance with same specifications as the current one and perform a Database Engine upgrade. (UUID format)
    #[serde(
    ...
    pub upgradable_version_id: Option<Option<String>>,
    #[serde(
        rename = "major_upgrade_workflow",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub major_upgrade_workflow:
        Option<Option<Box<models::UpgradeInstanceRequestMajorUpgradeWorkflow>>>,
    /// Defines whether or not encryption should be enabled on the Database Instance.
    #[serde(
        rename = "enable_encryption",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub enable_encryption: Option<Option<bool>>,
}
